...
<svg viewBox="0 0 10 10">
  <rect x="0" y="0" width="10em" height="10" fill="currentColor" />
      ...
      await tester.pumpWidget(DefaultSvgTheme(theme: svgTheme, child: svgPictureWidget));
      ...
      expect((svgPicture.bytesLoader as SvgStringLoader).getTheme(context), equals(svgTheme));
      ...
      await tester.pumpWidget(DefaultSvgTheme(theme: anotherSvgTheme, child: svgPictureWidget));
...
<svg viewBox="0 0 10 10">
  <rect x="0" y="0" width="10" height="10" fill="currentColor" />
      ...
      expect(svgPicture, isNotNull);
      expect(
        (svgPicture.bytesLoader as SvgStringLoader).getTheme(context).currentColor,
...
<svg viewBox="0 0 10 10">
  <rect x="0" y="0" width="10em" height="10em" />
      ...
      expect(svgPicture, isNotNull);
      expect((svgPicture.bytesLoader as SvgStringLoader).getTheme(context).fontSize, equals(12.0));
    });

    testWidgets('fontSize defaults to 14 '
...
<svg viewBox="0 0 10 10">
  <rect x="0" y="0" width="10em" height="10em" />
      ...
      final BuildContext context = tester.element(find.byType(SvgPicture));
      expect(svgPicture, isNotNull);
      expect((svgPicture.bytesLoader as SvgStringLoader).getTheme(context).fontSize, equals(14.0));
    });
...
<svg viewBox="0 0 10 10">
  <rect x="0" y="0" width="10ex" height="10ex" />
      ...
      final BuildContext context = tester.element(find.byType(SvgPicture));
      expect(svgPicture, isNotNull);
      expect((svgPicture.bytesLoader as SvgStringLoader).getTheme(context).xHeight, equals(7.0));
    });
