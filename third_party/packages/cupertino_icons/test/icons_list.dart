...
///
/// After making changes to the font, if the change requires code change in the
/// [CupertinoIcons] class (adding new icons, for example), consider updating
/// this list.
///
/// This list cannot be mutated by tests.
final List<IconData> icons = List<IconData>.unmodifiable(<IconData>[
