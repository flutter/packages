...
class _MyHomePageState extends State<MyHomePage> {
  ...
  _painters.add(SvgPicture.string('''<svg width="18px" height="18px" viewBox="0 0 18 18" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
