    ...
    group('_getPackageName', () {
      test('extracts name from pubspec.yaml', () {
        ...
        packageDir
            ...
            .writeAsStringSync('name: my_package_name\n');
        fs.currentDirectory = packageDir;

        expect(
          FlutterGoldenFileComparator.getPackageName(fs),
          'my_package_name',
        );
      });
      ...
      test('traverses upwards to find pubspec.yaml', () {
        ...
        packageDir
            .childFile('pubspec.yaml')
            .writeAsStringSync('name: my_package_name\n');
        final Directory testDir = packageDir.childDirectory('test')
          ..createSync(recursive: true);
      ...
      test('returns null if no pubspec.yaml is found', () {
        final fs = MemoryFileSystem();
        final Directory someDir = fs.directory('/some/dir')
          ..createSync(recursive: true);
