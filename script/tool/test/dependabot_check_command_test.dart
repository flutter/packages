...
void main() {
  ...
  setUp(() {
    ...
    runner = CommandRunner<void>('dependabot_test', 'Test for $DependabotCheckCommand');
...
''');
  ...
  test('passes with no supported ecosystems', () async {
    ...
    final List<String> output = await runCapturingPrint(runner, <String>['dependabot-check']);
