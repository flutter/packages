...
import 'package:cupertino_ui_examples/activity_indicator/cupertino_linear_activity_indicator.0.dart'
    as example;
...
void main() {
  testWidgets('Default and customized cupertino activity indicators', (
    ...
    await tester.pumpWidget(
      const example.CupertinoLinearActivityIndicatorApp(),
    );

    final Finder firstIndicator = find
        .byType(CupertinoLinearActivityIndicator)
        .first;
    ...
    final Finder thirdIndicator = find
        .byType(CupertinoLinearActivityIndicator)
        .at(2);
    ...
    final Finder lastIndicator = find
        .byType(CupertinoLinearActivityIndicator)
        .last;
