...
gboolean ffs_platform_file_chooser_options_equals(
  ...
  if (a->select_multiple != nullptr &&
      *a->select_multiple != *b->select_multiple) {
    return FALSE;
  }
  if ((a->create_folders == nullptr) != (b->create_folders == nullptr)) {
    return FALSE;
  }
  if (a->create_folders != nullptr &&
      *a->create_folders != *b->create_folders) {
    return FALSE;
  }
  return TRUE;
}
...
guint ffs_platform_file_chooser_options_hash(
  ...
  result = result * 31 + (self->current_folder_path != nullptr
                              ? g_str_hash(self->current_folder_path)
                              : 0);
  result = result * 31 +
           (self->current_name != nullptr ? g_str_hash(self->current_name) : 0);
  result = result * 31 + (self->accept_button_label != nullptr
                              ? g_str_hash(self->accept_button_label)
                              : 0);
  result = result * 31 + (self->select_multiple != nullptr
                              ? static_cast<guint>(*self->select_multiple)
                              : 0);
  result = result * 31 + (self->create_folders != nullptr
                              ? static_cast<guint>(*self->create_folders)
                              : 0);
  return result;
}
...
static FlValue* ffs_message_codec_read_ffs_platform_file_chooser_action_type(
  ...
  return fl_value_new_custom(
      ffs_platform_file_chooser_action_type_type_id,
...
static FlValue* ffs_message_codec_read_ffs_platform_type_group(
  ...
  return fl_value_new_custom_object(ffs_platform_type_group_type_id,
                                    G_OBJECT(value));
}
...
static FlValue* ffs_message_codec_read_ffs_platform_file_chooser_options(
  ...
  return fl_value_new_custom_object(ffs_platform_file_chooser_options_type_id,
                                    G_OBJECT(value));
}
