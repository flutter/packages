...
public class GeneratedFileSelectorApi {
  ...
  public interface FileSelectorApi {
    ...
    void openFile2(@Nullable String initialDirectory, @NonNull FileTypes allowedTypes, @NonNull NullableResult<String> result);
    /**
    ...
    static void setUp(@NonNull BinaryMessenger binaryMessenger, @NonNull String messageChannelSuffix, @Nullable FileSelectorApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.file_selector_android.FileSelectorApi.openFile2" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                ...
                api.openFile2(initialDirectoryArg, allowedTypesArg, resultCallback);
              });
        } else {
          channel.setMessageHandler(null);
        }
