...
abstract class TestFileSelectorApi {
  ...
  Future<String?> openFile(String? initialDirectory, List<String?>? mimeTypes);

  Future<List<String?>> openFiles(
      String? initialDirectory, List<String?>? mimeTypes);
      ...
      {BinaryMessenger? binaryMessenger}) {
    {
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
          ...
          final String? output =
              await api.openFile(arg_initialDirectory, arg_mimeTypes);
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
          ...
          final List<String?> output =
              await api.openFiles(arg_initialDirectory, arg_mimeTypes);
          return <Object?>[output];
        });
      }
    }
