...
class UrlLauncherTest {
    ...
    fun canLaunch_returnsFalseForEmulatorFallbackComponent() {
        val api =
            UrlLauncher(
                ApplicationProvider.getApplicationContext<Context?>(),
                IntentResolver { intent: Intent? -> "{com.android.fallback/com.android.fallback.Fallback}" })
    ...
    fun launch_createsIntentWithPassedUrl() {
        ...
        Mockito.doThrow(ActivityNotFoundException()).`when`<Activity?>(activity)
        ...
        Assert.assertEquals(
            ...
            (intentCaptor.getValue()!!
                .getFlags() and Intent.FLAG_ACTIVITY_REQUIRE_NON_BROWSER).toLong()
        )
    }
    ...
    fun openUrlInApp_opensUrlInWebViewIfNecessary() {
        ...
        Assert.assertEquals(
            url,
            intentCaptor.getValue()!!.getExtras()!!.getString(WebViewActivity.URL_EXTRA)
        )
        Assert.assertEquals(
            enableJavaScript,
    ...
    fun openWebView_opensUrlInCustomTabsWithCORSAllowedHeader() {
        ...
        val result =
            api.openUrlInApp(
                url, true, WebViewOptions(false, false, headers), BrowserOptions(false)
            )
    ...
    fun openWebView_opensUrlInCustomTabsWithShowTitle() {
        ...
        val result =
            api.openUrlInApp(
                url, true, WebViewOptions(false, false, headers), BrowserOptions(true)
            )
        ...
        Assert.assertEquals(
            ...
            intentCaptor.getValue()!!.getExtras()!!
                .getInt(CustomTabsIntent.EXTRA_TITLE_VISIBILITY_STATE).toLong()
        )
    }
    ...
    fun openWebView_fallsBackToWebViewIfCustomTabFails() {
        ...
        Mockito.doThrow(ActivityNotFoundException())
            ...
            .startActivity(
                ...
                ArgumentMatchers.any<Bundle?>()
            ) // for custom tabs intent
    ...
    fun openWebView_handlesHeaders() {
        ...
        api.openUrlInApp(
            "https://flutter.dev",
            true,
            WebViewOptions(false, false, headers),
            BrowserOptions(false)
        )
