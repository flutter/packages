      ...
      completion(
        .failure(
          PigeonError(
            ...
            message: "Callback to `UIViewController.viewDidAppear` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message: "Callback to `IMAAdsLoaderDelegate.adLoaderLoadedWith` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message: "Callback to `IMAAdsLoaderDelegate.adsLoaderFailedWithErrorData` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
...
protocol PigeonApiDelegateIMAAdsManager {
  ...
  func adCuePoints(pigeonApi: PigeonApiIMAAdsManager, pigeonInstance: IMAAdsManager) throws -> [Double]
...
final class PigeonApiIMAAdsManager: PigeonApiProtocolIMAAdsManager  {
  ...
  func pigeonNewInstance(pigeonInstance: IMAAdsManager, completion: @escaping (Result<Void, PigeonError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      let pigeonIdentifierArg = pigeonRegistrar.instanceManager.addHostCreatedInstance(pigeonInstance as AnyObject)
      let adCuePointsArg = try! pigeonDelegate.adCuePoints(pigeonApi: self, pigeonInstance: pigeonInstance)
      let binaryMessenger = pigeonRegistrar.binaryMessenger
      let codec = pigeonRegistrar.codec
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message: "Callback to `IMAAdsManagerDelegate.didReceiveAdEvent` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message: "Callback to `IMAAdsManagerDelegate.didReceiveAdError` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message: "Callback to `IMAAdsManagerDelegate.didRequestContentPause` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message: "Callback to `IMAAdsManagerDelegate.didRequestContentResume` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
...
final class PigeonApiIMAAdEvent: PigeonApiProtocolIMAAdEvent  {
  ...
  func pigeonNewInstance(pigeonInstance: IMAAdEvent, completion: @escaping (Result<Void, PigeonError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
      channel.sendMessage([pigeonIdentifierArg, typeArg, typeStringArg, adDataArg, adArg] as [Any?]) { response in
        guard let listResponse = response as? [Any?] else {
          completion(.failure(createConnectionError(withChannelName: channelName)))
          return
        }
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message: "Callback to `IMACompanionDelegate.companionAdSlotFilled` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message: "Callback to `IMACompanionDelegate.companionSlotWasClicked` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
