...
class AllTypesBaseRoute extends GoRouteData {
  ...
  @override
  Widget build(BuildContext context, _) => const BasePage<void>(
        dataTitle: 'Root',
        param: null,
      );
}
...
class BigIntRoute extends GoRouteData {
  ...
  @override
  Widget build(BuildContext context, _) => BasePage<BigInt>(
...
class BoolRoute extends GoRouteData {
  ...
  @override
  Widget build(BuildContext context, _) => BasePage<bool>(
        dataTitle: 'BoolRoute',
...
class DateTimeRoute extends GoRouteData {
  ...
  @override
  Widget build(BuildContext context, _) => BasePage<DateTime>(
...
class DoubleRoute extends GoRouteData {
  ...
  @override
  Widget build(BuildContext context, _) => BasePage<double>(
...
class IntRoute extends GoRouteData {
  ...
  @override
  Widget build(BuildContext context, _) => BasePage<int>(
        dataTitle: 'IntRoute',
...
class NumRoute extends GoRouteData {
  ...
  @override
  Widget build(BuildContext context, _) => BasePage<num>(
        dataTitle: 'NumRoute',
...
class EnumRoute extends GoRouteData {
  ...
  @override
  Widget build(BuildContext context, _) => BasePage<PersonDetails>(
        dataTitle: 'EnumRoute',
...
class EnhancedEnumRoute extends GoRouteData {
  ...
  @override
  Widget build(BuildContext context, _) => BasePage<SportDetails>(
...
class StringRoute extends GoRouteData {
  ...
  @override
  Widget build(BuildContext context, _) => BasePage<String>(
...
class UriRoute extends GoRouteData {
  ...
  @override
  Widget build(BuildContext context, _) => BasePage<Uri>(
        dataTitle: 'UriRoute',
