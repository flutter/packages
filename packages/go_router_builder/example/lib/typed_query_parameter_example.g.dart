...
RouteBase get $intRoute => GoRouteData.$route(path: '/int-route', factory: $IntRoute._fromState);

mixin $IntRoute on GoRouteData {
  static IntRoute _fromState(GoRouterState state) => IntRoute(
    intField: _$convertMapValue('intField', state.uri.queryParameters, int.tryParse),
    intFieldWithDefaultValue:
        _$convertMapValue('int_field_with_default_value', state.uri.queryParameters, int.parse) ??
        1,
    intFieldWithSpace: _$convertMapValue('int field', state.uri.queryParameters, int.tryParse),
  ...
  String get location => GoRouteData.$location(
    ...
    queryParams: {
      ...
      if (_self.intFieldWithDefaultValue != 1)
        'int_field_with_default_value': _self.intFieldWithDefaultValue.toString(),
      if (_self.intFieldWithSpace != null) 'int field': _self.intFieldWithSpace!.toString(),
