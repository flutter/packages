...
void main() {
  testWidgets('Test typed route navigation', (WidgetTester tester) async {
    ...
    BoolRoute(requiredBoolField: false, boolField: true).go(scaffoldState.context);
    await tester.pumpAndSettle();
    ...
    DateTimeRoute(requiredDateTimeField: param, dateTimeField: query).go(scaffoldState.context);
    await tester.pumpAndSettle();
    ...
    DoubleRoute(requiredDoubleField: 3.14, doubleField: -3.14).go(scaffoldState.context);
    await tester.pumpAndSettle();
    ...
    NumRoute(requiredNumField: 987.32, numField: -987.32).go(scaffoldState.context);
    await tester.pumpAndSettle();
    ...
    expect(find.text('Query param with default value: defaultValue'), findsOneWidget);
    ...
    expect(find.text('Query param with default value: PersonDetails.favoriteFood'), findsOneWidget);
    ...
    expect(find.text('Query param with default value: SportDetails.football'), findsOneWidget);
    ...
    IterableRoute(
      ...
      enumOnlyInSetField: <CookingRecipe>{CookingRecipe.burger, CookingRecipe.pizza},
    ).go(scaffoldState.context);
    await tester.pumpAndSettle();
  ...
  testWidgets('It should navigate to the iterable route with its default values', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(AllTypesApp());
    ...
    final IterablePage page = tester.widget<IterablePage>(find.byType(IterablePage));
    expect(
      page,
      isA<IterablePage>()
          .having((IterablePage page) => page.intIterableField, 'intIterableField', const <int>[0])
          .having((IterablePage page) => page.intListField, 'intListField', const <int>[0])
          .having((IterablePage page) => page.intSetField, 'intSetField', const <int>{0, 1})
          .having(
            (IterablePage page) => page.doubleIterableField,
            'doubleIterableField',
            const <double>[0, 1, 2],
          )
          .having((IterablePage page) => page.doubleListField, 'doubleListField', const <double>[
            1,
            2,
            3,
          ])
          .having((IterablePage page) => page.doubleSetField, 'doubleSetField', const <double>{})
          .having(
            (IterablePage page) => page.stringIterableField,
            'stringIterableField',
            const <String>['defaultValue'],
          )
          .having((IterablePage page) => page.stringListField, 'stringListField', const <String>[
            'defaultValue0',
            'defaultValue1',
          ])
          .having((IterablePage page) => page.stringSetField, 'stringSetField', const <String>{
            'defaultValue',
          })
          .having((IterablePage page) => page.boolIterableField, 'boolIterableField', const <bool>[
            false,
          ])
          .having((IterablePage page) => page.boolListField, 'boolListField', const <bool>[true])
          .having((IterablePage page) => page.boolSetField, 'boolSetField', const <bool>{
            true,
            false,
          })
          .having(
          ...
          .having((IterablePage page) => page.enumListField, 'enumListField', const <SportDetails>[
            SportDetails.football,
          ])
          .having((IterablePage page) => page.enumSetField, 'enumSetField', const <SportDetails>{
            SportDetails.hockey,
          }),
    );
  ...
  testWidgets('Test navigation with invalid query and path parameters using Uri.parse', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(AllTypesApp());
    ...
    scaffoldState.context.go(Uri.parse('/big-int-route/4?bigIntField=invalid').toString());
    await tester.pumpAndSettle();
    expect(find.text('BigIntRoute'), findsOneWidget);
    expect(find.text('Param: 4'), findsOneWidget);
    ...
    scaffoldState.context.go(
      Uri.parse('/date-time-route/2021-01-01T00:00:00.000?dateTimeField=invalid-date').toString(),
    );
    await tester.pumpAndSettle();
    expect(find.text('DateTimeRoute'), findsOneWidget);
    ...
    scaffoldState.context.go(Uri.parse('/double-route/3.14?doubleField=invalid').toString());
    await tester.pumpAndSettle();
    expect(find.text('DoubleRoute'), findsOneWidget);
    expect(find.text('Param: 3.14'), findsOneWidget);
    expect(find.text('Query param: null'), findsOneWidget);
    ...
    scaffoldState.context.go(Uri.parse('/int-route/65?intField=invalid').toString());
    await tester.pumpAndSettle();
    expect(find.text('IntRoute'), findsOneWidget);
    expect(find.text('Param: 65'), findsOneWidget);
    expect(find.text('Query param: null'), findsOneWidget);
    ...
    scaffoldState.context.go(
      Uri.parse('/uri-route/https%3A%2F%2Fdart.dev?uriField=invalid-uri').toString(),
    );
    await tester.pumpAndSettle();
    expect(find.text('UriRoute'), findsOneWidget);
    expect(find.text('Param: https://dart.dev'), findsOneWidget);
    ...
    scaffoldState.context.go(Uri.parse('/enum-route/favorite-food?enum-field=invalid').toString());
    await tester.pumpAndSettle();
    expect(find.text('EnumRoute'), findsOneWidget);
    expect(find.text('Query param: null'), findsOneWidget);
    expect(find.text('Query param with default value: PersonDetails.favoriteFood'), findsOneWidget);
    ...
    scaffoldState.context.go(Uri.parse('/iterable-route?intListField=invalid').toString());
    await tester.pumpAndSettle();
    expect(find.text('IterableRoute'), findsOneWidget);
    expect(find.text('/iterable-route'), findsOneWidget);
  });
