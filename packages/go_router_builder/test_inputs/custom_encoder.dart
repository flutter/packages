...
mixin _$CustomParameterRoute {}

@TypedGoRoute<CustomParameterRoute>(path: '/default-value-route')
class CustomParameterRoute extends GoRouteData with _$CustomParameterRoute {
