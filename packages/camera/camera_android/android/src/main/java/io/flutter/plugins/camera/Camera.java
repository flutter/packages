...
class Camera
  ...
  public String stopVideoRecording() {
    ...
    try {
      ...
      // We marked that mediaRecorder.stop() is failed when no valid audio/video data has been
      // received when stop() is called, so we should reset mediaRecorder and start preview.
