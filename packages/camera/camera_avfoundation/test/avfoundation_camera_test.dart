...
void main() {
    ...
    final ByteData? response = await _ambiguate(TestDefaultBinaryMessengerBinding.instance)!
        ...
        .handlePlatformMessage(
            ...
            const StandardMethodCodec().encodeMethodCall(const MethodCall(
                'orientation_changed', <String, Object>{'orientation': 'portraitDown'})),
            (ByteData? data) {});
        ...
        await _ambiguate(TestDefaultBinaryMessengerBinding.instance)!
            ...
            .handlePlatformMessage(
                ...
                const StandardMethodCodec()
                    .encodeMethodCall(MethodCall('orientation_changed', event.toJson())),
                null);
      }
  ...
  group('Function Tests', () {
    ...
    test('Should take a picture and return an XFile instance', () async {
      // Arrange
      final MethodChannelMock channel = MethodChannelMock(
          channelName: _channelName, methods: <String, dynamic>{'takePicture': '/test/path.jpg'});
    ...
    test('Should pass enableStream if callback is passed when starting recording a video',
        () async {
      // Arrange
      final MethodChannelMock channel = MethodChannelMock(
        channelName: _channelName,
