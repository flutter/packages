...
void main() {
  ...
  group('Function Tests', () {
    ...
    test('Should take a picture and return an XFile instance with jpeg format',
        () async {
      // Arrange
      final MethodChannelMock channel = MethodChannelMock(
          channelName: _channelName,
    ...
    test('Should take a picture and return an XFile instance with heic format',
        () async {
      // Arrange
      final MethodChannelMock channel = MethodChannelMock(
          channelName: _channelName,
          methods: <String, dynamic>{'takePicture': '/test/path.heic'});

      // Act
      final XFile file =
          await camera.takePicture(cameraId, imageFormat: ImageFormat.heic);
