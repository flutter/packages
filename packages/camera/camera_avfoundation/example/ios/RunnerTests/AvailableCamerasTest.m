...
- (void)testAvailableCamerasShouldReturnAllCamerasOnMultiCameraIPhone {
  ...
  _mockDeviceDiscovery.discoverySessionStub = ^NSArray<id<FLTCaptureDeviceControlling>> * _Nullable(NSArray<AVCaptureDeviceType> * _Nonnull deviceTypes, AVMediaType  _Nonnull mediaType, AVCaptureDevicePosition position) {
