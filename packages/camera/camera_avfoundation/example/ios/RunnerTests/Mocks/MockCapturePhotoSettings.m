...
- (id<FLTCapturePhotoSettings>)createPhotoSettings {
    return self.createPhotoSettingsStub ? self.createPhotoSettingsStub() : [[MockCapturePhotoSettings alloc] init];
}

- (id<FLTCapturePhotoSettings>)createPhotoSettingsWithFormat:(NSDictionary<NSString *, id> *)format {
    return self.createPhotoSettingsWithFormatStub ? self.createPhotoSettingsWithFormatStub(format) : [[MockCapturePhotoSettings alloc] init];
}
