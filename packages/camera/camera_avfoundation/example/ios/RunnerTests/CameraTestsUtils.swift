...
func getDefaultMediaSettings(resolutionPreset: FCPPlatformResolutionPreset)
...
func createTestCameraConfiguration() -> FLTCamConfiguration {
...
func createCameraWithCaptureSessionQueue(_ captureSessionQueue: DispatchQueue) -> FLTCam {
...
func createTestSampleBuffer() -> CMSampleBuffer {
...
func createTestAudioSampleBuffer() -> CMSampleBuffer? {
