...
class PlatformCameraDescription {
  ...
  PlatformCaptureDeviceType deviceType;
  ...
  static PlatformCameraDescription decode(Object result) {
    ...
    return PlatformCameraDescription(
      ...
      deviceType: result[2]! as PlatformCaptureDeviceType,
      manufacturer: result[3]! as String,
      model: result[4]! as String,
      localisedName: result[5]! as String,
    );
  }
}
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is int) {
      ...
      buffer.putUint8(136);
      writeValue(buffer, value.index);
    }    else if (value is PlatformCaptureDeviceType) {
      buffer.putUint8(137);
      writeValue(buffer, value.index);
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 137: 
        final int? value = readValue(buffer) as int?;
        return value == null ? null : PlatformCaptureDeviceType.values[value];
      case 138: 
