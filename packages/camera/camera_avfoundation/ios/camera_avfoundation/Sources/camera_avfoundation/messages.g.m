...
- (nullable id)readValueOfType:(UInt8)type {
  switch (type) {
    ...
    case 137: {
      NSNumber *enumAsNumber = [self readValue];
      return enumAsNumber == nil ? nil : [[FCPPlatformVideoStabilizationModeBox alloc] initWithValue:[enumAsNumber integerValue]];
    }
    case 138: 
...
void SetUpFCPCameraApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FCPCameraApi> *api, NSString *messageChannelSuffix) {
  ...
  /// Sets the video stabilization mode.
  {
    ...
    if (api) {
      ...
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
        FCPPlatformVideoStabilizationModeBox *boxedFCPPlatformVideoStabilizationMode = GetNullableObjectAtIndex(args, 0);
