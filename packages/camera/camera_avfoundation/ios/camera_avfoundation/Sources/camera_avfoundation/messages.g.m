...
@implementation FCPPlatformCaptureDeviceTypeBox
...
+ (instancetype)makeWithName:(NSString *)name
  ...
  pigeonResult.localisedName = localisedName;
  return pigeonResult;
}
+ (FCPPlatformCameraDescription *)fromList:(NSArray<id> *)list {
  FCPPlatformCameraDescription *pigeonResult = [[FCPPlatformCameraDescription alloc] init];
  ...
  FCPPlatformCaptureDeviceTypeBox *boxedFCPPlatformCaptureDeviceType = GetNullableObjectAtIndex(list, 2);
  pigeonResult.deviceType = boxedFCPPlatformCaptureDeviceType.value;
  pigeonResult.manufacturer = GetNullableObjectAtIndex(list, 3);
  pigeonResult.model = GetNullableObjectAtIndex(list, 4);
  pigeonResult.localisedName = GetNullableObjectAtIndex(list, 5);
  return pigeonResult;
}
+ (nullable FCPPlatformCameraDescription *)nullableFromList:(NSArray<id> *)list {
...
- (NSArray<id> *)toList {
  return @[
    ...
    [[FCPPlatformCaptureDeviceTypeBox alloc] initWithValue:self.deviceType],
    self.manufacturer ?: [NSNull null],
    self.model ?: [NSNull null],
    self.localisedName ?: [NSNull null],
  ];
}
@end
...
- (nullable id)readValueOfType:(UInt8)type {
  switch (type) {
    ...
    case 137: {
      NSNumber *enumAsNumber = [self readValue];
      return enumAsNumber == nil ? nil : [[FCPPlatformCaptureDeviceTypeBox alloc] initWithValue:[enumAsNumber integerValue]];
    }
    case 138: 
...
- (void)writeValue:(id)value {
  if ([value isKindOfClass:[FCPPlatformCameraLensDirectionBox class]]) {
    ...
    [self writeByte:136];
    [self writeValue:(value == nil ? [NSNull null] : [NSNumber numberWithInteger:box.value])];
  } else if ([value isKindOfClass:[FCPPlatformCaptureDeviceTypeBox class]]) {
    FCPPlatformCaptureDeviceTypeBox *box = (FCPPlatformCaptureDeviceTypeBox *)value;
    [self writeByte:137];
    [self writeValue:(value == nil ? [NSNull null] : [NSNumber numberWithInteger:box.value])];
