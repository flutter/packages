...
void main() {
  test('Agent Skills unit tests pass', () async {
    ...
    if (!skillsDir.existsSync()) {
      fail('The .agents/skills directory was not found. If this package has no skills, this test should be removed.');
    }

    final failedSkills = <String>[];

    final Iterable<Directory> skillDirs = skillsDir.listSync().whereType<Directory>();
