...
void main() {
  ...
  CameraXProxy getProxyForCreatingTestCamera({
    ...
    when(deviceOrientationManager.getUiOrientation())
        .thenAnswer((_) => getUiOrientation());
    when(deviceOrientationManager.getDefaultDisplayRotation())
  ...
  group('when handlesCropAndRotation is true', () {
    ...
    group('initial device orientation is landscapeRight,', () {
      ...
      late MockCameraSelector Function(
          ...
          // ignore: non_constant_identifier_names
          PigeonInstanceManager? pigeon_instanceManager,
          LensFacing? requireLensFacing}) fakeCreateCameraSelector;
    ...
    testWidgets(
      ...
      final MockDeviceOrientationManager mockDeviceOrientationManager =
          MockDeviceOrientationManager();
      when(mockDeviceOrientationManager.getUiOrientation()).thenAnswer((_) =>
          Future<String>.value(
      ...
      camera.proxy = getProxyForCreatingTestCameraWithDeviceOrientationManager(
          mockDeviceOrientationManager,
      ...
      for (final int currentDefaultDisplayRotation
        ...
        when(mockDeviceOrientationManager.getDefaultDisplayRotation())
            .thenAnswer(
                (_) => Future<int>.value(currentDefaultDisplayRotation));
