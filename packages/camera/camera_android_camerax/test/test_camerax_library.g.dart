  ...
  static void setup(TestPreviewHostApi? api, {BinaryMessenger? binaryMessenger}) {
    {
      ...
      if (api == null) {
        ...
        channel.setMockMessageHandler((Object? message) async {
          ...
          final ResolutionInfo? arg_targetResolution = (args[2] as ResolutionInfo?);
...
abstract class TestImageAnalysisAnalyzerHostApi {
  static const MessageCodec<Object?> codec = StandardMessageCodec();
  ...
  static void setup(TestImageAnalysisAnalyzerHostApi? api, {BinaryMessenger? binaryMessenger}) {
    {
      ...
      if (api == null) {
        ...
        channel.setMockMessageHandler((Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.ImageAnalysisAnalyzerHostApi.create was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_identifier = (args[0] as int?);
          assert(arg_identifier != null,
              'Argument for dev.flutter.pigeon.ImageAnalysisAnalyzerHostApi.create was null, expected non-null int.');
...
class _TestImageProxyHostApiCodec extends StandardMessageCodec {
  const _TestImageProxyHostApiCodec();
  @override
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is CameraPermissionsErrorData) {
      buffer.putUint8(128);
...
abstract class TestImageProxyHostApi {
  static const MessageCodec<Object?> codec = _TestImageProxyHostApiCodec();

  /// Handles Dart method `ImageProxy.getPlanes`.
  List<Object?> getPlanes(int identifier);
  ...
  static void setup(TestImageProxyHostApi? api, {BinaryMessenger? binaryMessenger}) {
    {
      ...
      if (api == null) {
        ...
        channel.setMockMessageHandler((Object? message) async {
          ...
          final List<Object?> output = api.getPlanes(arg_identifier!);
          return <Object?>[output];
        });
      }
    }
    {
      ...
      if (api == null) {
        ...
        channel.setMockMessageHandler((Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.ImageProxyHostApi.getFormat was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_identifier = (args[0] as int?);
          assert(arg_identifier != null,
              'Argument for dev.flutter.pigeon.ImageProxyHostApi.getFormat was null, expected non-null int.');
          final int output = api.getFormat(arg_identifier!);
          return <Object?>[output];
        });
      }
    }
    {
      ...
      if (api == null) {
        ...
        channel.setMockMessageHandler((Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.ImageProxyHostApi.getHeight was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_identifier = (args[0] as int?);
          assert(arg_identifier != null,
              'Argument for dev.flutter.pigeon.ImageProxyHostApi.getHeight was null, expected non-null int.');
          final int output = api.getHeight(arg_identifier!);
          return <Object?>[output];
        });
      }
    }
    {
      ...
      if (api == null) {
        ...
        channel.setMockMessageHandler((Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.ImageProxyHostApi.getWidth was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_identifier = (args[0] as int?);
          assert(arg_identifier != null,
              'Argument for dev.flutter.pigeon.ImageProxyHostApi.getWidth was null, expected non-null int.');
          final int output = api.getWidth(arg_identifier!);
          return <Object?>[output];
        });
      }
    }
...
abstract class TestImageProxyPlaneProxyHostApi {
  static const MessageCodec<Object?> codec = StandardMessageCodec();
  ...
  static void setup(TestImageProxyPlaneProxyHostApi? api, {BinaryMessenger? binaryMessenger}) {
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
      ...
      if (api == null) {
        ...
        channel.setMockMessageHandler((Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.ImageProxyPlaneProxyHostApi.getPixelStride was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_identifier = (args[0] as int?);
          assert(arg_identifier != null,
              'Argument for dev.flutter.pigeon.ImageProxyPlaneProxyHostApi.getPixelStride was null, expected non-null int.');
          final int output = api.getPixelStride(arg_identifier!);
          return <Object?>[output];
        });
      }
    }
    {
      ...
      if (api == null) {
        ...
        channel.setMockMessageHandler((Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.ImageProxyPlaneProxyHostApi.getBuffer was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_identifier = (args[0] as int?);
          assert(arg_identifier != null,
              'Argument for dev.flutter.pigeon.ImageProxyPlaneProxyHostApi.getBuffer was null, expected non-null int.');
          final Uint8List output = api.getBuffer(arg_identifier!);
          return <Object?>[output];
        });
      }
    }
    {
      ...
      if (api == null) {
        ...
        channel.setMockMessageHandler((Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.ImageProxyPlaneProxyHostApi.getRowStride was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_identifier = (args[0] as int?);
          assert(arg_identifier != null,
              'Argument for dev.flutter.pigeon.ImageProxyPlaneProxyHostApi.getRowStride was null, expected non-null int.');
          final int output = api.getRowStride(arg_identifier!);
          return <Object?>[output];
        });
      }
    }
