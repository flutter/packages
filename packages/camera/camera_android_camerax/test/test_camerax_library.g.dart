...
abstract class TestQualitySelectorHostApi {
  ...
  void create(int identifier, List<int?> videoQualityConstraintIndexList, int? fallbackStrategyId);

  ResolutionInfo getResolution(int cameraInfoId, VideoQualityConstraint quality);
  ...
  static void setup(TestQualitySelectorHostApi? api, {BinaryMessenger? binaryMessenger}) {
    {
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, (Object? message) async {
          ...
          final List<int?>? arg_videoQualityConstraintIndexList = (args[1] as List<Object?>?)?.cast<int?>();
    ...
    }
    {
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, (Object? message) async {
          ...
          final VideoQualityConstraint? arg_quality = args[1] == null ? null : VideoQualityConstraint.values[args[1] as int];
...
abstract class TestFallbackStrategyHostApi {
  ...
  void create(int identifier, VideoQualityConstraint quality, VideoResolutionFallbackRule fallbackRule);
