...
abstract class TestResolutionFilterHostApi {
  ...
  void setSynchronousReturnValueForFilter(int identifier, List<ResolutionInfo?> filteredResolutions);

  static void setup(TestResolutionFilterHostApi? api, {BinaryMessenger? binaryMessenger}) {
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.ResolutionFilterHostApi.create', codec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, null);
      } else {
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, (Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.ResolutionFilterHostApi.create was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_identifier = (args[0] as int?);
          assert(arg_identifier != null,
              'Argument for dev.flutter.pigeon.ResolutionFilterHostApi.create was null, expected non-null int.');
          api.create(arg_identifier!);
          return <Object?>[];
        });
      }
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.ResolutionFilterHostApi.setSynchronousReturnValueForFilter', codec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, null);
      } else {
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, (Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.ResolutionFilterHostApi.setSynchronousReturnValueForFilter was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_identifier = (args[0] as int?);
          assert(arg_identifier != null,
              'Argument for dev.flutter.pigeon.ResolutionFilterHostApi.setSynchronousReturnValueForFilter was null, expected non-null int.');
          final List<ResolutionInfo?>? arg_filteredResolutions = (args[1] as List<Object?>?)?.cast<ResolutionInfo?>();
          assert(arg_filteredResolutions != null,
              'Argument for dev.flutter.pigeon.ResolutionFilterHostApi.setSynchronousReturnValueForFilter was null, expected non-null List<ResolutionInfo?>.');
          api.setSynchronousReturnValueForFilter(arg_identifier!, arg_filteredResolutions!);
          return <Object?>[];
        });
      }
    }
