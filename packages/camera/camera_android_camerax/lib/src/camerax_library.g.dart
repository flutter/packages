...
class QualityData {
  ...
  static QualityData decode(Object result) {
    result as List<Object?>;
    return QualityData(
      quality: Quality.values[result[0]! as int],
    );
  }
}
...
class ImageCaptureHostApi {
  ...
  Future<void> create(int arg_identifier, int? arg_flashMode, int? arg_resolutionSelectorId) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.ImageCaptureHostApi.create', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_identifier, arg_flashMode, arg_resolutionSelectorId]) as List<Object?>?;
    if (replyList == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
...
class ImageAnalysisHostApi {
  ...
  Future<void> create(int arg_identifier, int? arg_resolutionSelectorId) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        ...
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_identifier, arg_resolutionSelectorId]) as List<Object?>?;
    if (replyList == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
...
class _QualitySelectorHostApiCodec extends StandardMessageCodec {
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      case 128: 
        return QualityData.decode(readValue(buffer)!);
      case 129: 
        return ResolutionInfo.decode(readValue(buffer)!);
      default:
        return super.readValueOfType(type, buffer);
...
class QualitySelectorHostApi {
  ...
  Future<void> create(int arg_identifier, List<QualityData?> arg_videoQualityConstraintIndexList, int? arg_fallbackStrategyId) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.QualitySelectorHostApi.create', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_identifier, arg_videoQualityConstraintIndexList, arg_fallbackStrategyId]) as List<Object?>?;
    if (replyList == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
  ...
  Future<ResolutionInfo> getResolution(int arg_cameraInfoId, Quality arg_quality) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
...
class FallbackStrategyHostApi {
  ...
  Future<void> create(int arg_identifier, Quality arg_quality, VideoResolutionFallbackRule arg_fallbackRule) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
