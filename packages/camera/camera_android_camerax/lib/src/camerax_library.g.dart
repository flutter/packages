...
class QualitySelectorHostApi {
  ...
  Future<void> create(int arg_identifier, List<int?> arg_videoQualityConstraintIndexList, int? arg_fallbackStrategyId) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
  ...
  Future<ResolutionInfo> getResolution(int arg_cameraInfoId, VideoQualityConstraint arg_quality) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
...
class FallbackStrategyHostApi {
  ...
  Future<void> create(int arg_identifier, VideoQualityConstraint arg_quality, VideoResolutionFallbackRule arg_fallbackRule) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
