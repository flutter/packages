...
class CameraSize {
  ...
  static CameraSize decode(Object result) {
    result as List<Object?>;
    return CameraSize(
      width: result[0]! as int,
      height: result[1]! as int,
...
class RecorderHostApi {
  ...
  Future<void> create(int arg_identifier, int? arg_aspectRatio, int? arg_bitRate) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        ...
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_identifier, arg_aspectRatio, arg_bitRate]) as List<Object?>?;
    if (replyList == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
...
class _ResolutionStrategyHostApiCodec extends StandardMessageCodec {
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      case 128: 
        return CameraSize.decode(readValue(buffer)!);
      default:
        return super.readValueOfType(type, buffer);
    }
  }
...
class ResolutionStrategyHostApi {
  ...
  Future<void> create(int arg_identifier, CameraSize arg_boundSize, int arg_fallbackRule) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
