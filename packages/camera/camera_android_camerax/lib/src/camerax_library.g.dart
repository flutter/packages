...
class PigeonOverrides {
  ...
  static Future<Uint8List> Function(ImageProxy)? imageProxyUtils_getNv21Buffer;
...
class ImageProxyUtils extends PigeonInternalProxyApiBaseClass {
  ...
  static Future<Uint8List> getNv21Buffer(
    ...
    if (PigeonOverrides.imageProxyUtils_getNv21Buffer != null) {
      return PigeonOverrides.imageProxyUtils_getNv21Buffer!(imageProxy);
    }
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec = _PigeonInternalProxyApiBaseCodec(
      pigeon_instanceManager ?? PigeonInstanceManager.instance,
    );
    ...
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[imageProxy]);
    final pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
