...
class DisplayOrientedMeteringPointFactoryHostApi {
  ...
  Future<void> create(int arg_identifier, int arg_cameraInfoId, int arg_width, int arg_height) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.DisplayOrientedMeteringPointFactoryHostApi.create', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_identifier, arg_cameraInfoId, arg_width, arg_height]) as List<Object?>?;
    if (replyList == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
  ...
  Future<int> createPoint(int arg_x, int arg_y, int? arg_size) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.DisplayOrientedMeteringPointFactoryHostApi.createPoint', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_x, arg_y, arg_size]) as List<Object?>?;
    if (replyList == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
  ...
  Future<int> getDefaultPointSize() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
