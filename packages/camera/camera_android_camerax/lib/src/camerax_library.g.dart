...
class ResolutionFilterHostApi {
  ...
  Future<void> setSynchronousReturnValueForFilter(int arg_identifier, List<ResolutionInfo?> arg_filteredResolutions) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.ResolutionFilterHostApi.setSynchronousReturnValueForFilter', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_identifier, arg_filteredResolutions]) as List<Object?>?;
    if (replyList == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
...
class _ResolutionFilterFlutterApiCodec extends StandardMessageCodec {
  const _ResolutionFilterFlutterApiCodec();
  @override
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is ResolutionInfo) {
      buffer.putUint8(128);
...
abstract class ResolutionFilterFlutterApi {
  ...
  static void setup(ResolutionFilterFlutterApi? api, {BinaryMessenger? binaryMessenger}) {
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.ResolutionFilterFlutterApi.filter', codec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        channel.setMessageHandler(null);
      } else {
        channel.setMessageHandler((Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.ResolutionFilterFlutterApi.filter was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_identifier = (args[0] as int?);
          assert(arg_identifier != null,
              'Argument for dev.flutter.pigeon.ResolutionFilterFlutterApi.filter was null, expected non-null int.');
          final List<ResolutionInfo?>? arg_supportedSizes = (args[1] as List<Object?>?)?.cast<ResolutionInfo?>();
          assert(arg_supportedSizes != null,
              'Argument for dev.flutter.pigeon.ResolutionFilterFlutterApi.filter was null, expected non-null List<ResolutionInfo?>.');
