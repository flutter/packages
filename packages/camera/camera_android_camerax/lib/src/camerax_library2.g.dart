...
class SystemServicesHostApi {
  ...
  SystemServicesHostApi({BinaryMessenger? binaryMessenger, String messageChannelSuffix = ''})
      : pigeonVar_binaryMessenger = binaryMessenger,
  ...
  Future<CameraPermissionsErrorData?> requestCameraPermissions(bool enableAudio) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.camera_android_camerax.SystemServicesHostApi.requestCameraPermissions$pigeonVar_messageChannelSuffix';
  ...
  Future<String> getTempFilePath(String prefix, String suffix) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.camera_android_camerax.SystemServicesHostApi.getTempFilePath$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    ...
    final List<Object?>? pigeonVar_replyList =
        await pigeonVar_channel.send(<Object?>[prefix, suffix]) as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
      throw PlatformException(
  ...
  Future<bool> isPreviewPreTransformed() async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.camera_android_camerax.SystemServicesHostApi.isPreviewPreTransformed$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
...
abstract class SystemServicesFlutterApi {
  ...
  static void setUp(SystemServicesFlutterApi? api, {BinaryMessenger? binaryMessenger, String messageChannelSuffix = '',}) {
    messageChannelSuffix = messageChannelSuffix.isNotEmpty ? '.$messageChannelSuffix' : '';
    {
      final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.camera_android_camerax.SystemServicesFlutterApi.onCameraError$messageChannelSuffix', pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        pigeonVar_channel.setMessageHandler(null);
      } else {
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.camera_android_camerax.SystemServicesFlutterApi.onCameraError was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final String? arg_errorDescription = (args[0] as String?);
          assert(arg_errorDescription != null,
              'Argument for dev.flutter.pigeon.camera_android_camerax.SystemServicesFlutterApi.onCameraError was null, expected non-null String.');
          try {
...
class Preview extends UseCase {
  ...
  static void pigeon_setUpMessageHandlers({
    ...
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
    Preview Function()? pigeon_newInstance,
  }) {
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec =
        _PigeonInternalProxyApiBaseCodec(
            pigeon_instanceManager ?? PigeonInstanceManager.instance);
...
class ImageCapture extends UseCase {
  ...
  static void pigeon_setUpMessageHandlers({
    ...
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
    ImageCapture Function()? pigeon_newInstance,
  }) {
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec =
        _PigeonInternalProxyApiBaseCodec(
            pigeon_instanceManager ?? PigeonInstanceManager.instance);
...
class ImageAnalysis extends UseCase {
  ...
  static void pigeon_setUpMessageHandlers({
    ...
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
    ImageAnalysis Function()? pigeon_newInstance,
  }) {
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec =
        _PigeonInternalProxyApiBaseCodec(
            pigeon_instanceManager ?? PigeonInstanceManager.instance);
