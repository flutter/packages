        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val resolutionSelectorArg =
                args[2] as androidx.camera.core.resolutionselector.ResolutionSelector?
            val wrapped: List<Any?> =
                try {
                  api.pigeonRegistrar.instanceManager.addDartCreatedInstance(
                      api.pigeon_defaultConstructor(targetRotationArg, resolutionSelectorArg),
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val resolutionSelectorArg =
                args[3] as androidx.camera.core.resolutionselector.ResolutionSelector?
            val wrapped: List<Any?> =
                try {
                  api.pigeonRegistrar.instanceManager.addDartCreatedInstance(
                      api.pigeon_defaultConstructor(
                          targetRotationArg, flashModeArg, resolutionSelectorArg),
                      pigeon_identifierArg)
                  listOf(null)
                } catch (exception: Throwable) {
                  wrapError(exception)
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val aspectRatioStrategyArg =
                args[1] as androidx.camera.core.resolutionselector.AspectRatioStrategy?
            val resolutionStrategyArg =
                args[2] as androidx.camera.core.resolutionselector.ResolutionStrategy?
            val resolutionFilterArg =
                args[3] as androidx.camera.core.resolutionselector.ResolutionFilter?
            val wrapped: List<Any?> =
                try {
                  api.pigeonRegistrar.instanceManager.addDartCreatedInstance(
                      api.pigeon_defaultConstructor(
                          aspectRatioStrategyArg, resolutionStrategyArg, resolutionFilterArg),
                      pigeon_identifierArg)
                  listOf(null)
                } catch (exception: Throwable) {
                  wrapError(exception)
