...
public class GeneratedCameraXLibrary {
  ...
  public static final class ExposureRange {
    private @NonNull Double minCompensation;

    public @NonNull Double getMinCompensation() {
      return minCompensation;
    }

    public void setMinCompensation(@NonNull Double setterArg) {
      if (setterArg == null) {
    ...
    private @NonNull Double maxCompensation;

    public @NonNull Double getMaxCompensation() {
      return maxCompensation;
    }

    public void setMaxCompensation(@NonNull Double setterArg) {
      if (setterArg == null) {
    ...
    /** Constructor is private to enforce null safety; use Builder. */
    private ExposureRange() {}

    public static final class Builder {

      private @Nullable Double minCompensation;

      public @NonNull Builder setMinCompensation(@NonNull Double setterArg) {
        this.minCompensation = setterArg;
        return this;
      }

      private @Nullable Double maxCompensation;

      public @NonNull Builder setMaxCompensation(@NonNull Double setterArg) {
        this.maxCompensation = setterArg;
        return this;
      }
    ...
    static @NonNull ExposureRange fromList(@NonNull ArrayList<Object> list) {
      ...
      pigeonResult.setMinCompensation((Double) minCompensation);
      Object maxCompensation = list.get(1);
      pigeonResult.setMaxCompensation((Double) maxCompensation);
      return pigeonResult;
    }
  }
  ...
  private static class ExposureStateHostApiCodec extends StandardMessageCodec {
    public static final ExposureStateHostApiCodec INSTANCE = new ExposureStateHostApiCodec();

    private ExposureStateHostApiCodec() {}
  ...
  /** Generated interface from Pigeon that represents a handler of messages from Flutter. */
  public interface ExposureStateHostApi {

    @NonNull 
    ExposureRange getExposureCompensationRange(@NonNull Long identifier);

    @NonNull 
    Double getExposureCompensationStep(@NonNull Long identifier);

    /** The codec used by ExposureStateHostApi. */
    static MessageCodec<Object> getCodec() {
      return ExposureStateHostApiCodec.INSTANCE;
    }
    /**Sets up an instance of `ExposureStateHostApi` to handle messages through the `binaryMessenger`. */
    static void setup(BinaryMessenger binaryMessenger, ExposureStateHostApi api) {
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.ExposureStateHostApi.getExposureCompensationRange", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ...
                Number identifierArg = (Number) args.get(0);
                try {
                  ExposureRange output = api.getExposureCompensationRange((identifierArg == null) ? null : identifierArg.longValue());
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.ExposureStateHostApi.getExposureCompensationStep", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ...
                Number identifierArg = (Number) args.get(0);
                try {
                  Double output = api.getExposureCompensationStep((identifierArg == null) ? null : identifierArg.longValue());
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
  ...
  public static class ExposureStateFlutterApi {
    ...
    public ExposureStateFlutterApi(BinaryMessenger argBinaryMessenger) {
      this.binaryMessenger = argBinaryMessenger;
    }
  ...
  /** Generated interface from Pigeon that represents a handler of messages from Flutter. */
  public interface ZoomStateHostApi {

    @NonNull 
    Double getMaxZoomRatio(@NonNull Long identifier);

    @NonNull 
    Double getMinZoomRatio(@NonNull Long identifier);

    /** The codec used by ZoomStateHostApi. */
    static MessageCodec<Object> getCodec() {
      return new StandardMessageCodec();
    }
    /**Sets up an instance of `ZoomStateHostApi` to handle messages through the `binaryMessenger`. */
    static void setup(BinaryMessenger binaryMessenger, ZoomStateHostApi api) {
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.ZoomStateHostApi.getMaxZoomRatio", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ...
                Number identifierArg = (Number) args.get(0);
                try {
                  Double output = api.getMaxZoomRatio((identifierArg == null) ? null : identifierArg.longValue());
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.ZoomStateHostApi.getMinZoomRatio", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ...
                Number identifierArg = (Number) args.get(0);
                try {
                  Double output = api.getMinZoomRatio((identifierArg == null) ? null : identifierArg.longValue());
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
