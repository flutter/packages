...
public class GeneratedCameraXLibrary {
  ...
  public interface ResolutionFilterHostApi {
    ...
    void setSynchronousReturnValueForFilter(@NonNull Long identifier, @NonNull List<ResolutionInfo> filteredResolutions);
    ...
    static void setup(@NonNull BinaryMessenger binaryMessenger, @Nullable ResolutionFilterHostApi api) {
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.ResolutionFilterHostApi.create", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.ResolutionFilterHostApi.setSynchronousReturnValueForFilter", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ArrayList<Object> args = (ArrayList<Object>) message;
                Number identifierArg = (Number) args.get(0);
                List<ResolutionInfo> filteredResolutionsArg = (List<ResolutionInfo>) args.get(1);
                try {
                  api.setSynchronousReturnValueForFilter((identifierArg == null) ? null : identifierArg.longValue(), filteredResolutionsArg);
                  wrapped.add(0, null);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
  ...
  private static class ResolutionFilterFlutterApiCodec extends StandardMessageCodec {
    public static final ResolutionFilterFlutterApiCodec INSTANCE = new ResolutionFilterFlutterApiCodec();

    private ResolutionFilterFlutterApiCodec() {}
  ...
  /** Generated class from Pigeon that represents Flutter messages that can be called from Java. */
  public static class ResolutionFilterFlutterApi {
    private final @NonNull BinaryMessenger binaryMessenger;

    public ResolutionFilterFlutterApi(@NonNull BinaryMessenger argBinaryMessenger) {
      this.binaryMessenger = argBinaryMessenger;
    }
    ...
    /** The codec used by ResolutionFilterFlutterApi. */
    static @NonNull MessageCodec<Object> getCodec() {
      return ResolutionFilterFlutterApiCodec.INSTANCE;
    }
    public void filter(@NonNull Long identifierArg, @NonNull List<ResolutionInfo> supportedSizesArg, @NonNull Long rotationDegreesArg, @NonNull Reply<List<ResolutionInfo>> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(
              binaryMessenger, "dev.flutter.pigeon.ResolutionFilterFlutterApi.filter", getCodec());
      channel.send(
          new ArrayList<Object>(Arrays.asList(identifierArg, supportedSizesArg, rotationDegreesArg)),
          channelReply -> {
            @SuppressWarnings("ConstantConditions")
            List<ResolutionInfo> output = (List<ResolutionInfo>) channelReply;
