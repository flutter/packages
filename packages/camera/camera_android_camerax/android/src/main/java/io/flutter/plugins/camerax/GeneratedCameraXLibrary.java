...
public class GeneratedCameraXLibrary {
  ...
  public static final class DeviceOrientationInfo {
    ...
    static @NonNull DeviceOrientationInfo fromList(@NonNull ArrayList<Object> list) {
      ...
      pigeonResult.setDefaultDisplayRotation((defaultDisplayRotation == null) ? null : ((defaultDisplayRotation instanceof Integer) ? (Integer) defaultDisplayRotation : (Long) defaultDisplayRotation));
      return pigeonResult;
    }
  }
  ...
  public interface SystemServicesHostApi {
    ...
    static void setup(@NonNull BinaryMessenger binaryMessenger, @Nullable SystemServicesHostApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.SystemServicesHostApi.isPreviewPreTransformed", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
  ...
  public interface DeviceOrientationManagerHostApi {
    ...
    static void setup(@NonNull BinaryMessenger binaryMessenger, @Nullable DeviceOrientationManagerHostApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.DeviceOrientationManagerHostApi.getDeviceOrientation", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
  ...
  private static class DeviceOrientationManagerFlutterApiCodec extends StandardMessageCodec {
    public static final DeviceOrientationManagerFlutterApiCodec INSTANCE = new DeviceOrientationManagerFlutterApiCodec();
  ...
  public static class DeviceOrientationManagerFlutterApi {
    ...
    public void onDeviceOrientationChanged(@NonNull DeviceOrientationInfo deviceOrientationInfoArg, @NonNull Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(
