...
public class GeneratedCameraXLibrary {
  ...
  public interface RecorderHostApi {
    ...
    void create(@NonNull Long identifier, @Nullable Long aspectRatio, @Nullable Long bitRate, @Nullable Long qualitySelector);
        ...
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ...
                try {
                  api.create((identifierArg == null) ? null : identifierArg.longValue(), (aspectRatioArg == null) ? null : aspectRatioArg.longValue(), (bitRateArg == null) ? null : bitRateArg.longValue(), (qualitySelectorArg == null) ? null : qualitySelectorArg.longValue());
                  wrapped.add(0, null);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
