...
public class GeneratedCameraXLibrary {
    ...
    static void setup(BinaryMessenger binaryMessenger, CameraInfoHostApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger,
                "dev.flutter.pigeon.CameraInfoHostApi.getLiveCameraState",
                getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
  ...
  public interface LiveCameraStateHostApi {
    ...
    /**
     * Sets up an instance of `LiveCameraStateHostApi` to handle messages through the
     * `binaryMessenger`.
     */
    static void setup(BinaryMessenger binaryMessenger, LiveCameraStateHostApi api) {
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger,
                "dev.flutter.pigeon.LiveCameraStateHostApi.addObserver",
                getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger,
                "dev.flutter.pigeon.LiveCameraStateHostApi.removeObservers",
                getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
  ...
  private static class LiveCameraStateFlutterApiCodec extends StandardMessageCodec {
    public static final LiveCameraStateFlutterApiCodec INSTANCE =
        new LiveCameraStateFlutterApiCodec();
  ...
  public static class LiveCameraStateFlutterApi {
    ...
    public void onCameraClosing(Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(
              binaryMessenger,
              "dev.flutter.pigeon.LiveCameraStateFlutterApi.onCameraClosing",
              getCodec());
      channel.send(
          null,
          channelReply -> {
