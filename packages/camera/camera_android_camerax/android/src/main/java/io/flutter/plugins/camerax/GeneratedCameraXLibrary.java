...
public class GeneratedCameraXLibrary {
  ...
  public static class ExposureStateFlutterApi {
    ...
    public void create(@NonNull Long identifierArg, @NonNull ExposureRange exposureCompensationRangeArg, @NonNull Double exposureCompensationStepArg, @NonNull Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(
  ...
  public static class ZoomStateFlutterApi {
    ...
    public void create(@NonNull Long identifierArg, @NonNull Long minZoomRatioArg, @NonNull Long maxZoomRatioArg, @NonNull Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(
