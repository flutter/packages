...
public class GeneratedCameraXLibrary {
  ...
  public interface CameraInfoHostApi {
    ...
    @NonNull 
    Long getLensFacing(@NonNull Long identifier);
    ...
    static void setup(@NonNull BinaryMessenger binaryMessenger, @Nullable CameraInfoHostApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.CameraInfoHostApi.getLensFacing", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ...
                Number identifierArg = (Number) args.get(0);
                try {
                  Long output = api.getLensFacing((identifierArg == null) ? null : identifierArg.longValue());
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
