...
public class GeneratedCameraXLibrary {
  ...
  public interface DisplayOrientedMeteringPointFactoryHostApi {
    ...
    void create(@NonNull Long identifier, @NonNull Long cameraInfoId, @NonNull Long width, @NonNull Long height);
    ...
    /**Sets up an instance of `DisplayOrientedMeteringPointFactoryHostApi` to handle messages through the `binaryMessenger`. */
    static void setup(@NonNull BinaryMessenger binaryMessenger, @Nullable DisplayOrientedMeteringPointFactoryHostApi api) {
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.DisplayOrientedMeteringPointFactoryHostApi.create", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ...
                try {
                  api.create((identifierArg == null) ? null : identifierArg.longValue(), (cameraInfoIdArg == null) ? null : cameraInfoIdArg.longValue(), (widthArg == null) ? null : widthArg.longValue(), (heightArg == null) ? null : heightArg.longValue());
                  wrapped.add(0, null);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.DisplayOrientedMeteringPointFactoryHostApi.createPoint", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ...
                try {
                  Long output = api.createPoint((xArg == null) ? null : xArg.longValue(), (yArg == null) ? null : yArg.longValue(), (sizeArg == null) ? null : sizeArg.longValue());
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.DisplayOrientedMeteringPointFactoryHostApi.getDefaultPointSize", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
