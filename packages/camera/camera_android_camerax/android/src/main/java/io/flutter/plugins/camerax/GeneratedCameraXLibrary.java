...
public class GeneratedCameraXLibrary {
  ...
  public interface CameraInfoHostApi {
    ...
    @NonNull Long getLiveCameraState(@NonNull Long identifier);
    ...
    static void setup(BinaryMessenger binaryMessenger, CameraInfoHostApi api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.CameraInfoHostApi.getLiveCameraState", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
  ...
  public interface CameraHostApi {
    @NonNull Long getCameraInfo(@NonNull Long identifier);
    ...
    static void setup(BinaryMessenger binaryMessenger, CameraHostApi api) {
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.CameraHostApi.getCameraInfo", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
      ...
      } else 
{
  ...
  private static class LiveCameraStateHostApiCodec extends StandardMessageCodec {
    public static final LiveCameraStateHostApiCodec INSTANCE = new LiveCameraStateHostApiCodec();
    private LiveCameraStateHostApiCodec() {}
  }
  ...
  public interface LiveCameraStateHostApi {
    ...
    static MessageCodec<Object> getCodec() {
      return LiveCameraStateHostApiCodec.INSTANCE;
    }

    /** Sets up an instance of `LiveCameraStateHostApi` to handle messages through the `binaryMessenger`. */
    static void setup(BinaryMessenger binaryMessenger, LiveCameraStateHostApi api) {
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.LiveCameraStateHostApi.addObserver", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.LiveCameraStateHostApi.removeObservers", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
  ...
  private static class LiveCameraStateFlutterApiCodec extends StandardMessageCodec {
    public static final LiveCameraStateFlutterApiCodec INSTANCE = new LiveCameraStateFlutterApiCodec();
    private LiveCameraStateFlutterApiCodec() {}
  }

  /** Generated class from Pigeon that represents Flutter messages that can be called from Java.*/
  public static class LiveCameraStateFlutterApi {
    private final BinaryMessenger binaryMessenger;
    public LiveCameraStateFlutterApi(BinaryMessenger argBinaryMessenger){
      this.binaryMessenger = argBinaryMessenger;
    }
    public interface Reply<T> {
      void reply(T reply);
    ...
    static MessageCodec<Object> getCodec() {
      return LiveCameraStateFlutterApiCodec.INSTANCE;
    }

    public void create(@NonNull Long identifierArg, Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.LiveCameraStateFlutterApi.create", getCodec());
      channel.send(new ArrayList<Object>(Arrays.asList(identifierArg)), channelReply -> {
        callback.reply(null);
      });
    }
    public void onCameraClosing(Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.LiveCameraStateFlutterApi.onCameraClosing", getCodec());
