...
public class ImageAnalysisTest {
  ...
  public void setAnalyzer_setsAnalyzerThatSendsExpectedImageInformation() {
    final ImageAnalysisHostApiImpl imageAnalysisHostApiImpl =
        new ImageAnalysisHostApiImpl(mockBinaryMessenger, testInstanceManager);
    final ImageAnalysisFlutterApiImpl mockImageAnalysisFlutterApiImpl =
        mock(ImageAnalysisFlutterApiImpl.class);
    ...
    imageAnalysisHostApiImpl.cameraXProxy = mockCameraXProxy;
    when(mockCameraXProxy.createImageAnalysisFlutterApiImpl(mockBinaryMessenger))
        .thenReturn(mockImageAnalysisFlutterApiImpl);
    ...
    final ArgumentCaptor<GeneratedCameraXLibrary.ImageInformation> imageInformationCaptor =
        ArgumentCaptor.forClass(GeneratedCameraXLibrary.ImageInformation.class);

    analyzer.analyze(mockImageProxy);

    verify(mockImageAnalysisFlutterApiImpl)
        .sendOnImageAnalyzedEvent(imageInformationCaptor.capture(), any());
    ...
    List<ImagePlaneInformation> imagePlanesInformation =
        imageInformation.getImagePlanesInformation();
