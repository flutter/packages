...
public class ImageAnalysisTest {
  ...
  public void pigeon_defaultConstructor_createsExpectedImageAnalysisInstance() {
    ...
    final long outputImageFormat = ImageAnalysis.OUTPUT_IMAGE_FORMAT_YUV_NV21;
    final ImageAnalysis imageAnalysis =
        api.pigeon_defaultConstructor(mockResolutionSelector, targetResolution, targetResolution);
