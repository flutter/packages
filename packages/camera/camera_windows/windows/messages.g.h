...
class PlatformVideoCaptureOptions {
 public:
  ...
  // Constructs an object setting all fields.
  explicit PlatformVideoCaptureOptions(const int64_t* max_duration_milliseconds);
 ...
 private:
  static PlatformVideoCaptureOptions FromEncodableList(const flutter::EncodableList& list);
  flutter::EncodableList ToEncodableList() const;
  friend class CameraApi;
  friend class PigeonCodecSerializer;
...
class CameraApi {
 public:
  ...
  virtual void StartVideoRecording(
    int64_t camera_id,
    const PlatformVideoCaptureOptions& options,
