...
class PlatformMediaSettings {
 public:
  ...
  bool operator==(const PlatformMediaSettings& other) const;
  bool operator!=(const PlatformMediaSettings& other) const;
...
class PlatformSize {
 public:
  ...
  bool operator==(const PlatformSize& other) const;
  bool operator!=(const PlatformSize& other) const;
  /// Returns a hash code value for the object. This method is supported for the
  /// benefit of hash tables.
  size_t Hash() const;
  /// Stream output operator for formatted string representation.
  friend std::ostream& operator<<(std::ostream& os, const PlatformSize& obj);
...
class CameraApi {
 public:
  ...
  static void SetUp(::flutter::BinaryMessenger* binary_messenger,
                    CameraApi* api);
  static void SetUp(::flutter::BinaryMessenger* binary_messenger,
                    CameraApi* api, const std::string& message_channel_suffix);
