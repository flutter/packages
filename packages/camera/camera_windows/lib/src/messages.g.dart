...
class CameraApi {
  ...
  Future<String> create(String cameraName, ResolutionPreset? resolutionPreset,
    ...
    final List<Object?>? __pigeon_replyList = await __pigeon_channel
            .send(<Object?>[cameraName, resolutionPreset?.index, enableAudio])
        as List<Object?>?;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
  ...
  Future<PlatformSize> dispose(int cameraId) async {
    final String __pigeon_channelName =
