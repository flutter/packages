...
void main() {
  ...
  group('$MethodChannelCamera', () {
    ...
    group('Function Tests', () {
      ...
      test('Should take a picture and return an XFile instance with jpg extension', () async {
        // Arrange
        final MethodChannelMock channel = MethodChannelMock(
            channelName: 'plugins.flutter.io/camera', methods: <String, dynamic>{'takePicture': '/test/path.jpg'});
      ...
      test('Should take a picture and return an XFile instance with heic extension', () async {
        // Arrange
        final MethodChannelMock channel = MethodChannelMock(
            channelName: 'plugins.flutter.io/camera', methods: <String, dynamic>{'takePicture': '/test/path.heic'});
