...
void main() {
  ...
  group('$CameraPlatform', () {
    ...
    test(
      'Default implementation of setZeroShutterLagEnabled() should throw unimplemented error',
      () {
        // Arrange
        final cameraPlatform = ExtendsCameraPlatform();

        // Act & Assert
        expect(() => cameraPlatform.setZeroShutterLagEnabled(1, true), throwsUnimplementedError);
      },
    );
