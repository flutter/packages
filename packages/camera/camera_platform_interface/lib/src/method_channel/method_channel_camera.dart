...
class MethodChannelCamera extends CameraPlatform {
  ...
  @override
  Future<XFile> takePicture(int cameraId, {ImageExtension imageExtension = ImageExtension.jpeg}) async {
    final String? path = await _channel.invokeMethod<String>(
      'takePicture',
      <String, dynamic>{'cameraId': cameraId, 'imageExtension': _serializeImageExtension(imageExtension)},
    );
