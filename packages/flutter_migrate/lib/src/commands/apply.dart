...
class MigrateApplyCommand extends MigrateCommand {
  ...
  Future<CommandResult> runCommand() async {
    ...
    final FlutterToolsEnvironment environment = await FlutterToolsEnvironment.initializeFlutterToolsEnvironment(logger);
    ...
    final String currentGitHash = environment.getString('FlutterVersion.frameworkRevision') ?? '';
