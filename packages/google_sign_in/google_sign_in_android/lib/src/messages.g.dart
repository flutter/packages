...
class PlatformRevokeAccessRequest {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(accountEmail, other.accountEmail) && _deepEquals(scopes, other.scopes);
  }
...
class PlatformGoogleIdTokenCredential {
  ...
  static PlatformGoogleIdTokenCredential decode(Object result) {
    ...
    return PlatformGoogleIdTokenCredential(
      ...
      uniqueId: result[4]! as String,
      idToken: result[5]! as String,
      profilePictureUri: result[6] as String?,
    );
  }
...
class GetCredentialSuccess extends GetCredentialResult {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(credential, other.credential);
  }
