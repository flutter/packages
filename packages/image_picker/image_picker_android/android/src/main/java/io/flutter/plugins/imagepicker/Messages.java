...
public class Messages {
  ...
  public static final class VideoSelectionOptions {
     ...
     */
    private @Nullable Long videoQuality;

    public @Nullable Long getVideoQuality() {
      return videoQuality;
    }

    public void setVideoQuality(@Nullable Long setterArg) {
      this.videoQuality = setterArg;
    }
    ...
    public boolean equals(Object o) {
      ...
      return Objects.equals(maxDurationSeconds, that.maxDurationSeconds) && Objects.equals(videoQuality, that.videoQuality);
    }

    @Override
    public int hashCode() {
      return Objects.hash(maxDurationSeconds, videoQuality);
    }
    ...
    public static final class Builder {
      ...
      @CanIgnoreReturnValue
      public @NonNull Builder setVideoQuality(@Nullable Long setterArg) {
        this.videoQuality = setterArg;
        return this;
      }
      ...
      public @NonNull VideoSelectionOptions build() {
        ...
        pigeonReturn.setVideoQuality(videoQuality);
        return pigeonReturn;
      }
    }
    ...
    static @NonNull VideoSelectionOptions fromList(@NonNull ArrayList<Object> pigeonVar_list) {
      ...
      Object videoQuality = pigeonVar_list.get(1);
      pigeonResult.setVideoQuality((Long) videoQuality);
      return pigeonResult;
    }
  }
