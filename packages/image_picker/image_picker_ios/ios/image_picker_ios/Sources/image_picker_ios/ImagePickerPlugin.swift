...
internal typealias FlutterResultAdapter = ([String]?, Error?) -> Void

internal class ImagePickerMethodCallContext {
...
internal protocol DeviceCapabilityHandler {
...
internal final class DefaultDeviceCapabilityHandler: DeviceCapabilityHandler {
  func isSourceTypeAvailable(_ sourceType: UIImagePickerController.SourceType) -> Bool {
  ...
  PHPickerViewControllerDelegate, UIAdaptivePresentationControllerDelegate
{
  ...
  internal let deviceCapabilityHandler: DeviceCapabilityHandler
  internal var interactionBlockerWindow: UIWindow?
  internal weak var previousKeyWindow: UIWindow?

  internal var callContext: ImagePickerMethodCallContext?
  ...
  @available(iOS 14, *)
  internal func launchPHPicker(with context: ImagePickerMethodCallContext) {
  ...
  internal func launchUIImagePicker(
  ...
  internal func cancelInProgressCall() {
    if callContext != nil {
      let pigeonError = PigeonError(
  ...
  internal func checkCameraAuthorization(
    with imagePickerController: UIImagePickerController,
  ...
  internal func checkPhotoAuthorization(with pickerViewController: UIViewController) {
  ...
  internal func errorNoCameraAccess(_ status: AVAuthorizationStatus) {
  ...
  internal func errorNoPhotoAccess(_ status: PHAuthorizationStatus) {
  ...
  internal func showPhotoLibrary(with pickerViewController: UIViewController) {
  ...
  internal func getDesiredImageQuality(_ imageQuality: Double?) -> Double {
  ...
  @available(iOS 14, *)
  internal func handlePickerResults(_ results: [PHPickerResult]) {
