...
typedef NS_ENUM(NSUInteger, FLTApiVideoQuality) {
  FLTApiVideoQualityLow = 0,
  FLTApiVideoQualityMedium = 1,
  FLTApiVideoQualityHigh = 2,
};

/// Wrapper for FLTApiVideoQuality to allow for nullability.
@interface FLTApiVideoQualityBox : NSObject
@property(nonatomic, assign) FLTApiVideoQuality value;
...
- (void)pickVideoWithSource:(FLTSourceSpecification *)source maxDuration:(nullable NSNumber *)maxDurationSeconds videoQuality:(nullable FLTApiVideoQualityBox *)videoQualityBoxed completion:(void (^)(NSString *_Nullable, FlutterError *_Nullable))completion;
...
extern void SetUpFLTImagePickerApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FLTImagePickerApi> *_Nullable api, NSString *messageChannelSuffix);
