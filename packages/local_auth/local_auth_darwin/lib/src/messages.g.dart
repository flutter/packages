...
class AuthStrings {
  ...
  @override
  String toString() {
    return 'AuthStrings(reason: $reason, cancelButton: $cancelButton, localizedFallbackTitle: $localizedFallbackTitle)';
  }
}
...
class AuthOptions {
  ...
  @override
  String toString() {
    return 'AuthOptions(biometricOnly: $biometricOnly, sticky: $sticky)';
  }
}
...
class AuthResultDetails {
  ...
  @override
  String toString() {
    return 'AuthResultDetails(result: $result, errorMessage: $errorMessage, errorDetails: $errorDetails)';
  }
}
