...
struct AuthStrings: Hashable {
  ...
  static func == (lhs: AuthStrings, rhs: AuthStrings) -> Bool {
    ...
    return deepEqualsmessages(lhs.reason, rhs.reason)
      && deepEqualsmessages(lhs.cancelButton, rhs.cancelButton)
      && deepEqualsmessages(lhs.localizedFallbackTitle, rhs.localizedFallbackTitle)
  }
...
struct AuthOptions: Hashable {
  ...
  static func == (lhs: AuthOptions, rhs: AuthOptions) -> Bool {
    ...
    return deepEqualsmessages(lhs.biometricOnly, rhs.biometricOnly)
      && deepEqualsmessages(lhs.sticky, rhs.sticky)
  }
...
struct AuthResultDetails: Hashable {
  ...
  static func == (lhs: AuthResultDetails, rhs: AuthResultDetails) -> Bool {
    ...
    return deepEqualsmessages(lhs.result, rhs.result)
      && deepEqualsmessages(lhs.errorMessage, rhs.errorMessage)
      && deepEqualsmessages(lhs.errorDetails, rhs.errorDetails)
  }
...
class LocalAuthApiSetup {
  ...
  static func setUp(
    ...
    /// Returns false if there was no authentication in progress,
    /// or an error occurred.
    let stopAuthenticationChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.local_auth_darwin.LocalAuthApi.stopAuthentication\(channelSuffix)",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
