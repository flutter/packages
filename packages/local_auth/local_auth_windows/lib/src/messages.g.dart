...
class LocalAuthApi {
  ...
  Future<bool> isDeviceSupported() async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.local_auth_windows.LocalAuthApi.isDeviceSupported$pigeonVar_messageChannelSuffix';
  ...
  Future<AuthResult> authenticate(String localizedReason) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.local_auth_windows.LocalAuthApi.authenticate$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
