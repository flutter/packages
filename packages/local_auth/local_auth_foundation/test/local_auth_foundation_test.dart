...
import 'package:local_auth_foundation/src/messages.g.dart';
import 'package:local_auth_platform_interface/local_auth_platform_interface.dart';
import 'package:mockito/annotations.dart';
import 'package:mockito/mockito.dart';

import 'local_auth_foundation_test.mocks.dart';

@GenerateMocks(<Type>[LocalAuthApi])
void main() {
  late MockLocalAuthApi api;
  late LocalAuthFoundation plugin;

  setUp(() {
    api = MockLocalAuthApi();
    plugin = LocalAuthFoundation(api: api);
  });

  test('registers instance', () {
    LocalAuthFoundation.registerWith();
    expect(LocalAuthPlatform.instance, isA<LocalAuthFoundation>());
  });
  ...
  group('authenticate', () {
    group('strings', () {
      test('passes default values when nothing is provided', () async {
        ...
        expect(strings.lockOut, defaultLockOut);
        expect(strings.goToSettingsButton, goToSettings);
        expect(
            strings.goToSettingsDescription,
            (Platform.isIOS
                ? iOSGoToSettingsDescription
                : macOSGoToSettingsDescription));
        expect(strings.cancelButton, okButton);
