...
/// Class wrapping all authentication messages needed on iOS and macOS.
...
class DarwinAuthMessages extends AuthMessages {
  ...
  Map<String, String> get args {
    return <String, String>{
      ...
      'okButton': cancelButton ?? okButton,
...
String get defaultLockOut => Intl.message(
...
/// Message advising the user to go to the settings and configure Biometrics
/// for their macOS device.
String get macOSGoToSettingsDescription => Intl.message(
    'Biometric authentication is not set up on your device. Please go to System Preferences '
    'and enable Touch ID.',
    desc:
        'Message advising the user to go to the settings and configure Biometrics '
        'for their macOS device.');
...
/// Message shown on a button that the user can click to leave the current
/// dialog.
String get okButton => Intl.message('OK',
