...
import 'types/auth_messages_foundation.dart';

export 'package:local_auth_foundation/types/auth_messages_foundation.dart';
...
class LocalAuthFoundation extends LocalAuthPlatform {
  ...
  static void registerWith() {
    LocalAuthPlatform.instance = LocalAuthFoundation();
  }
  ...
  AuthStrings _pigeonStringsFromAuthMessages(
    ...
    return AuthStrings(
      ...
      lockOut: messages?.lockOut ?? defaultLockOut,
      ...
      cancelButton: messages?.cancelButton ?? okButton,
