...
class LocalAuthApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: LocalAuthApi?) {
    /// Returns true if this device supports authentication.
    let isDeviceSupportedChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.LocalAuthApi.isDeviceSupported", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns true if this device can support biometric authentication, whether
    /// any biometrics are enrolled or not.
    let deviceCanSupportBiometricsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.LocalAuthApi.deviceCanSupportBiometrics", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the biometric types that are enrolled, and can thus be used
    /// without additional setup.
    let getEnrolledBiometricsChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.LocalAuthApi.getEnrolledBiometrics", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Attempts to authenticate the user with the provided [options], and using
    /// [strings] for any UI.
    let authenticateChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.LocalAuthApi.authenticate", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
