        ...
        '''
{
  ...
  test(
    ...
    () async {
      expect(
        await SkiaPerfGcsAdaptor.computeObjectName(
            kFlutterFrameworkRepo, kFrameworkRevision1, DateTime.fromMillisecondsSinceEpoch(1575529660000),),
        equals(
            'flutter-flutter/2019/12/04/23/$kFrameworkRevision1/values.json'),
      );
      expect(
        await SkiaPerfGcsAdaptor.computeObjectName(
            kFlutterEngineRepo, kEngineRevision1, DateTime.fromMillisecondsSinceEpoch(1575432460000),),
        equals('flutter-engine/2019/12/03/20/$kEngineRevision1/values.json'),
      );
      expect(
        await SkiaPerfGcsAdaptor.computeObjectName(
            kFlutterEngineRepo, kEngineRevision2, DateTime.fromMillisecondsSinceEpoch(1578092860000),),
        equals('flutter-engine/2020/01/03/15/$kEngineRevision2/values.json'),
      );
    },
    skip: testBucket == null,
