...
_ListenerTrampoline _1w5ousu_wrapListenerBlock_xtuoz7(
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline _1w5ousu_wrapBlockingBlock_xtuoz7(int64_t port, DOBJC_Context* ctx,
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline_1 _1w5ousu_wrapListenerBlock_10c3wkj(
    int64_t port, DOBJC_Context* ctx) NS_RETURNS_RETAINED {
  __block __weak _ListenerTrampoline_1 weakSelfBlock = nil;
  _ListenerTrampoline_1 strongSelfBlock = [^void(id arg0, id arg1, CGImagePropertyOrientation arg2, id arg3) {
    @autoreleasepool {
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline_1 _1w5ousu_wrapBlockingBlock_10c3wkj(int64_t port, DOBJC_Context* ctx,
    void (*directInvoke)(void*)) NS_RETURNS_RETAINED {
  BLOCKING_BLOCK_IMPL(ctx, _ListenerTrampoline_1, ^void(id arg0, id arg1, CGImagePropertyOrientation arg2, id arg3), {
    @autoreleasepool {
      _1w5ousu_BlockArgs_10c3wkj* args = [[_1w5ousu_BlockArgs_10c3wkj alloc] init];
      args.block = weakSelfBlock;
      args.arg0 = arg0;
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline_2 _1w5ousu_wrapListenerBlock_pfv6jd(
    int64_t port, DOBJC_Context* ctx) NS_RETURNS_RETAINED {
...
__attribute__((visibility("default"))) __attribute__((used))
_ListenerTrampoline_2 _1w5ousu_wrapBlockingBlock_pfv6jd(int64_t port, DOBJC_Context* ctx,
    void (*directInvoke)(void*)) NS_RETURNS_RETAINED {
