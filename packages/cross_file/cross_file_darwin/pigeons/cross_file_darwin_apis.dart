...
/// a [PHAssetResourceManager](https://developer.apple.com/documentation/photos/phassetresourcemanager).
@ProxyApi()
abstract class AssetResourceReader {
  ...
  bool openRead(String localIdentifier, AssetResourceReaderDelegate delegate);
  ...
  @async
  Uint8List readBytes(String localIdentifier);
}

/// Handles bytes received from [AssetResourceReader.openRead].
@ProxyApi()
abstract class AssetResourceReaderDelegate {
