...
void main() {
  ...
  final BenchmarkResults testResults1 = _benchmarkResultsFromFile('/path/to/benchmark_test_1.json');
  final BenchmarkResults testResults2 = _benchmarkResultsFromFile('/path/to/benchmark_test_2.json');
...
BenchmarkResults _benchmarkResultsFromFile(String path) {
  ...
  final fileContentAsJson = jsonDecode(file.readAsStringSync()) as Map<String, Object?>;
