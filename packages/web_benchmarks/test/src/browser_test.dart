...
void main() {
  group('BlinkTraceEvent works with Chrome 89+', () {
    ...
    final BlinkTraceEvent unrelatedPhX = BlinkTraceEvent.fromJson(
      unrelatedPhXJson,
    );
    final BlinkTraceEvent anotherUnrelated = BlinkTraceEvent.fromJson(
      anotherUnrelatedJson,
    );

    test('isBeginFrame', () {
      final BlinkTraceEvent event = BlinkTraceEvent.fromJson(
