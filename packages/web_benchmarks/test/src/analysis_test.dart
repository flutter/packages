...
void main() {
  group('averageBenchmarkResults', () {
    test('succeeds for identical benchmark names and metrics', () {
      ...
      final BenchmarkResults average = computeAverage(<BenchmarkResults>[result1, result2]);
      expect(average.toJson(), <String, List<Map<String, Object?>>>{
...
final Map<String, List<Map<String, Object?>>> testBenchmarkResults1 =
    <String, List<Map<String, Object?>>>{
      'foo': <Map<String, Object?>>[
        ...
        <String, Object?>{'metric': 'drawFrameDuration.outlierAverage', 'value': 24000},
        <String, Object?>{'metric': 'drawFrameDuration.outlierRatio', 'value': 12.05},
...
final Map<String, List<Map<String, Object?>>> testBenchmarkResults2 =
    <String, List<Map<String, Object?>>>{
      'foo': <Map<String, Object?>>[
        ...
        <String, Object?>{'metric': 'drawFrameDuration.outlierAverage', 'value': 20000},
        <String, Object?>{'metric': 'drawFrameDuration.outlierRatio', 'value': 11.05},
...
expectedBenchmarkDelta = <String, List<Map<String, Object?>>>{
  'foo': <Map<String, Object?>>[
    <String, Object?>{'metric': 'preroll_frame.average', 'value': 65.5, 'delta': 5.0},
    <String, Object?>{'metric': 'preroll_frame.outlierAverage', 'value': 1410.0, 'delta': 10.0},
    <String, Object?>{
      'metric': 'preroll_frame.outlierRatio',
      'value': 20.0,
      'delta': -0.1999999999999993,
    },
    <String, Object?>{'metric': 'preroll_frame.noise', 'value': 1.5, 'delta': 0.65},
    <String, Object?>{'metric': 'apply_frame.average', 'value': 50.0, 'delta': -30.0},
    <String, Object?>{'metric': 'apply_frame.outlierAverage', 'value': 100.0, 'delta': -100.6},
    <String, Object?>{
      'metric': 'apply_frame.outlierRatio',
      'value': 2.55,
      'delta': 0.04999999999999982,
    },
    <String, Object?>{'metric': 'apply_frame.noise', 'value': 0.9, 'delta': 0.5},
    <String, Object?>{
    ...
    <String, Object?>{'metric': 'drawFrameDuration.outlierRatio', 'value': 11.05, 'delta': -1.0},
    <String, Object?>{'metric': 'drawFrameDuration.noise', 'value': 1.34, 'delta': 1.0},
    <String, Object?>{'metric': 'totalUiFrame.average', 'value': 4150.0, 'delta': -16.0},
  ],
  'bar': <Map<String, Object?>>[
    <String, Object?>{'metric': 'preroll_frame.average', 'value': 65.5, 'delta': 5.0},
    <String, Object?>{'metric': 'preroll_frame.outlierAverage', 'value': 1410.0, 'delta': 10.0},
