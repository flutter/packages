...
void main() async {
  ...
  group('IdConfig', () {
    testWidgets('passes values from Dart to JS', (_) async {
      ...
      expectConfigValue('allowed_parent_origin', <String>['allowed', 'another']);
      ...
      expectConfigValue('intermediate_iframe_close_callback', utils.isAJs('function'));
  ...
  group('prompt', () {
    testWidgets('supports a moment notification callback with correct type and reason', (_) async {
    ...
    testWidgets('supports a moment notification callback while handling invalid reason '
    ...
    testWidgets('calls config callback with credential response', (_) async {
      ...
      id.initialize(IdConfiguration(client_id: 'testing_1-2-3', callback: controller.add));
