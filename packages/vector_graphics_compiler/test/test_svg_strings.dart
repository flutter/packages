...
List<Path> groupMaskForMaskingOptimizer = <Path>[
  Path(
    ...
    commands: const <PathCommand>[
      ...
      CubicToCommand(12.53927764767, 3.864209346170001, 12.30144139827, 4.11228729057, 12.0, 4.125),
      LineToCommand(4.687000000000001, 4.125000000000001),
      CubicToCommand(4.378, 4.125000000000001, 4.125, 4.377000000000001, 4.125, 4.6880000000000015),
      ...
      CubicToCommand(16.205000000000002, 16.442999999999998, 16.079, 16.5, 15.938, 16.5),
      ...
      CubicToCommand(8.6250000148, 11.68906369162, 8.87706369162, 11.43700000817, 9.188, 11.437),
      ...
      CubicToCommand(15.375, 7.75206368585, 15.62706368585, 7.5, 15.937999999999999, 7.5),
      CubicToCommand(16.079, 7.5, 16.205, 7.557, 16.304000000000002, 7.644),
      LineToCommand(16.308, 7.639),
      LineToCommand(20.808, 11.577),
      CubicToCommand(20.9279360201, 11.68524001601, 20.997484016690002, 11.83846294601, 21.0, 12.0),
      CloseCommand(),
    ],
  ),
  Path(
    ...
    commands: const <PathCommand>[
      ...
      CubicToCommand(12.315999984741211, 3.0789999961853027, 12.168999671936035, 3.0, 12.0, 3.0),
      CubicToCommand(
        11.838462829589844,
        3.002516031265259,
        11.685239791870117,
      ...
      CubicToCommand(7.5, 8.372936248779297, 7.752063751220703, 8.625, 8.062999725341797, 8.625),
      CubicToCommand(
        8.224536895751953,
        8.62248420715332,
        8.37775993347168,
      ...
      CubicToCommand(16.24799919128418, 8.625, 16.5, 8.373000144958496, 16.5, 8.062000274658203),
      CubicToCommand(
        16.5,
        7.921000003814697,
        16.44300079345703,
      ...
      CubicToCommand(20.12700080871582, 11.437000274658203, 19.875, 11.6899995803833, 19.875, 12.0),
...
List<Path> blendsAndMasksForMaskingOptimizer = <Path>[
  ...
  Path(
    ...
    commands: const <PathCommand>[
      ...
      CubicToCommand(90.0, 27.923398971557617, 72.07659912109375, 10.0, 50.0, 10.0),
      CubicToCommand(27.923398971557617, 10.0, 10.0, 27.923398971557617, 10.0, 50.0),
      CubicToCommand(10.0, 72.07659912109375, 27.923398971557617, 90.0, 50.0, 90.0),
      CubicToCommand(72.07659912109375, 90.0, 90.0, 72.07659912109375, 90.0, 50.0),
      CloseCommand(),
    ],
  ),
];
...
List<Path> basicClipsForClippingOptimzer = <Path>[
  Path(
    ...
    commands: const <PathCommand>[
      ...
      CubicToCommand(50.0, 18.961700439453125, 41.038299560546875, 10.0, 30.0, 10.0),
      CubicToCommand(18.961700439453125, 10.0, 10.0, 18.961700439453125, 10.0, 30.0),
      CubicToCommand(10.0, 41.038299560546875, 18.961700439453125, 50.0, 30.0, 50.0),
      CubicToCommand(41.038299560546875, 50.0, 50.0, 41.038299560546875, 50.0, 30.0),
      CloseCommand(),
      MoveToCommand(90.0, 70.0),
      CubicToCommand(90.0, 58.961700439453125, 81.03829956054688, 50.0, 70.0, 50.0),
      CubicToCommand(58.961700439453125, 50.0, 50.0, 58.961700439453125, 50.0, 70.0),
      CubicToCommand(50.0, 81.03829956054688, 58.961700439453125, 90.0, 70.0, 90.0),
      CubicToCommand(81.03829956054688, 90.0, 90.0, 81.03829956054688, 90.0, 70.0),
      CloseCommand(),
    ],
  ),
];
