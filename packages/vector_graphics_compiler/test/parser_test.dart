  ...
  test('Ghostscript Tiger - dedupes paints', () async {
    ...
    expect(
      ...
      const <DrawCommand>[
        ...
        DrawCommand(1, 0, DrawCommandType.path, 'path12'),
        DrawCommand(2, 0, DrawCommandType.path, 'path16'),
        DrawCommand(3, 0, DrawCommandType.path, 'path20'),
        DrawCommand(4, 0, DrawCommandType.path, 'path24'),
        DrawCommand(5, 0, DrawCommandType.path, 'path28'),
        DrawCommand(6, 0, DrawCommandType.path, 'path32'),
        DrawCommand(7, 0, DrawCommandType.path, 'path36'),
        DrawCommand(8, 0, DrawCommandType.path, 'path40'),
        DrawCommand(9, 0, DrawCommandType.path, 'path44'),
        DrawCommand(10, 0, DrawCommandType.path, 'path48'),
        DrawCommand(11, 0, DrawCommandType.path, 'path52'),
        DrawCommand(12, 1, DrawCommandType.path, 'path56'),
        DrawCommand(13, 2, DrawCommandType.path, 'path60'),
        DrawCommand(14, 3, DrawCommandType.path, 'path64'),
        DrawCommand(15, 4, DrawCommandType.path, 'path68'),
        DrawCommand(16, 5, DrawCommandType.path, 'path72'),
        DrawCommand(17, 6, DrawCommandType.path, 'path76'),
        DrawCommand(18, 7, DrawCommandType.path, 'path80'),
        DrawCommand(19, 8, DrawCommandType.path, 'path84'),
        DrawCommand(20, 9, DrawCommandType.path, 'path88'),
        DrawCommand(21, 10, DrawCommandType.path, 'path92'),
        DrawCommand(22, 11, DrawCommandType.path, 'path96'),
        DrawCommand(23, 12, DrawCommandType.path, 'path100'),
        DrawCommand(24, 13, DrawCommandType.path, 'path104'),
        DrawCommand(25, 14, DrawCommandType.path, 'path108'),
        DrawCommand(26, 15, DrawCommandType.path, 'path112'),
        DrawCommand(27, 16, DrawCommandType.path, 'path116'),
        DrawCommand(28, 15, DrawCommandType.path, 'path120'),
        DrawCommand(29, 16, DrawCommandType.path, 'path124'),
        DrawCommand(30, 16, DrawCommandType.path, 'path128'),
        DrawCommand(31, 16, DrawCommandType.path, 'path132'),
        DrawCommand(32, 16, DrawCommandType.path, 'path136'),
        DrawCommand(33, 16, DrawCommandType.path, 'path140'),
        DrawCommand(34, 16, DrawCommandType.path, 'path144'),
        DrawCommand(35, 15, DrawCommandType.path, 'path148'),
        DrawCommand(36, 17, DrawCommandType.path, 'path152'),
        DrawCommand(37, 18, DrawCommandType.path, 'path156'),
        DrawCommand(38, 19, DrawCommandType.path, 'path160'),
        DrawCommand(39, 20, DrawCommandType.path, 'path164'),
        DrawCommand(40, 21, DrawCommandType.path, 'path168'),
        DrawCommand(41, 22, DrawCommandType.path, 'path172'),
        DrawCommand(42, 23, DrawCommandType.path, 'path176'),
        DrawCommand(43, 21, DrawCommandType.path, 'path180'),
        DrawCommand(44, 21, DrawCommandType.path, 'path184'),
        DrawCommand(45, 21, DrawCommandType.path, 'path188'),
        DrawCommand(46, 21, DrawCommandType.path, 'path192'),
        DrawCommand(47, 21, DrawCommandType.path, 'path196'),
        DrawCommand(48, 21, DrawCommandType.path, 'path200'),
        DrawCommand(49, 24, DrawCommandType.path, 'path204'),
        DrawCommand(50, 24, DrawCommandType.path, 'path208'),
        DrawCommand(51, 21, DrawCommandType.path, 'path212'),
        DrawCommand(52, 24, DrawCommandType.path, 'path216'),
        DrawCommand(53, 24, DrawCommandType.path, 'path220'),
        DrawCommand(54, 25, DrawCommandType.path, 'path224'),
        DrawCommand(55, 21, DrawCommandType.path, 'path228'),
        DrawCommand(56, 21, DrawCommandType.path, 'path232'),
        DrawCommand(57, 21, DrawCommandType.path, 'path236'),
        DrawCommand(58, 15, DrawCommandType.path, 'path240'),
        DrawCommand(59, 21, DrawCommandType.path, 'path244'),
        DrawCommand(60, 21, DrawCommandType.path, 'path248'),
        DrawCommand(61, 21, DrawCommandType.path, 'path252'),
        DrawCommand(62, 21, DrawCommandType.path, 'path256'),
        DrawCommand(63, 21, DrawCommandType.path, 'path260'),
        DrawCommand(64, 26, DrawCommandType.path, 'path264'),
        DrawCommand(65, 26, DrawCommandType.path, 'path268'),
        DrawCommand(66, 3, DrawCommandType.path, 'path272'),
        DrawCommand(67, 27, DrawCommandType.path, 'path276'),
        DrawCommand(68, 28, DrawCommandType.path, 'path280'),
        DrawCommand(69, 29, DrawCommandType.path, 'path284'),
        DrawCommand(70, 30, DrawCommandType.path, 'path288'),
        DrawCommand(71, 14, DrawCommandType.path, 'path292'),
        DrawCommand(72, 16, DrawCommandType.path, 'path296'),
        DrawCommand(73, 15, DrawCommandType.path, 'path300'),
        DrawCommand(74, 31, DrawCommandType.path, 'path304'),
        DrawCommand(75, 32, DrawCommandType.path, 'path308'),
        DrawCommand(76, 14, DrawCommandType.path, 'path312'),
        DrawCommand(77, 15, DrawCommandType.path, 'path316'),
        DrawCommand(78, 3, DrawCommandType.path, 'path320'),
        DrawCommand(79, 14, DrawCommandType.path, 'path324'),
        DrawCommand(80, 33, DrawCommandType.path, 'path328'),
        DrawCommand(81, 34, DrawCommandType.path, 'path332'),
        DrawCommand(82, 35, DrawCommandType.path, 'path336'),
        DrawCommand(83, 14, DrawCommandType.path, 'path340'),
        DrawCommand(84, 16, DrawCommandType.path, 'path344'),
        DrawCommand(85, 15, DrawCommandType.path, 'path348'),
        DrawCommand(86, 31, DrawCommandType.path, 'path352'),
        DrawCommand(87, 15, DrawCommandType.path, 'path356'),
        DrawCommand(88, 15, DrawCommandType.path, 'path360'),
        DrawCommand(89, 15, DrawCommandType.path, 'path364'),
        DrawCommand(90, 36, DrawCommandType.path, 'path368'),
        DrawCommand(91, 37, DrawCommandType.path, 'path372'),
        DrawCommand(92, 38, DrawCommandType.path, 'path376'),
        DrawCommand(93, 16, DrawCommandType.path, 'path380'),
        DrawCommand(94, 14, DrawCommandType.path, 'path384'),
        DrawCommand(95, 39, DrawCommandType.path, 'path388'),
        DrawCommand(96, 16, DrawCommandType.path, 'path392'),
        DrawCommand(97, 16, DrawCommandType.path, 'path396'),
        DrawCommand(98, 16, DrawCommandType.path, 'path400'),
        DrawCommand(99, 16, DrawCommandType.path, 'path404'),
        DrawCommand(100, 16, DrawCommandType.path, 'path408'),
        DrawCommand(101, 15, DrawCommandType.path, 'path412'),
        DrawCommand(102, 15, DrawCommandType.path, 'path416'),
        DrawCommand(103, 3, DrawCommandType.path, 'path420'),
        DrawCommand(104, 3, DrawCommandType.path, 'path424'),
        DrawCommand(105, 3, DrawCommandType.path, 'path428'),
        DrawCommand(106, 3, DrawCommandType.path, 'path432'),
        DrawCommand(107, 3, DrawCommandType.path, 'path436'),
        DrawCommand(108, 3, DrawCommandType.path, 'path440'),
        DrawCommand(109, 15, DrawCommandType.path, 'path444'),
        DrawCommand(110, 40, DrawCommandType.path, 'path448'),
        DrawCommand(111, 40, DrawCommandType.path, 'path452'),
        DrawCommand(112, 40, DrawCommandType.path, 'path456'),
        DrawCommand(113, 40, DrawCommandType.path, 'path460'),
        DrawCommand(114, 15, DrawCommandType.path, 'path464'),
        DrawCommand(115, 41, DrawCommandType.path, 'path468'),
        DrawCommand(116, 31, DrawCommandType.path, 'path472'),
        DrawCommand(117, 32, DrawCommandType.path, 'path476'),
        DrawCommand(118, 15, DrawCommandType.path, 'path480'),
        DrawCommand(119, 15, DrawCommandType.path, 'path484'),
        DrawCommand(120, 15, DrawCommandType.path, 'path488'),
        DrawCommand(121, 42, DrawCommandType.path, 'path492'),
        DrawCommand(122, 43, DrawCommandType.path, 'path496'),
        DrawCommand(123, 39, DrawCommandType.path, 'path500'),
        DrawCommand(124, 14, DrawCommandType.path, 'path504'),
        DrawCommand(125, 39, DrawCommandType.path, 'path508'),
        DrawCommand(126, 15, DrawCommandType.path, 'path512'),
        DrawCommand(127, 15, DrawCommandType.path, 'path516'),
        DrawCommand(128, 15, DrawCommandType.path, 'path520'),
        DrawCommand(129, 15, DrawCommandType.path, 'path524'),
        DrawCommand(130, 15, DrawCommandType.path, 'path528'),
        DrawCommand(131, 15, DrawCommandType.path, 'path532'),
        DrawCommand(132, 15, DrawCommandType.path, 'path536'),
        DrawCommand(133, 15, DrawCommandType.path, 'path540'),
        DrawCommand(134, 15, DrawCommandType.path, 'path544'),
        DrawCommand(135, 14, DrawCommandType.path, 'path548'),
        DrawCommand(136, 14, DrawCommandType.path, 'path552'),
        DrawCommand(137, 16, DrawCommandType.path, 'path556'),
        DrawCommand(138, 15, DrawCommandType.path, 'path560'),
        DrawCommand(139, 16, DrawCommandType.path, 'path564'),
        DrawCommand(140, 15, DrawCommandType.path, 'path568'),
        DrawCommand(141, 15, DrawCommandType.path, 'path572'),
        DrawCommand(142, 15, DrawCommandType.path, 'path576'),
        DrawCommand(143, 15, DrawCommandType.path, 'path580'),
        DrawCommand(144, 15, DrawCommandType.path, 'path584'),
        DrawCommand(145, 15, DrawCommandType.path, 'path588'),
        DrawCommand(146, 15, DrawCommandType.path, 'path592'),
        DrawCommand(147, 15, DrawCommandType.path, 'path596'),
        DrawCommand(148, 15, DrawCommandType.path, 'path600'),
        DrawCommand(149, 15, DrawCommandType.path, 'path604'),
        DrawCommand(150, 15, DrawCommandType.path, 'path608'),
        DrawCommand(151, 15, DrawCommandType.path, 'path612'),
        DrawCommand(152, 15, DrawCommandType.path, 'path616'),
        DrawCommand(153, 15, DrawCommandType.path, 'path620'),
        DrawCommand(154, 15, DrawCommandType.path, 'path624'),
        DrawCommand(155, 15, DrawCommandType.path, 'path628'),
        DrawCommand(156, 15, DrawCommandType.path, 'path632'),
        DrawCommand(157, 39, DrawCommandType.path, 'path636'),
        DrawCommand(158, 39, DrawCommandType.path, 'path640'),
        DrawCommand(159, 16, DrawCommandType.path, 'path644'),
        DrawCommand(160, 15, DrawCommandType.path, 'path648'),
        DrawCommand(161, 15, DrawCommandType.path, 'path652'),
        DrawCommand(162, 44, DrawCommandType.path, 'path656'),
        DrawCommand(163, 44, DrawCommandType.path, 'path660'),
        DrawCommand(164, 44, DrawCommandType.path, 'path664'),
        DrawCommand(165, 44, DrawCommandType.path, 'path668'),
        DrawCommand(166, 44, DrawCommandType.path, 'path672'),
        DrawCommand(167, 44, DrawCommandType.path, 'path676'),
        DrawCommand(168, 44, DrawCommandType.path, 'path680'),
        DrawCommand(169, 44, DrawCommandType.path, 'path684'),
        DrawCommand(170, 16, DrawCommandType.path, 'path688'),
        DrawCommand(171, 15, DrawCommandType.path, 'path692'),
        DrawCommand(172, 15, DrawCommandType.path, 'path696'),
        DrawCommand(173, 15, DrawCommandType.path, 'path700'),
        DrawCommand(174, 15, DrawCommandType.path, 'path704'),
        DrawCommand(175, 15, DrawCommandType.path, 'path708'),
        DrawCommand(176, 15, DrawCommandType.path, 'path712'),
        DrawCommand(177, 15, DrawCommandType.path, 'path716'),
        DrawCommand(178, 15, DrawCommandType.path, 'path720'),
        DrawCommand(179, 15, DrawCommandType.path, 'path724'),
        DrawCommand(180, 15, DrawCommandType.path, 'path728'),
        DrawCommand(181, 44, DrawCommandType.path, 'path732'),
        DrawCommand(182, 15, DrawCommandType.path, 'path736'),
        DrawCommand(183, 44, DrawCommandType.path, 'path740'),
        DrawCommand(184, 44, DrawCommandType.path, 'path744'),
        DrawCommand(185, 44, DrawCommandType.path, 'path748'),
        DrawCommand(186, 44, DrawCommandType.path, 'path752'),
        DrawCommand(187, 44, DrawCommandType.path, 'path756'),
        DrawCommand(188, 44, DrawCommandType.path, 'path760'),
        DrawCommand(189, 44, DrawCommandType.path, 'path764'),
        DrawCommand(190, 44, DrawCommandType.path, 'path768'),
        DrawCommand(191, 44, DrawCommandType.path, 'path772'),
        DrawCommand(192, 44, DrawCommandType.path, 'path776'),
        DrawCommand(193, 44, DrawCommandType.path, 'path780'),
        DrawCommand(194, 44, DrawCommandType.path, 'path784'),
        DrawCommand(195, 44, DrawCommandType.path, 'path788'),
        DrawCommand(196, 44, DrawCommandType.path, 'path792'),
        DrawCommand(197, 44, DrawCommandType.path, 'path796'),
        DrawCommand(198, 44, DrawCommandType.path, 'path800'),
        DrawCommand(199, 44, DrawCommandType.path, 'path804'),
        DrawCommand(200, 44, DrawCommandType.path, 'path808'),
        DrawCommand(201, 44, DrawCommandType.path, 'path812'),
        DrawCommand(202, 44, DrawCommandType.path, 'path816'),
        DrawCommand(203, 44, DrawCommandType.path, 'path820'),
        DrawCommand(204, 44, DrawCommandType.path, 'path824'),
        DrawCommand(205, 44, DrawCommandType.path, 'path828'),
        DrawCommand(206, 44, DrawCommandType.path, 'path832'),
        DrawCommand(207, 44, DrawCommandType.path, 'path836'),
        DrawCommand(208, 15, DrawCommandType.path, 'path840'),
        DrawCommand(209, 15, DrawCommandType.path, 'path844'),
        DrawCommand(210, 15, DrawCommandType.path, 'path848'),
        DrawCommand(211, 15, DrawCommandType.path, 'path852'),
        DrawCommand(212, 15, DrawCommandType.path, 'path856'),
        DrawCommand(213, 15, DrawCommandType.path, 'path860'),
        DrawCommand(214, 16, DrawCommandType.path, 'path864'),
        DrawCommand(215, 16, DrawCommandType.path, 'path868'),
        DrawCommand(216, 16, DrawCommandType.path, 'path872'),
        DrawCommand(217, 16, DrawCommandType.path, 'path876'),
        DrawCommand(218, 16, DrawCommandType.path, 'path880'),
        DrawCommand(219, 16, DrawCommandType.path, 'path884'),
        DrawCommand(220, 16, DrawCommandType.path, 'path888'),
        DrawCommand(221, 16, DrawCommandType.path, 'path892'),
        DrawCommand(222, 16, DrawCommandType.path, 'path896'),
        DrawCommand(223, 16, DrawCommandType.path, 'path900'),
        DrawCommand(224, 16, DrawCommandType.path, 'path904'),
        DrawCommand(225, 16, DrawCommandType.path, 'path908'),
        DrawCommand(226, 16, DrawCommandType.path, 'path912'),
        DrawCommand(227, 16, DrawCommandType.path, 'path916'),
        DrawCommand(228, 16, DrawCommandType.path, 'path920'),
        DrawCommand(229, 16, DrawCommandType.path, 'path924'),
        DrawCommand(230, 16, DrawCommandType.path, 'path928'),
        DrawCommand(231, 16, DrawCommandType.path, 'path932'),
        DrawCommand(232, 16, DrawCommandType.path, 'path936'),
        DrawCommand(233, 16, DrawCommandType.path, 'path940'),
        DrawCommand(234, 16, DrawCommandType.path, 'path944'),
        DrawCommand(235, 16, DrawCommandType.path, 'path948'),
        DrawCommand(236, 45, DrawCommandType.path, 'path952'),
        DrawCommand(237, 45, DrawCommandType.path, 'path956'),
        DrawCommand(238, 45, DrawCommandType.path, 'path960'),
        DrawCommand(239, 45, DrawCommandType.path, 'path964'),
      ],
    );
  });
}
