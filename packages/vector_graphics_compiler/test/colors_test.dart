...
void main() {
  group('parseCssRgb - record output validation', () {
    ...
    test('Legacy RGBA', () {
      expect(parseCssRgb('rgba(255, 0, 0, 0.5)'), (r: '255', g: '0', b: '0', a: '0.5'));
    });

    test('Legacy Percentages', () {
      expect(parseCssRgb('rgb(10%, 20%, 30%)'), (r: '10%', g: '20%', b: '30%', a: '1'));
    });
    ...
    test('Modern Alpha Slash', () {
      expect(parseCssRgb('rgb(255 0 0 / 0.5)'), (r: '255', g: '0', b: '0', a: '0.5'));
    });

    test('Modern Alpha Percentage', () {
      expect(parseCssRgb('rgba(255 0 0 / 50%)'), (r: '255', g: '0', b: '0', a: '50%'));
    });

    // --- POSITIVE MATCHES: NEGATIVES, DECIMALS, WHITESPACE ---
    test('Leading decimal and negative', () {
      expect(parseCssRgb('rgb(-10, 5, .5)'), (r: '-10', g: '5', b: '.5', a: '1'));
    });

    test('Trailing and leading decimals', () {
      expect(parseCssRgb('rgb(5. 5. 5. / .1)'), (r: '5.', g: '5.', b: '5.', a: '.1'));
    });

    test('Negative percentage/alpha', () {
      expect(parseCssRgb('rgb(-50% 120% 0 / -1)'), (r: '-50%', g: '120%', b: '0', a: '-1'));
    });

    test('Case/Tight spacing', () {
      expect(parseCssRgb('RGBA( 255,255,255 )'), (r: '255', g: '255', b: '255', a: '1'));
    });

    test('Extra spacing', () {
      expect(parseCssRgb('rgb(  0  0  0  /  0  )'), (r: '0', g: '0', b: '0', a: '0'));
    });
  ...
  group('parseCssHsl - record output validation', () {
    // --- POSITIVE MATCHES: LEGACY SYNTAX ---
    test('Legacy HSL', () {
      expect(parseCssHsl('hsl(270, 100%, 76%)'), (h: '270', s: '100%', l: '76%', a: '1'));
    });

    test('Legacy HSLA', () {
      expect(parseCssHsl('hsla(270, 100%, 76%, 0.5)'), (h: '270', s: '100%', l: '76%', a: '0.5'));
    });

    test('Legacy alpha percentage', () {
      expect(parseCssHsl('hsla(270, 100%, 76%, 50%)'), (h: '270', s: '100%', l: '76%', a: '50%'));
    });
    ...
    test('Modern Space HSLA (no alpha)', () {
      expect(parseCssHsl('hsla(270 100% 76%)'), (h: '270', s: '100%', l: '76%', a: '1'));
    });
    ...
    // --- POSITIVE MATCHES: NEGATIVES, DECIMALS, WHITESPACE ---
    test('Leading decimal and negative', () {
      expect(parseCssHsl('hsl(-.5 100% 76%)'), (h: '-.5', s: '100%', l: '76%', a: '1'));
    });

    test('Trailing and leading decimals', () {
      expect(parseCssHsl('hsl(270. 100% 76. / .5)'), (h: '270.', s: '100%', l: '76.', a: '.5'));
    });

    test('Negative percentage/alpha', () {
      expect(parseCssHsl('hsl(270 -10% 120% / -1)'), (h: '270', s: '-10%', l: '120%', a: '-1'));
    });
    ...
    test('Extra spacing', () {
      expect(parseCssHsl('hsl(  270  100%  76%  /  0  )'), (h: '270', s: '100%', l: '76%', a: '0'));
    });
