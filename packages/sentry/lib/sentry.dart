...
class SentryClient {
  ...
  /// sentry enpoint to send exception
  String get postUri =>
...
class SentryResponse {
  /// Successful response from sentry
  const SentryResponse.success({@required this.eventId})
      : isSuccessful = true,
        error = null;

  /// Failed response from sentry
...
class SeverityLevel {
  ...
  /// datal level
  static const SeverityLevel fatal = SeverityLevel._('fatal');

  /// error level
  static const SeverityLevel error = SeverityLevel._('error');

  /// warning level
  static const SeverityLevel warning = SeverityLevel._('warning');

  /// info level
  static const SeverityLevel info = SeverityLevel._('info');

  /// debug level
  static const SeverityLevel debug = SeverityLevel._('debug');
...
class Event {
  ...
  Map<String, dynamic> toJson({StackFrameFilter stackFrameFilter}) {
    ...
    if (exception != null) {
      json['exception'] = <Map<String, dynamic>>[
        <String, dynamic>{
