...
void main() {
  const MethodChannel channel = MethodChannel('plugins.flutter.io/ios_platform_images');

  TestWidgetsFlutterBinding.ensureInitialized();

  setUp(() {
    _ambiguate(TestDefaultBinaryMessengerBinding.instance)!.defaultBinaryMessenger.setMockMethodCallHandler(channel,
  ...
  test('load', () async {
    ...
    expect(image.obtainCacheStatus(configuration: ImageConfiguration.empty), isA<Future<ImageCacheStatus?>>());
