...
class IconButtonTemplate extends M3ETokenTemplate {
  ...
  @override
  String get parentFilePath => 'material_3_expressive/icon_button.dart';
...
class $className extends ButtonStyle {
  $className(this.context, this.toggleable, this.buttonSize, this.buttonWidth)
    : super(
...
class _M3EFilledTonalIconButtonDefaults extends ButtonStyle {
  _M3EFilledTonalIconButtonDefaults(this.context, this.toggleable, this.buttonSize, this.buttonWidth)
    : super(
        animationDuration: kThemeChangeDuration,
        enableFeedback: true,
        alignment: Alignment.center,
