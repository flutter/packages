...
class $className extends ChipThemeData {
  ...
  EdgeInsetsGeometry? get labelPadding {
    final double fontSize = labelStyle?.fontSize ?? ${number(TokenFilterChip.labelTextType.fontSize)};
    final double fontSizeRatio = MediaQuery.textScalerOf(context).scale(fontSize) / ${number(TokenFilterChip.labelTextType.fontSize)};
