...
class TokenExtendedFabPrimaryContainer {
...
class TokenExtendedFabPrimaryContainerDark {
...
class TokenExtendedFabPrimaryContainerDarkDefault {
...
class TokenExtendedFabPrimaryContainerDarkHighContrast {
  /// md.comp.extended-fab.primary-container.container.color
  static const TokenColorRole containerColor = TokenColorRole.primaryContainer;
...
class TokenExtendedFabPrimaryContainerDarkMediumContrast {
  /// md.comp.extended-fab.primary-container.container.color
  static const TokenColorRole containerColor = TokenColorRole.primaryContainer;
...
class TokenExtendedFabPrimaryContainerLight {
  /// md.comp.extended-fab.primary-container.container.shadow-color
  static const TokenColorRole containerShadowColor = TokenColorRole.shadow;
}

class TokenExtendedFabPrimaryContainerLightDefault {
  /// md.comp.extended-fab.primary-container.container.color
  static const TokenColorRole containerColor = TokenColorRole.primaryContainer;
...
class TokenExtendedFabPrimaryContainerLightHighContrast {
  /// md.comp.extended-fab.primary-container.container.color
  static const TokenColorRole containerColor = TokenColorRole.primaryContainer;
...
class TokenExtendedFabPrimaryContainerLightMediumContrast {
  /// md.comp.extended-fab.primary-container.container.color
  static const TokenColorRole containerColor = TokenColorRole.primaryContainer;
