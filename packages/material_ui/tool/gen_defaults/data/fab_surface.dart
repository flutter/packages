...
class TokenFabSurface {
  ...
  /// md.comp.fab.surface.focus.state-layer.opacity
  ...
  /// md.comp.fab.surface.hover.state-layer.opacity
  ...
  /// md.comp.fab.surface.pressed.state-layer.opacity
  static const double pressedStateLayerOpacity = 0.10;
}

class TokenFabSurfaceDark {
...
class TokenFabSurfaceDarkDefault {
...
class TokenFabSurfaceDarkHighContrast {
  /// md.comp.fab.surface.focus.icon.color
  static const TokenColorRole focusIconColor = TokenColorRole.primary;
...
class TokenFabSurfaceDarkMediumContrast {
  /// md.comp.fab.surface.focus.icon.color
  static const TokenColorRole focusIconColor = TokenColorRole.primary;
...
class TokenFabSurfaceLightDefault {
  /// md.comp.fab.surface.focus.icon.color
  static const TokenColorRole focusIconColor = TokenColorRole.primary;
...
class TokenFabSurfaceLightHighContrast {
  /// md.comp.fab.surface.focus.icon.color
  static const TokenColorRole focusIconColor = TokenColorRole.primary;
...
class TokenFabSurfaceLightMediumContrast {
  /// md.comp.fab.surface.focus.icon.color
  static const TokenColorRole focusIconColor = TokenColorRole.primary;
