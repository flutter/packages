...
class TokenLoadingIndicatorDarkDefault {
...
class TokenLoadingIndicatorDarkHighContrast {
  /// md.comp.loading-indicator.active-indicator.color
  static const TokenColorRole activeIndicatorColor = TokenColorRole.primary;
...
class TokenLoadingIndicatorDarkMediumContrast {
  /// md.comp.loading-indicator.active-indicator.color
  static const TokenColorRole activeIndicatorColor = TokenColorRole.primary;
...
class TokenLoadingIndicatorLightDefault {
  /// md.comp.loading-indicator.active-indicator.color
  static const TokenColorRole activeIndicatorColor = TokenColorRole.primary;
...
class TokenLoadingIndicatorLightHighContrast {
  /// md.comp.loading-indicator.active-indicator.color
  static const TokenColorRole activeIndicatorColor = TokenColorRole.primary;
...
class TokenLoadingIndicatorLightMediumContrast {
  /// md.comp.loading-indicator.active-indicator.color
  static const TokenColorRole activeIndicatorColor = TokenColorRole.primary;
