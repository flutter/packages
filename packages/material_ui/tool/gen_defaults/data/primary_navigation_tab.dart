...
class TokenPrimaryNavigationTabDarkHighContrast {
  /// md.comp.primary-navigation-tab.active.focus.state-layer.color
  static const TokenColorRole activeFocusStateLayerColor =
      TokenColorRole.primary;
...
class TokenPrimaryNavigationTabDarkMediumContrast {
  /// md.comp.primary-navigation-tab.active.focus.state-layer.color
  static const TokenColorRole activeFocusStateLayerColor =
      TokenColorRole.primary;
...
class TokenPrimaryNavigationTabLight {
  /// md.comp.primary-navigation-tab.container.color
  static const TokenColorRole containerColor = TokenColorRole.surface;
}

class TokenPrimaryNavigationTabLightDefault {
  /// md.comp.primary-navigation-tab.active.focus.state-layer.color
  static const TokenColorRole activeFocusStateLayerColor =
      TokenColorRole.primary;
...
class TokenPrimaryNavigationTabLightHighContrast {
  /// md.comp.primary-navigation-tab.active.focus.state-layer.color
  static const TokenColorRole activeFocusStateLayerColor =
      TokenColorRole.primary;
...
class TokenPrimaryNavigationTabLightMediumContrast {
  /// md.comp.primary-navigation-tab.active.focus.state-layer.color
  static const TokenColorRole activeFocusStateLayerColor =
      TokenColorRole.primary;
