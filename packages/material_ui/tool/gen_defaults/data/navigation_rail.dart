...
class TokenNavigationRail {
  ...
  static const double containerWidth = 80.00;
  ...
  static const ShapeStruct noLabelActiveIndicatorShape = ShapeStruct(
    family: 'SHAPE_FAMILY_CIRCULAR',
    topLeft: 0.00,
    topRight: 0.00,
    bottomLeft: 0.00,
...
class TokenNavigationRailDarkHighContrast {
  /// md.comp.navigation-rail.active.focus.icon.color
  static const TokenColorRole activeFocusIconColor =
      TokenColorRole.onSecondaryContainer;
...
class TokenNavigationRailDarkMediumContrast {
  /// md.comp.navigation-rail.active.focus.icon.color
  static const TokenColorRole activeFocusIconColor =
      TokenColorRole.onSecondaryContainer;
...
class TokenNavigationRailLight {
  /// md.comp.navigation-rail.container.color
  static const TokenColorRole containerColor = TokenColorRole.surface;
}

class TokenNavigationRailLightDefault {
  /// md.comp.navigation-rail.active.focus.icon.color
  static const TokenColorRole activeFocusIconColor =
      TokenColorRole.onSecondaryContainer;
...
class TokenNavigationRailLightHighContrast {
  /// md.comp.navigation-rail.active.focus.icon.color
  static const TokenColorRole activeFocusIconColor =
      TokenColorRole.onSecondaryContainer;
...
class TokenNavigationRailLightMediumContrast {
  /// md.comp.navigation-rail.active.focus.icon.color
  static const TokenColorRole activeFocusIconColor =
      TokenColorRole.onSecondaryContainer;
