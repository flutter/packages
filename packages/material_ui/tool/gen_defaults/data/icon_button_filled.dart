...
class TokenIconButtonFilledDark {
...
class TokenIconButtonFilledDarkDefault {
...
class TokenIconButtonFilledDarkHighContrast {
  /// md.comp.icon-button.filled.container.color
  static const TokenColorRole containerColor = TokenColorRole.primary;
...
class TokenIconButtonFilledDarkMediumContrast {
  /// md.comp.icon-button.filled.container.color
  static const TokenColorRole containerColor = TokenColorRole.primary;
...
class TokenIconButtonFilledLight {
  /// md.comp.icon-button.filled.unselected.container.color
  static const TokenColorRole unselectedContainerColor =
      TokenColorRole.surfaceContainer;
}

class TokenIconButtonFilledLightDefault {
  /// md.comp.icon-button.filled.container.color
  static const TokenColorRole containerColor = TokenColorRole.primary;
...
class TokenIconButtonFilledLightHighContrast {
  /// md.comp.icon-button.filled.container.color
  static const TokenColorRole containerColor = TokenColorRole.primary;
...
class TokenIconButtonFilledLightMediumContrast {
  /// md.comp.icon-button.filled.container.color
  static const TokenColorRole containerColor = TokenColorRole.primary;
