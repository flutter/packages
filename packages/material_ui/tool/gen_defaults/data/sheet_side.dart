...
class TokenSheetSideDarkDefault {
...
class TokenSheetSideDarkHighContrast {
  /// md.comp.sheet.side.docked.action.focus.label-text.color
  static const TokenColorRole dockedActionFocusLabelTextColor =
      TokenColorRole.primary;
...
class TokenSheetSideDarkMediumContrast {
  /// md.comp.sheet.side.docked.action.focus.label-text.color
  static const TokenColorRole dockedActionFocusLabelTextColor =
      TokenColorRole.primary;
...
class TokenSheetSideLightDefault {
  /// md.comp.sheet.side.docked.action.focus.label-text.color
  static const TokenColorRole dockedActionFocusLabelTextColor =
      TokenColorRole.primary;
...
class TokenSheetSideLightHighContrast {
  /// md.comp.sheet.side.docked.action.focus.label-text.color
  static const TokenColorRole dockedActionFocusLabelTextColor =
      TokenColorRole.primary;
...
class TokenSheetSideLightMediumContrast {
  /// md.comp.sheet.side.docked.action.focus.label-text.color
  static const TokenColorRole dockedActionFocusLabelTextColor =
      TokenColorRole.primary;
