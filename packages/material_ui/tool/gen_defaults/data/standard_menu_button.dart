...
class TokenStandardMenuButtonDarkDefault {
  ...
  static const TokenColorRole focusLabelTextColor =
  ...
  static const TokenColorRole withIconFocusIconColor =
      TokenColorRole.onSurfaceVariant;
...
class TokenStandardMenuButtonDarkHighContrast {
  /// md.comp.standard-menu-button.disabled.label-text.color
  static const TokenColorRole disabledLabelTextColor = TokenColorRole.onSurface;
...
class TokenStandardMenuButtonDarkMediumContrast {
  /// md.comp.standard-menu-button.disabled.label-text.color
  static const TokenColorRole disabledLabelTextColor = TokenColorRole.onSurface;
...
class TokenStandardMenuButtonLightDefault {
  /// md.comp.standard-menu-button.disabled.label-text.color
  static const TokenColorRole disabledLabelTextColor = TokenColorRole.onSurface;
...
class TokenStandardMenuButtonLightHighContrast {
  /// md.comp.standard-menu-button.disabled.label-text.color
  static const TokenColorRole disabledLabelTextColor = TokenColorRole.onSurface;
...
class TokenStandardMenuButtonLightMediumContrast {
  /// md.comp.standard-menu-button.disabled.label-text.color
  static const TokenColorRole disabledLabelTextColor = TokenColorRole.onSurface;
