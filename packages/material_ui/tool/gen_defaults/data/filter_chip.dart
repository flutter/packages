...
class TokenFilterChipDarkDefault {
...
class TokenFilterChipDarkHighContrast {
  /// md.comp.filter-chip.disabled.label-text.color
  static const TokenColorRole disabledLabelTextColor = TokenColorRole.onSurface;
...
class TokenFilterChipDarkMediumContrast {
  /// md.comp.filter-chip.disabled.label-text.color
  static const TokenColorRole disabledLabelTextColor = TokenColorRole.onSurface;
...
class TokenFilterChipLightDefault {
  /// md.comp.filter-chip.disabled.label-text.color
  static const TokenColorRole disabledLabelTextColor = TokenColorRole.onSurface;
...
class TokenFilterChipLightHighContrast {
  /// md.comp.filter-chip.disabled.label-text.color
  static const TokenColorRole disabledLabelTextColor = TokenColorRole.onSurface;
