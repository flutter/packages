...
class TokenAssistChipDarkDefault {
...
class TokenAssistChipDarkHighContrast {
  /// md.comp.assist-chip.disabled.label-text.color
  static const TokenColorRole disabledLabelTextColor = TokenColorRole.onSurface;
...
class TokenAssistChipDarkMediumContrast {
  /// md.comp.assist-chip.disabled.label-text.color
  static const TokenColorRole disabledLabelTextColor = TokenColorRole.onSurface;
...
class TokenAssistChipLightDefault {
  /// md.comp.assist-chip.disabled.label-text.color
  static const TokenColorRole disabledLabelTextColor = TokenColorRole.onSurface;
...
class TokenAssistChipLightHighContrast {
  /// md.comp.assist-chip.disabled.label-text.color
  static const TokenColorRole disabledLabelTextColor = TokenColorRole.onSurface;
...
class TokenAssistChipLightMediumContrast {
  /// md.comp.assist-chip.disabled.label-text.color
  static const TokenColorRole disabledLabelTextColor = TokenColorRole.onSurface;
