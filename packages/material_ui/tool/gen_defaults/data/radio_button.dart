...
class TokenRadioButtonDarkDefault {
...
class TokenRadioButtonDarkHighContrast {
  /// md.comp.radio-button.disabled.selected.icon.color
  static const TokenColorRole disabledSelectedIconColor =
      TokenColorRole.onSurface;
...
class TokenRadioButtonDarkMediumContrast {
  /// md.comp.radio-button.disabled.selected.icon.color
  static const TokenColorRole disabledSelectedIconColor =
      TokenColorRole.onSurface;
...
class TokenRadioButtonLightDefault {
  /// md.comp.radio-button.disabled.selected.icon.color
  static const TokenColorRole disabledSelectedIconColor =
      TokenColorRole.onSurface;
...
class TokenRadioButtonLightHighContrast {
  /// md.comp.radio-button.disabled.selected.icon.color
  static const TokenColorRole disabledSelectedIconColor =
      TokenColorRole.onSurface;
...
class TokenRadioButtonLightMediumContrast {
  /// md.comp.radio-button.disabled.selected.icon.color
  static const TokenColorRole disabledSelectedIconColor =
      TokenColorRole.onSurface;
