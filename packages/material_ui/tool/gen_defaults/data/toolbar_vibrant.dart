...
class TokenToolbarVibrant {
  /// md.comp.toolbar.vibrant.container.shape
  ...
  /// md.comp.toolbar.vibrant.disabled.icon.opacity
  static const double disabledIconOpacity = 0.38;

  /// md.comp.toolbar.vibrant.disabled.label-text.opacity
...
class TokenToolbarVibrantDarkDefault {
  ...
  /// md.comp.toolbar.vibrant.disabled.icon.color
  static const TokenColorRole disabledIconColor = TokenColorRole.onSurface;

  /// md.comp.toolbar.vibrant.disabled.label-text.color
  ...
  /// md.comp.toolbar.vibrant.icon.color
  ...
  /// md.comp.toolbar.vibrant.selected.label-text.color
...
class TokenToolbarVibrantDarkHighContrast {
  /// md.comp.toolbar.vibrant.button.container.color
  static const TokenColorRole buttonContainerColor =
      TokenColorRole.primaryContainer;
...
class TokenToolbarVibrantDarkMediumContrast {
  /// md.comp.toolbar.vibrant.button.container.color
  static const TokenColorRole buttonContainerColor =
      TokenColorRole.primaryContainer;
...
class TokenToolbarVibrantLight {
  /// md.comp.toolbar.vibrant.selected.button.container.color
  static const TokenColorRole selectedButtonContainerColor =
      TokenColorRole.surfaceContainer;
}

class TokenToolbarVibrantLightDefault {
  /// md.comp.toolbar.vibrant.button.container.color
  static const TokenColorRole buttonContainerColor =
      TokenColorRole.primaryContainer;
...
class TokenToolbarVibrantLightHighContrast {
  /// md.comp.toolbar.vibrant.button.container.color
  static const TokenColorRole buttonContainerColor =
      TokenColorRole.primaryContainer;
...
class TokenToolbarVibrantLightMediumContrast {
  /// md.comp.toolbar.vibrant.button.container.color
  static const TokenColorRole buttonContainerColor =
      TokenColorRole.primaryContainer;
