...
class TokenExtendedFabPrimaryDark {
...
class TokenExtendedFabPrimaryDarkDefault {
...
class TokenExtendedFabPrimaryDarkHighContrast {
  /// md.comp.extended-fab.primary.container.color
  static const TokenColorRole containerColor = TokenColorRole.primary;
...
class TokenExtendedFabPrimaryDarkMediumContrast {
  /// md.comp.extended-fab.primary.container.color
  static const TokenColorRole containerColor = TokenColorRole.primary;
...
class TokenExtendedFabPrimaryLight {
  /// md.comp.extended-fab.primary.container.shadow-color
  static const TokenColorRole containerShadowColor = TokenColorRole.shadow;
}

class TokenExtendedFabPrimaryLightDefault {
  /// md.comp.extended-fab.primary.container.color
  static const TokenColorRole containerColor = TokenColorRole.primary;
...
class TokenExtendedFabPrimaryLightHighContrast {
  /// md.comp.extended-fab.primary.container.color
  static const TokenColorRole containerColor = TokenColorRole.primary;
...
class TokenExtendedFabPrimaryLightMediumContrast {
  /// md.comp.extended-fab.primary.container.color
  static const TokenColorRole containerColor = TokenColorRole.primary;
