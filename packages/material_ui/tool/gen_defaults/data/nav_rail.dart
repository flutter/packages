...
class TokenNavRailDarkHighContrast {
  /// md.comp.nav-rail.item.active.focused.state-layer.color
  static const TokenColorRole itemActiveFocusedStateLayerColor =
      TokenColorRole.onSecondaryContainer;
...
class TokenNavRailDarkMediumContrast {
  /// md.comp.nav-rail.item.active.focused.state-layer.color
  static const TokenColorRole itemActiveFocusedStateLayerColor =
      TokenColorRole.onSecondaryContainer;
...
class TokenNavRailLightDefault {
  /// md.comp.nav-rail.item.active.focused.state-layer.color
  static const TokenColorRole itemActiveFocusedStateLayerColor =
      TokenColorRole.onSecondaryContainer;
...
class TokenNavRailLightHighContrast {
  /// md.comp.nav-rail.item.active.focused.state-layer.color
  static const TokenColorRole itemActiveFocusedStateLayerColor =
      TokenColorRole.onSecondaryContainer;
...
class TokenNavRailLightMediumContrast {
  /// md.comp.nav-rail.item.active.focused.state-layer.color
  static const TokenColorRole itemActiveFocusedStateLayerColor =
      TokenColorRole.onSecondaryContainer;
