...
class TokenCheckbox {
  ...
  static const double containerSize = 18.00;

  /// md.comp.checkbox.error.focus.state-layer.opacity
  static const double errorFocusStateLayerOpacity = 0.10;
...
class TokenCheckboxDarkHighContrast {
  /// md.comp.checkbox.error.focus.state-layer.color
  static const TokenColorRole errorFocusStateLayerColor = TokenColorRole.error;
...
class TokenCheckboxDarkMediumContrast {
  /// md.comp.checkbox.error.focus.state-layer.color
  static const TokenColorRole errorFocusStateLayerColor = TokenColorRole.error;
...
class TokenCheckboxLight {
  /// md.comp.checkbox.selected.disabled.icon.color
  static const TokenColorRole selectedDisabledIconColor =
      TokenColorRole.surface;
}

class TokenCheckboxLightDefault {
  /// md.comp.checkbox.error.focus.state-layer.color
  static const TokenColorRole errorFocusStateLayerColor = TokenColorRole.error;
...
class TokenCheckboxLightHighContrast {
  /// md.comp.checkbox.error.focus.state-layer.color
  static const TokenColorRole errorFocusStateLayerColor = TokenColorRole.error;
...
class TokenCheckboxLightMediumContrast {
  /// md.comp.checkbox.error.focus.state-layer.color
  static const TokenColorRole errorFocusStateLayerColor = TokenColorRole.error;
