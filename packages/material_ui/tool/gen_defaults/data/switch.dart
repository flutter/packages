...
class TokenSwitch {
  ...
  /// md.comp.switch.focus.indicator.offset
  static const double focusIndicatorOffset = 2.00;

  /// md.comp.switch.focus.indicator.thickness
  ...
  static const double pressedHandleHeight = 28.00;
  ...
  static const double selectedHandleHeight = 24.00;
  ...
  static const ShapeStruct stateLayerShape = ShapeStruct(
    family: 'SHAPE_FAMILY_CIRCULAR',
    topLeft: 0.00,
    topRight: 0.00,
    bottomLeft: 0.00,
  ...
  static const double trackHeight = 32.00;

  /// md.comp.switch.track.outline.width
  static const double trackOutlineWidth = 2.00;
  ...
  static const double unselectedHandleHeight = 16.00;
  ...
  static const double withIconHandleWidth = 24.00;
}

class TokenSwitchDark {
...
class TokenSwitchDarkDefault {
  ...
  static const TokenColorRole selectedFocusTrackColor = TokenColorRole.primary;

  /// md.comp.switch.selected.handle.color
  static const TokenColorRole selectedHandleColor = TokenColorRole.onPrimary;
  ...
  static const TokenColorRole selectedHoverTrackColor = TokenColorRole.primary;

  /// md.comp.switch.selected.icon.color
  static const TokenColorRole selectedIconColor = TokenColorRole.primary;
...
class TokenSwitchDarkHighContrast {
  /// md.comp.switch.disabled.selected.icon.color
  static const TokenColorRole disabledSelectedIconColor =
      TokenColorRole.onSurface;
...
class TokenSwitchLightHighContrast {
  /// md.comp.switch.disabled.selected.icon.color
  static const TokenColorRole disabledSelectedIconColor =
      TokenColorRole.onSurface;
...
class TokenSwitchLightMediumContrast {
  /// md.comp.switch.disabled.selected.icon.color
  static const TokenColorRole disabledSelectedIconColor =
      TokenColorRole.onSurface;
