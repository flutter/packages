...
class TokenSuggestionChip {
  ...
  static const TokenColorRole draggedLabelTextColor = TokenColorRole.onSurfaceVariant;

  /// md.comp.suggestion-chip.dragged.state-layer.color
  static const TokenColorRole draggedStateLayerColor = TokenColorRole.onSurfaceVariant;
  ...
  static const TokenColorRole flatFocusOutlineColor = TokenColorRole.onSurfaceVariant;
  ...
  static const TokenColorRole withLeadingIconDraggedLeadingIconColor = TokenColorRole.primary;

  /// md.comp.suggestion-chip.with-leading-icon.focus.leading-icon.color
  static const TokenColorRole withLeadingIconFocusLeadingIconColor = TokenColorRole.primary;

  /// md.comp.suggestion-chip.with-leading-icon.hover.leading-icon.color
  static const TokenColorRole withLeadingIconHoverLeadingIconColor = TokenColorRole.primary;

  /// md.comp.suggestion-chip.with-leading-icon.leading-icon.color
  static const TokenColorRole withLeadingIconLeadingIconColor = TokenColorRole.primary;
  ...
  static const TokenColorRole withLeadingIconPressedLeadingIconColor = TokenColorRole.primary;
}
