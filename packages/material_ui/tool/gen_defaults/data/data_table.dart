...
class TokenDataTableDark {
  /// md.comp.data-table.footer.container.color
  static const TokenColorRole footerContainerColor = TokenColorRole.surface;
  ...
  static const TokenColorRole rowItemSelectedContainerColor =
...
class TokenDataTableDarkDefault {
...
class TokenDataTableDarkHighContrast {
  /// md.comp.data-table.footer.supporting-text.color
  static const TokenColorRole footerSupportingTextColor =
      TokenColorRole.onSurfaceVariant;
...
class TokenDataTableDarkMediumContrast {
  /// md.comp.data-table.footer.supporting-text.color
  static const TokenColorRole footerSupportingTextColor =
      TokenColorRole.onSurfaceVariant;
...
class TokenDataTableLightDefault {
  /// md.comp.data-table.footer.supporting-text.color
  static const TokenColorRole footerSupportingTextColor =
      TokenColorRole.onSurfaceVariant;
...
class TokenDataTableLightHighContrast {
  /// md.comp.data-table.footer.supporting-text.color
  static const TokenColorRole footerSupportingTextColor =
      TokenColorRole.onSurfaceVariant;
...
class TokenDataTableLightMediumContrast {
  /// md.comp.data-table.footer.supporting-text.color
  static const TokenColorRole footerSupportingTextColor =
      TokenColorRole.onSurfaceVariant;
