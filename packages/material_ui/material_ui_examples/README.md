...
[`material_ui_examples/test`](./test), that matches their location under [lib](./lib),
...
[pubspec.yaml](pubspec.yaml) in the [material_ui_examples](./) directory.
...
The source for these snippets isn't stored under the [`material_ui_examples`](.)
