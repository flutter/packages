...
import 'package:material_ui_examples/chip/deletable_chip_attributes.delete_icon_box_constraints.0.dart'
    as example;

void main() {
  testWidgets(
    'RawChip.deleteIconBoxConstraints updates delete icon size constraints',
    (WidgetTester tester) async {
      ...
      Offset deleteIconCenter = tester.getCenter(
        find.byIcon(Icons.cancel).at(0),
      );
      expect(
        chipToRight.dx,
