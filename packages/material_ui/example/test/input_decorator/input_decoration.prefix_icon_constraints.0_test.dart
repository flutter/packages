...
import 'package:material_ui_examples/input_decorator/input_decoration.prefix_icon_constraints.0.dart'
    as example;

void main() {
  testWidgets(
    'Shows two TextFields decorated with prefix icon sizes matching their hint text',
  ...
  testWidgets('prefixIcons are placed left of hintText', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(const example.PrefixIconConstraintsExampleApp());
