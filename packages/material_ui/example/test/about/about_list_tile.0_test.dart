...
import 'package:material_ui_examples/about/about_list_tile.0.dart' as example;
...
void main() {
  ...
  testWidgets(
    'It should show the about dialog after clicking on about list tile in the drawer',
    (WidgetTester tester) async {
      ...
      expect(
        find.widgetWithText(AboutListTile, 'About Show About Example'),
        findsOne,
      );
