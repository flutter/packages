...
import 'package:material_ui_examples/scaffold/scaffold.floating_action_button_animator.0.dart'
    as example;

void main() {
  testWidgets('FloatingActionButton animation can be customized', (
    WidgetTester tester,
  ) async {
