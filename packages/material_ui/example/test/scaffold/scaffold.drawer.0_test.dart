...
import 'package:material_ui_examples/scaffold/scaffold.drawer.0.dart'
    as example;

void main() {
  testWidgets(
    'The page should contain a drawer than can be opened and closed',
    (WidgetTester tester) async {
      await tester.pumpWidget(const example.DrawerExampleApp());
