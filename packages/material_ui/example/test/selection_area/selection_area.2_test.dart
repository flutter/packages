...
void main() {
  testWidgets('SelectionArea Color Text Red Example Smoke Test', (
    ...
    expect(
      find.widgetWithIcon(FloatingActionButton, Icons.undo),
      findsOneWidget,
    );
    expect(find.byType(Column), findsNWidgets(2));
    expect(
      find.textContaining('This is some bulleted list:\n'),
      findsOneWidget,
    );
    for (int i = 1; i <= 7; i += 1) {
    ...
    expect(
      find.textContaining('This is some text in a text widget.'),
      findsOneWidget,
    );
    expect(
      find.textContaining(' This is some more text in the same text widget.'),
      findsOneWidget,
    );
    expect(
      find.textContaining('This is some text in another text widget.'),
      findsOneWidget,
    );
  });

  testWidgets(
    'SelectionArea Color Text Red Example - colors selected range red',
    (WidgetTester tester) async {
      ...
      expect(
        paragraph2.selections[0],
        const TextSelection(baseOffset: 0, extentOffset: 83),
      );
      // Third text widget.
      expect(paragraph3.selections.length, 1);
      expect(
        paragraph3.selections[0],
      ...
      expect(
        (paragraph1ResultingSpan.children![0] as TextSpan).children,
        isNotNull,
      );
      expect(
        (paragraph1ResultingSpan.children![0] as TextSpan).children!.length,
        3,
      );
      expect(
        (paragraph1ResultingSpan.children![0] as TextSpan).children![0].style,
        isNull,
      );
      expect(
        (paragraph1ResultingSpan.children![0] as TextSpan).children![1],
        isA<TextSpan>(),
      );
      expect(
        ((paragraph1ResultingSpan.children![0] as TextSpan).children![1]
      ...
      expect(
        (paragraph1ResultingSpan.children![0] as TextSpan).children![1].style,
        isNotNull,
      );
      expect(
        (paragraph1ResultingSpan.children![0] as TextSpan)
            .children![1]
            .style!
            .color,
        isNotNull,
      ...
      expect(
        (paragraph1ResultingSpan.children![0] as TextSpan).children![2],
        isA<WidgetSpan>(),
      );
      // Bullets are red.
      for (final RenderParagraph paragraphBullet in bullets) {
        ...
        expect(
          (resultingBulletSpan.children![0] as TextSpan).children,
          isNotNull,
        );
        expect(
          (resultingBulletSpan.children![0] as TextSpan).children!.length,
          1,
        );
        expect(
          (resultingBulletSpan.children![0] as TextSpan).children![0],
          isA<TextSpan>(),
        );
        expect(
          ((resultingBulletSpan.children![0] as TextSpan).children![0]
      ...
      expect(
        (paragraph2ResultingSpan.children![0] as TextSpan).children,
        isNotNull,
      );
      for (final InlineSpan span
          in (paragraph2ResultingSpan.children![0] as TextSpan).children!) {
        if (span is TextSpan) {
      ...
      expect(
        (paragraph3ResultingSpan.children![0] as TextSpan).children,
        isNotNull,
      );
      expect(
        (paragraph3ResultingSpan.children![0] as TextSpan).children!.length,
        2,
      );
      expect(
      ...
      expect(
        (paragraph3ResultingSpan.children![0] as TextSpan)
            .children![0]
            .style!
            .color,
        isNotNull,
      ...
      expect(
        (paragraph3ResultingSpan.children![0] as TextSpan).children![1].style,
        isNull,
      );
    },
  );
