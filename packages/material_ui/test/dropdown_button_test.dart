...
void main() {
  ...
  Finder findDropdownButtonIconRichText(Key iconKey) {
    return find.descendant(of: find.byKey(iconKey), matching: find.byType(RichText));
  }

  testWidgets('Default DropdownButton golden', (WidgetTester tester) async {
    final Key buttonKey = UniqueKey();
    Widget build() => buildFrame(
      useMaterial3: false,
      child: buildDropdownButton(buttonKey: buttonKey, onChanged: onChanged),
    );
  ...
  testWidgets('Expanded DropdownButton golden', (WidgetTester tester) async {
    final Key buttonKey = UniqueKey();
    Widget build() => buildFrame(
      useMaterial3: false,
      child: buildDropdownButton(buttonKey: buttonKey, isExpanded: true, onChanged: onChanged),
    );
    await tester.pumpWidget(build());
    final Finder buttonFinder = find.byKey(buttonKey);
    assert(tester.renderObject(buttonFinder).attached);
  ...
  testWidgets('DropdownButton button control test', (WidgetTester tester) async {
    String? value = 'one';
    ...
    Widget build() => buildFrame(
      child: buildDropdownButton(initialValue: value, onChanged: didChangeValue),
    );
  ...
  testWidgets('Size of DropdownButton with padding', (WidgetTester tester) async {
    ...
    Widget build() => buildFrame(
      child: buildDropdownButton(buttonKey: buttonKey, onChanged: onChanged, padding: padding),
    );
  ...
  group('DropdownButton feedback', () {
    ...
    testWidgets('DropdownButton feedback enabled', (WidgetTester tester) async {
    ...
    testWidgets('DropdownButton feedback disabled', (WidgetTester tester) async {
    ...
    testWidgets('DropdownButton feedback enabled by default', (WidgetTester tester) async {
  ...
  testWidgets('DropdownButton does not crash if used in very short screen', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('DropdownButton position test with `menuMaxHeight`', (WidgetTester tester) async {
    final Key buttonKey = UniqueKey();
    await tester.pumpWidget(
      buildFrame(
        child: buildDropdownButton(
  ...
  testWidgets(
    'DropdownButton maximum height should be influenced by DropdownButton.menuMaxHeight',
  ...
  testWidgets('DropdownButton should persistently show a scrollbar if it is scrollable', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      buildFrame(
  ...
  testWidgets(
    'DropdownButton does not crash when option is selected without waiting for opening animation to complete',
    (WidgetTester tester) async {
  ...
  testWidgets('DropdownButton onTap callback is called when defined', (WidgetTester tester) async {
    ...
    Widget build() => buildFrame(
      child: buildDropdownButton(initialValue: value, onChanged: onChanged, onTap: onTap),
    );
    await tester.pumpWidget(build());
  ...
  testWidgets('Selected element is focused when DropdownButton is opened', (
    WidgetTester tester,
  ) async {
    final focusNode = FocusNode(debugLabel: 'DropdownButton');
    addTearDown(focusNode.dispose);
  ...
  testWidgets(
    'Selected element is correctly focused with DropdownButton that has more items than fit on the screen',
    (WidgetTester tester) async {
      final focusNode = FocusNode(debugLabel: 'DropdownButton');
      addTearDown(focusNode.dispose);
      int? value = 1;
  ...
  testWidgets(
    "DropdownButton having a focused element doesn't interrupt scroll when flung by touch",
    (WidgetTester tester) async {
      final focusNode = FocusNode(debugLabel: 'DropdownButton');
      addTearDown(focusNode.dispose);
      int? value = 1;
  ...
  testWidgets('DropdownButton handles variable size and oversized menu items', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('DropdownButton will accept widgets as its underline', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      buildFrame(
        child: buildDropdownButton(buttonKey: buttonKey, underline: customUnderline),
      ),
    );
    expect(tester.widgetList<DecoratedBox>(decoratedBox).last.decoration, decoration);

    await tester.pumpWidget(buildFrame(child: buildDropdownButton(buttonKey: buttonKey)));
    expect(tester.widgetList<DecoratedBox>(decoratedBox).last.decoration, defaultDecoration);
  });

  testWidgets('DropdownButton respects parent size limits', (WidgetTester tester) async {
  ...
  testWidgets('DropdownButton in center showing bottom item', (WidgetTester tester) async {
  ...
  testWidgets('DropdownButton in middle showing middle item', (WidgetTester tester) async {
    final items = List<DropdownMenuItem<int>>.generate(
      100,
      (int i) => DropdownMenuItem<int>(value: i, child: Text('$i')),
    );
  ...
  testWidgets('DropdownButton in top showing bottom item', (WidgetTester tester) async {
    final items = List<DropdownMenuItem<int>>.generate(
      100,
      (int i) => DropdownMenuItem<int>(value: i, child: Text('$i')),
    );
  ...
  testWidgets('DropdownButton in bottom showing top item', (WidgetTester tester) async {
    final items = List<DropdownMenuItem<int>>.generate(
      100,
      (int i) => DropdownMenuItem<int>(value: i, child: Text('$i')),
    );
  ...
  testWidgets('DropdownButton menu width is correct when set', (WidgetTester tester) async {
  ...
  testWidgets('DropdownButton disabledHint displays on empty items or onChanged', (
    WidgetTester tester,
  ) async {
    final Key buttonKey = UniqueKey();
  ...
  testWidgets('DropdownButton disabledHint behavior test', (WidgetTester tester) async {
    Widget build({
      List<String>? items,
      ValueChanged<String?>? onChanged,
      String? value,
  ...
  testWidgets('DropdownButton must fit within the screen', (WidgetTester tester) async {
    ...
    await popUpAndDown(
      buildFrame(
        ...
        child: buildDropdownButton(initialValue: menuItems.last, onChanged: onChanged),
      ),
    );
    ...
    await popUpAndDown(
      buildFrame(
        ...
        child: buildDropdownButton(initialValue: menuItems.first, onChanged: onChanged),
      ),
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(
        buildFrame(
          child: buildDropdownButton(onChanged: onChanged),
          mediaSize: const Size(800, 600),
        ),
      );
      await tester.tap(find.byType(dropdownButtonType));
  ...
  testWidgets('Size of DropdownButton with null value', (WidgetTester tester) async {
    ...
    Widget build() => buildFrame(
      child: buildDropdownButton(buttonKey: buttonKey, initialValue: value, onChanged: onChanged),
    );
  ...
  testWidgets('Size of DropdownButton with no items', (WidgetTester tester) async {
    ...
    Widget build() => buildFrame(
      child: buildDropdownButton(buttonKey: buttonKey, items: items, onChanged: onChanged),
    );
  ...
  testWidgets('DropdownButton scrolls to first item in long lists', (WidgetTester tester) async {
    final Key buttonKey = UniqueKey();
    await tester.pumpWidget(
      buildFrame(
        child: buildDropdownButton(
  ...
  testWidgets('DropdownButton aligns selected item with button in long lists', (
    WidgetTester tester,
  ) async {
    final Key buttonKey = UniqueKey();
    await tester.pumpWidget(
  ...
  testWidgets('DropdownButton scrolls to last item in long lists', (WidgetTester tester) async {
    final Key buttonKey = UniqueKey();
    await tester.pumpWidget(
      buildFrame(
        child: buildDropdownButton(
  ...
  testWidgets('DropdownButton can have a text style with no fontSize specified', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('DropdownButton with isDense:true aligns selected menu item', (
    WidgetTester tester,
  ) async {
    final Key buttonKey = UniqueKey();

    Widget build() => buildFrame(
      child: buildDropdownButton(buttonKey: buttonKey, isDense: true, onChanged: onChanged),
    );
  ...
  testWidgets(
    'DropdownButton should use its own size and color properties over those defined by the theme',
    (WidgetTester tester) async {
      ...
      final RichText enabledRichText = tester.widget<RichText>(
        findDropdownButtonIconRichText(iconKey),
      );
  ...
  testWidgets('DropdownButton icon will accept widgets as icons', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      buildFrame(
        child: buildDropdownButton(icon: customWidget, onChanged: onChanged),
      ),
    );
    ...
    await tester.pumpWidget(
      buildFrame(
        child: buildDropdownButton(icon: const Icon(Icons.assessment), onChanged: onChanged),
      ),
    );
  ...
  testWidgets('DropdownButton icon should have default size and colors when not defined', (
    WidgetTester tester,
  ) async {
    final Key iconKey = UniqueKey();
    ...
    await tester.pumpWidget(
      buildFrame(
        child: buildDropdownButton(icon: customIcon, onChanged: onChanged),
      ),
    );
    ...
    // test for disabled color
    await tester.pumpWidget(buildFrame(child: buildDropdownButton(icon: customIcon)));
  ...
  testWidgets('DropdownButton icon should have the passed in size and color instead of defaults', (
    WidgetTester tester,
  ) async {
    final Key iconKey = UniqueKey();
    final customIcon = Icon(Icons.assessment, key: iconKey);
  ...
  testWidgets('DropdownButton arrow icon aligns with the edge of button when expanded', (
    WidgetTester tester,
  ) async {
    final Key buttonKey = UniqueKey();
  ...
  testWidgets('DropdownButton can position correctly inside a nested navigator', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('DropdownButton without WidgetsApp', (WidgetTester tester) async {
    String? value = 'one';
    void didChangeValue(String? newValue) {
      value = newValue;
    }
            ...
            onGenerateRoute: (RouteSettings settings) {
              return MaterialPageRoute<void>(
                ...
                builder: (BuildContext context) {
                  return Material(
                    child: buildFrame(
                      child: buildDropdownButton(initialValue: 'one', onChanged: didChangeValue),
                    ),
                  );
                },
              );
  ...
  testWidgets('Conflicting scrollbars are not applied by ScrollBehavior to DropdownButton', (
    WidgetTester tester,
  ) async {
  ...
  group('DropdownButton semantics', () {
    testWidgets('DropdownButton semantics tree contains only selected element', (
      WidgetTester tester,
    ) async {
      final semantics = SemanticsTester(tester);
      await tester.pumpWidget(buildFrame(child: buildDropdownButton(onChanged: onChanged)));
    ...
    testWidgets('Closed DropdownButton includes semantics', (WidgetTester tester) async {
    ...
    testWidgets('DropdownButton includes semantics', (WidgetTester tester) async {
      final semantics = SemanticsTester(tester);
      const key = Key('test');
      await tester.pumpWidget(
        buildFrame(
          child: buildDropdownButton(buttonKey: key, initialValue: null, onChanged: onChanged),
        ),
      );
    ...
    testWidgets(
      'DropdownButton Semantics expanded state should update when menu opens and closes',
      (WidgetTester tester) async {
        // Regression test for https://github.com/flutter/flutter/issues/183432
        const key = Key('test');
        await tester.pumpWidget(
          buildFrame(
            child: buildDropdownButton(buttonKey: key, onChanged: onChanged),
          ),
        );
