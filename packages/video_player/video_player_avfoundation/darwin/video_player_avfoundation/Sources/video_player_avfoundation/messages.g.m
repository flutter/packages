...
@interface FVPPreferredAudioLanguageMessage ()
+ (FVPPreferredAudioLanguageMessage *)fromList:(NSArray<id> *)list;
+ (nullable FVPPreferredAudioLanguageMessage *)nullableFromList:(NSArray<id> *)list;
- (NSArray<id> *)toList;
@end
...
@implementation FVPPreferredAudioLanguageMessage
+ (instancetype)makeWithPreferredAudioLanguage:(nullable NSString *)preferredAudioLanguage {
  FVPPreferredAudioLanguageMessage* pigeonResult = [[FVPPreferredAudioLanguageMessage alloc] init];
  pigeonResult.preferredAudioLanguage = preferredAudioLanguage;
  return pigeonResult;
}
+ (FVPPreferredAudioLanguageMessage *)fromList:(NSArray<id> *)list {
  FVPPreferredAudioLanguageMessage *pigeonResult = [[FVPPreferredAudioLanguageMessage alloc] init];
  pigeonResult.preferredAudioLanguage = GetNullableObjectAtIndex(list, 0);
  return pigeonResult;
}
+ (nullable FVPPreferredAudioLanguageMessage *)nullableFromList:(NSArray<id> *)list {
  return (list) ? [FVPPreferredAudioLanguageMessage fromList:list] : nil;
}
- (NSArray<id> *)toList {
  return @[
    self.preferredAudioLanguage ?: [NSNull null],
  ];
}
@end
...
- (nullable id)readValueOfType:(UInt8)type {
  switch (type) {
    ...
    case 130: 
      return [FVPPreferredAudioLanguageMessage fromList:[self readValue]];
    case 131: 
...
- (void)writeValue:(id)value {
  ...
  } else if ([value isKindOfClass:[FVPPreferredAudioLanguageMessage class]]) {
    [self writeByte:130];
...
void SetUpFVPAVFoundationVideoPlayerApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FVPAVFoundationVideoPlayerApi> *api, NSString *messageChannelSuffix) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.video_player_avfoundation.AVFoundationVideoPlayerApi.setPreferredAudioLanguage", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:FVPGetMessagesCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(setPreferredAudioLanguage:error:)], @"FVPAVFoundationVideoPlayerApi api (%@) doesn't respond to @selector(setPreferredAudioLanguage:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
        NSString *arg_language = GetNullableObjectAtIndex(args, 0);
        FlutterError *error;
        [api setPreferredAudioLanguage:arg_language error:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
      [channel setMessageHandler:nil];
