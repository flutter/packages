...
@class FVPPreferredAudioLanguageMessage;
@class FVPPlatformVideoViewCreationParams;
@class FVPCreationOptions;

@interface FVPPreferredAudioLanguageMessage : NSObject
...
- (void)setPreferredAudioLanguage:(nullable NSString *)language error:(FlutterError *_Nullable *_Nonnull)error;
@end
