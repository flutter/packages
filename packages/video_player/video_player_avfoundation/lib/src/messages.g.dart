...
class PreferredAudioLanguageMessage {
  ...
  static PreferredAudioLanguageMessage decode(Object result) {
    result as List<Object?>;
    return PreferredAudioLanguageMessage(
      preferredAudioLanguage: result[0] as String?,
    );
  }
}
...
class AVFoundationVideoPlayerApi {
  ...
  Future<void> setPreferredAudioLanguage(String? language) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.video_player_avfoundation.AVFoundationVideoPlayerApi.setPreferredAudioLanguage$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
