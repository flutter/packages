...
@class FLTIsSupportedMessageResponse;
@class FLTClearCacheMessageResponse;
...
@interface FLTIsSupportedMessageResponse : NSObject
/// `init` unavailable to enforce nonnull fields, see the `make` class method.
- (instancetype)init NS_UNAVAILABLE;
...
@interface FLTClearCacheMessageResponse : NSObject
/// `init` unavailable to enforce nonnull fields, see the `make` class method.
- (instancetype)init NS_UNAVAILABLE;
...
/// @return `nil` only when `error != nil`.
- (nullable FLTClearCacheMessageResponse *)clearCache:(FLTClearCacheMessage *)msg error:(FlutterError *_Nullable *_Nonnull)error;
- (void)setVolume:(FLTVolumeMessage *)msg error:(FlutterError *_Nullable *_Nonnull)error;
/// @return `nil` only when `error != nil`.
- (nullable FLTIsSupportedMessageResponse *)isCacheSupportedForNetworkMedia:(FLTIsCacheSupportedMessage *)msg error:(FlutterError *_Nullable *_Nonnull)error;
