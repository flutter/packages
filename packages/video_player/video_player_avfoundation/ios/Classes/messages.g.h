...
@class FVPIsCacheSupportedMessage;
...
/// @return `nil` only when `error != nil`.
- (nullable NSNumber *)clearCache:(FlutterError *_Nullable *_Nonnull)error;
- (void)setVolume:(FVPVolumeMessage *)msg error:(FlutterError *_Nullable *_Nonnull)error;
/// @return `nil` only when `error != nil`.
- (nullable NSNumber *)isCacheSupportedForNetworkMedia:(FVPIsCacheSupportedMessage *)msg error:(FlutterError *_Nullable *_Nonnull)error;
