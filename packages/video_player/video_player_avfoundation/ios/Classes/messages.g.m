...
+ (instancetype)makeWithTextureId:(NSNumber *)textureId
  ...
  FLTAutomaticallyStartsPictureInPictureMessage *pigeonResult =
      [[FLTAutomaticallyStartsPictureInPictureMessage alloc] init];
  pigeonResult.textureId = textureId;
...
+ (instancetype)makeWithTextureId:(NSNumber *)textureId
  ...
  FLTSetPictureInPictureOverlaySettingsMessage *pigeonResult =
      [[FLTSetPictureInPictureOverlaySettingsMessage alloc] init];
  pigeonResult.textureId = textureId;
...
+ (FLTSetPictureInPictureOverlaySettingsMessage *)fromList:(NSArray *)list {
  ...
  pigeonResult.textureId = GetNullableObjectAtIndex(list, 0);
  NSAssert(pigeonResult.textureId != nil, @"");
  pigeonResult.settings = [FLTPictureInPictureOverlaySettingsMessage
...
+ (instancetype)makeWithTop:(NSNumber *)top
  ...
  FLTPictureInPictureOverlaySettingsMessage *pigeonResult =
      [[FLTPictureInPictureOverlaySettingsMessage alloc] init];
