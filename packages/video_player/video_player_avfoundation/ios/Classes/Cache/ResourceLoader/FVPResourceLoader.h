 ...
 * resource data from a specified URL. It supports caching and downloading of media data from the
 * URL using a ContentCacheWorker and ContentDownloader. It uses a delegate pattern to notify the
