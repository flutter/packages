...
void main() {
  ...
  group('convertNumVideoDurationToPluginDuration', () {
    testWidgets('Finite value converts to milliseconds', (WidgetTester _) async {
    ...
    testWidgets('Finite value rounds 3rd decimal value', (WidgetTester _) async {
      final Duration? result = convertNumVideoDurationToPluginDuration(1.567899089087);
      final Duration? another = convertNumVideoDurationToPluginDuration(1.567199089087);
    ...
    testWidgets('Infinite value returns magic constant', (WidgetTester _) async {
      final Duration? result = convertNumVideoDurationToPluginDuration(double.infinity);
