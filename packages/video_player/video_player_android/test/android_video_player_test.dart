...
void main() {
  ...
  group('AndroidVideoPlayer', () {
    ...
    test('createWithOptions passes forwardBufferDurationMs for texture view', () async {
      final (AndroidVideoPlayer player, MockAndroidVideoPlayerApi api, _) = setUpMockPlayer(
        playerId: 1,
        textureId: 100,
      );
    ...
    test('createWithOptions passes forwardBufferDurationMs for platform view', () async {
      final (AndroidVideoPlayer player, MockAndroidVideoPlayerApi api, _) = setUpMockPlayer(
        playerId: 1,
      );
      when(api.createForPlatformView(any)).thenAnswer((_) async => 2);
