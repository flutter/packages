...
class CreateMessage {
  ...
  static CreateMessage decode(Object result) {
    ...
    return CreateMessage(
      ...
      clearKey: result[5] as String?,
      token: result[6] as String?,
      licenseUrl: result[7] as String?,
      certificateUrl: result[8] as String?,
      drmType: result[9] as String?,
      drmHeaders: (result[10] as Map<Object?, Object?>?)?.cast<String, String>(),
    );
  }
}
