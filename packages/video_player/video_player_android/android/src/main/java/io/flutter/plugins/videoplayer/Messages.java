...
public class Messages {
  ...
  public static final class CreateMessage {
    ...
    private @Nullable String clearKey;

    public @Nullable String getClearKey() {
      return clearKey;
    }

    public void setClearKey(@Nullable String setterArg) {
      this.clearKey = setterArg;
    }
    ...
    private @Nullable Map<String, String> drmHeaders;

    public @Nullable Map<String, String> getDrmHeaders() {
      return drmHeaders;
    }

    public void setDrmHeaders(@Nullable Map<String, String> setterArg) {
      this.drmHeaders = setterArg;
    }
    ...
    public boolean equals(Object o) {
      ...
      return Objects.equals(asset, that.asset) && Objects.equals(uri, that.uri) && Objects.equals(packageName, that.packageName) && Objects.equals(formatHint, that.formatHint) && httpHeaders.equals(that.httpHeaders) && Objects.equals(clearKey, that.clearKey) && Objects.equals(token, that.token) && Objects.equals(licenseUrl, that.licenseUrl) && Objects.equals(certificateUrl, that.certificateUrl) && Objects.equals(drmType, that.drmType) && Objects.equals(drmHeaders, that.drmHeaders);
    }

    @Override
    public int hashCode() {
      return Objects.hash(asset, uri, packageName, formatHint, httpHeaders, clearKey, token, licenseUrl, certificateUrl, drmType, drmHeaders);
    }
    ...
    public static final class Builder {
      ...
      @CanIgnoreReturnValue
      public @NonNull Builder setClearKey(@Nullable String setterArg) {
        this.clearKey = setterArg;
        return this;
      }
      ...
      @CanIgnoreReturnValue
      public @NonNull Builder setDrmHeaders(@Nullable Map<String, String> setterArg) {
        this.drmHeaders = setterArg;
        return this;
      }
      ...
      public @NonNull CreateMessage build() {
        ...
        pigeonReturn.setClearKey(clearKey);
        ...
        pigeonReturn.setDrmHeaders(drmHeaders);
        return pigeonReturn;
      }
    }
    ...
    static @NonNull CreateMessage fromList(@NonNull ArrayList<Object> pigeonVar_list) {
      ...
      Object clearKey = pigeonVar_list.get(5);
      pigeonResult.setClearKey((String) clearKey);
      Object token = pigeonVar_list.get(6);
      pigeonResult.setToken((String) token);
      Object licenseUrl = pigeonVar_list.get(7);
      pigeonResult.setLicenseUrl((String) licenseUrl);
      Object certificateUrl = pigeonVar_list.get(8);
      pigeonResult.setCertificateUrl((String) certificateUrl);
      Object drmType = pigeonVar_list.get(9);
      pigeonResult.setDrmType((String) drmType);
      Object drmHeaders = pigeonVar_list.get(10);
      pigeonResult.setDrmHeaders((Map<String, String>) drmHeaders);
      return pigeonResult;
    }
  }
