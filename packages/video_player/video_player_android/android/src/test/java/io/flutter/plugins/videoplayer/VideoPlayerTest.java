...
public final class VideoPlayerTest {
  ...
  public void testSelectVideoTrack_disposeDuringDimensionChangeDelayDoesNotCrash() {
    ...
    Format currentFormat =
        new Format.Builder().setId("cur").setWidth(1280).setHeight(720).build();
    Format newFormat =
        new Format.Builder().setId("new").setWidth(1920).setHeight(1080).build();
    ...
    doThrow(new IllegalStateException("Player released"))
        .when(mockExoPlayer)
        .seekTo(anyLong());
