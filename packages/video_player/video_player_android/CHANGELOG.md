...
- Added support for preferred audio language by passing preferredAudioLanguage string parameter (for example 'en' or 'fr') via VideoPlayerOptions when initializing VideoPlayerController.
