...
abstract class TestWebViewHostApi {
  ...
  Future<void> setAuthCredentials(int instanceId, String host, String realm, String username, String password);
  ...
  static void setup(TestWebViewHostApi? api, {BinaryMessenger? binaryMessenger}) {
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.WebViewHostApi.setAuthCredentials', codec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, null);
      } else {
        _testBinaryMessengerBinding!.defaultBinaryMessenger.setMockDecodedMessageHandler<Object?>(channel, (Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.WebViewHostApi.setAuthCredentials was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_instanceId = (args[0] as int?);
          assert(arg_instanceId != null,
              'Argument for dev.flutter.pigeon.WebViewHostApi.setAuthCredentials was null, expected non-null int.');
          final String? arg_host = (args[1] as String?);
          assert(arg_host != null,
              'Argument for dev.flutter.pigeon.WebViewHostApi.setAuthCredentials was null, expected non-null String.');
          final String? arg_realm = (args[2] as String?);
          assert(arg_realm != null,
              'Argument for dev.flutter.pigeon.WebViewHostApi.setAuthCredentials was null, expected non-null String.');
          final String? arg_username = (args[3] as String?);
          assert(arg_username != null,
              'Argument for dev.flutter.pigeon.WebViewHostApi.setAuthCredentials was null, expected non-null String.');
          final String? arg_password = (args[4] as String?);
          assert(arg_password != null,
              'Argument for dev.flutter.pigeon.WebViewHostApi.setAuthCredentials was null, expected non-null String.');
          await api.setAuthCredentials(arg_instanceId!, arg_host!, arg_realm!, arg_username!, arg_password!);
          return <Object?>[];
        });
      }
    }
...
abstract class TestWebViewClientHostApi {
  ...
  static void setup(TestWebViewClientHostApi? api,
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.WebViewClientHostApi.setAuthCredentials', codec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        _testBinaryMessengerBinding!.defaultBinaryMessenger
            .setMockDecodedMessageHandler<Object?>(channel, null);
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
            .setMockDecodedMessageHandler<Object?>(channel,
                (Object? message) async {
          assert(message != null,
              'Argument for dev.flutter.pigeon.WebViewClientHostApi.setAuthCredentials was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_instanceId = (args[0] as int?);
          assert(arg_instanceId != null,
              'Argument for dev.flutter.pigeon.WebViewClientHostApi.setAuthCredentials was null, expected non-null int.');
          final String? arg_host = (args[1] as String?);
          assert(arg_host != null,
              'Argument for dev.flutter.pigeon.WebViewClientHostApi.setAuthCredentials was null, expected non-null String.');
          final String? arg_realm = (args[2] as String?);
          assert(arg_realm != null,
              'Argument for dev.flutter.pigeon.WebViewClientHostApi.setAuthCredentials was null, expected non-null String.');
          final String? arg_username = (args[3] as String?);
          ...
          assert(arg_password != null,
              'Argument for dev.flutter.pigeon.WebViewClientHostApi.setAuthCredentials was null, expected non-null String.');
          await api.setAuthCredentials(arg_instanceId!, arg_host!, arg_realm!,
