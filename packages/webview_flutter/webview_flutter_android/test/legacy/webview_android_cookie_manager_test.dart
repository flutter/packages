...
void main() {
  ...
  test('clearCookies should call android_webview.clearCookies', () {
    ...
    WebViewAndroidCookieManager(cookieManager: mockCookieManager).clearCookies();
  ...
  test('setCookie should call android_webview.csetCookie with properly formatted cookie value', () {
    final mockCookieManager = MockCookieManager();
