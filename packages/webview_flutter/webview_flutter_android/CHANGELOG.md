...
* Adds support for handling basic authentication.
* See `PlatformNavigationDelegate.setOnReceiveHttpAuthRequest`.
* See `PlatformWebViewController.setHttpAuthCredentials`.
