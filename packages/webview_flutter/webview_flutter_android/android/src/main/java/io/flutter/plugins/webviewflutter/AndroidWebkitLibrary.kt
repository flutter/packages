...
private class PigeonInstanceManagerApi(val binaryMessenger: BinaryMessenger) {
  companion object {
    ...
    fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, instanceManager: PigeonInstanceManager?) {
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android.PigeonInstanceManagerApi.removeStrongReference", codec)
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android.PigeonInstanceManagerApi.clear", codec)
        if (instanceManager != null) {
...
{
    val channelName = "dev.flutter.pigeon.webview_flutter_android.PigeonInstanceManagerApi.removeStrongReference"
...
abstract class PigeonProxyApiRegistrar(val binaryMessenger: BinaryMessenger) {
  ...
  init {
    ...
    instanceManager = PigeonInstanceManager.create(
...
abstract class PigeonApiWebResourceRequest(open val pigeonRegistrar: PigeonProxyApiRegistrar) {
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiWebResourceError(open val pigeonRegistrar: PigeonProxyApiRegistrar) {
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiConsoleMessage(open val pigeonRegistrar: PigeonProxyApiRegistrar) {
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiCookieManager(open val pigeonRegistrar: PigeonProxyApiRegistrar) {
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiWebView(open val pigeonRegistrar: PigeonProxyApiRegistrar) {
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val pigeon_instanceArg = args[0] as android.webkit.WebView
            val wrapped: List<Any?> = try {
              listOf<Any?>(api.getUrl(pigeon_instanceArg))
            } catch (exception: Throwable) {
              wrapError(exception)
            }
            reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val pigeon_instanceArg = args[0] as android.webkit.WebView
            val wrapped: List<Any?> = try {
              listOf<Any?>(api.canGoBack(pigeon_instanceArg))
            } catch (exception: Throwable) {
              wrapError(exception)
            }
            reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val pigeon_instanceArg = args[0] as android.webkit.WebView
            val wrapped: List<Any?> = try {
              listOf<Any?>(api.canGoForward(pigeon_instanceArg))
            } catch (exception: Throwable) {
              wrapError(exception)
            }
            reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val pigeon_instanceArg = args[0] as android.webkit.WebView
            val wrapped: List<Any?> = try {
              listOf<Any?>(api.getTitle(pigeon_instanceArg))
            } catch (exception: Throwable) {
              wrapError(exception)
            }
            reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as android.webkit.WebView
            val colorArg = args[1].let { num -> if (num is Int) num.toLong() else num as Long }
            val wrapped: List<Any?> = try {
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiWebSettings(open val pigeonRegistrar: PigeonProxyApiRegistrar) {
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as android.webkit.WebSettings
            val textZoomArg = args[1].let { num -> if (num is Int) num.toLong() else num as Long }
            val wrapped: List<Any?> = try {
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val pigeon_instanceArg = args[0] as android.webkit.WebSettings
            val wrapped: List<Any?> = try {
              listOf<Any?>(api.getUserAgentString(pigeon_instanceArg))
            } catch (exception: Throwable) {
              wrapError(exception)
            }
            reply.reply(wrapped)
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiWebViewClient(open val pigeonRegistrar: PigeonProxyApiRegistrar) {
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiDownloadListener(open val pigeonRegistrar: PigeonProxyApiRegistrar) {
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiFlutterAssetManager(open val pigeonRegistrar: PigeonProxyApiRegistrar) {
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val wrapped: List<Any?> = try {
              listOf<Any?>(api.list(pigeon_instanceArg, pathArg))
            } catch (exception: Throwable) {
              wrapError(exception)
            }
            reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val nameArg = args[1] as String
            val wrapped: List<Any?> = try {
              listOf<Any?>(api.getAssetFilePathByName(pigeon_instanceArg, nameArg))
            } catch (exception: Throwable) {
              wrapError(exception)
            }
            reply.reply(wrapped)
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiWebStorage(open val pigeonRegistrar: PigeonProxyApiRegistrar) {
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiFileChooserParams(open val pigeonRegistrar: PigeonProxyApiRegistrar) {
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiPermissionRequest(open val pigeonRegistrar: PigeonProxyApiRegistrar) {
  @androidx.annotation.RequiresApi(api = 21)
        ...
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            reply.reply(wrapError(UnsupportedOperationException(
              "Call references class `android.webkit.PermissionRequest`, which requires api version 21."
            )))
          }
        } else {
          channel.setMessageHandler(null)
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiCustomViewCallback(open val pigeonRegistrar: PigeonProxyApiRegistrar) {
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val xArg = args[1].let { num -> if (num is Int) num.toLong() else num as Long }
            val yArg = args[2].let { num -> if (num is Int) num.toLong() else num as Long }
            val wrapped: List<Any?> = try {
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val pigeon_instanceArg = args[0] as android.view.View
            val wrapped: List<Any?> = try {
              listOf<Any?>(api.getScrollPosition(pigeon_instanceArg))
            } catch (exception: Throwable) {
              wrapError(exception)
            }
            reply.reply(wrapped)
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiGeolocationPermissionsCallback(open val pigeonRegistrar: PigeonProxyApiRegistrar) {
 ...
 */
@Suppress("UNCHECKED_CAST")
abstract class PigeonApiHttpAuthHandler(open val pigeonRegistrar: PigeonProxyApiRegistrar) {
  /**
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val wrapped: List<Any?> = try {
              listOf<Any?>(api.useHttpAuthUsernamePassword(pigeon_instanceArg))
            } catch (exception: Throwable) {
              wrapError(exception)
            }
            reply.reply(wrapped)
