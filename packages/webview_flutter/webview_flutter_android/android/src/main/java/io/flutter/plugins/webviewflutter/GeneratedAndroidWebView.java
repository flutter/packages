...
public class GeneratedAndroidWebView {
    ...
    static void setup(
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger,
                "dev.flutter.pigeon.WebViewClientHostApi.setSynchronousReturnValueForOnRenderProcessGone",
                getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ...
                Boolean valueArg = (Boolean) args.get(1);
                try {
                  api.setSynchronousReturnValueForOnRenderProcessGone(
                      (instanceIdArg == null) ? null : instanceIdArg.longValue(), valueArg);
                  wrapped.add(0, null);
                } catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
  ...
  public static class WebViewClientFlutterApi {
    ...
    public void onRenderProcessGone(
        @NonNull Long instanceIdArg,
        @NonNull Long webViewInstanceIdArg,
        @NonNull RenderProcessGoneDetailData detailArg,
        @NonNull Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(
              binaryMessenger,
              "dev.flutter.pigeon.WebViewClientFlutterApi.onRenderProcessGone",
              getCodec());
      channel.send(
