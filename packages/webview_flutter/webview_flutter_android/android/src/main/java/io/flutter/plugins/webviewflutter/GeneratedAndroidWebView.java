...
public class GeneratedAndroidWebView {
  ...
  public static class WebViewClientFlutterApi {
    ...
    public void onRenderProcessGone(@NonNull Long instanceIdArg, @NonNull Long webViewInstanceIdArg, @NonNull Boolean didCrashArg, @NonNull Long rendererPriorityAtExitArg, Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(
              binaryMessenger, "dev.flutter.pigeon.WebViewClientFlutterApi.onRenderProcessGone", getCodec());
      channel.send(
          new ArrayList<Object>(Arrays.asList(instanceIdArg, webViewInstanceIdArg, didCrashArg, rendererPriorityAtExitArg)),
          channelReply -> callback.reply(null));
    }
