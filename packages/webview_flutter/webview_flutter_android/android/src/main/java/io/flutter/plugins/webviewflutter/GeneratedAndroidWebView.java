      ...
      } else 
{
  ...
  public interface WebSettingsHostApi {
    ...
    void setTextZoom(@NonNull Long textZoom);
    ...
    static void setup(BinaryMessenger binaryMessenger, WebSettingsHostApi api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.WebSettingsHostApi.setTextZoom", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ArrayList wrapped = new ArrayList<>();
            try {
              ArrayList<Object> args = (ArrayList<Object>)message;
              assert args != null;
              Number textZoomArg = (Number)args.get(0);
              if (textZoomArg == null) {
                throw new NullPointerException("textZoomArg unexpectedly null.");
              }
              api.setTextZoom((textZoomArg == null) ? null : textZoomArg.longValue());
              wrapped.add(0, null);
            }
            catch (Error | RuntimeException exception) {
              ArrayList<Object> wrappedError = wrapError(exception);
