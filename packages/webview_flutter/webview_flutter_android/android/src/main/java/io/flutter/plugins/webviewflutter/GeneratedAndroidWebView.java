...
public class GeneratedAndroidWebView {
  ...
  public interface WebViewHostApi {
    ...
    void requestFocus(@NonNull Long instanceId);
    ...
    static void setup(@NonNull BinaryMessenger binaryMessenger, @Nullable WebViewHostApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.webview_flutter_android.WebViewHostApi.requestFocus", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ...
                Number instanceIdArg = (Number) args.get(0);
                try {
                  api.requestFocus((instanceIdArg == null) ? null : instanceIdArg.longValue());
                  wrapped.add(0, null);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
