...
public class GeneratedAndroidWebView {
  ...
  /** Generated class from Pigeon that represents data sent in messages. */
  public static final class RenderProcessGoneDetailData {
    private @NonNull Boolean didCrash;

    public @NonNull Boolean getDidCrash() {
      return didCrash;
    }

    public void setDidCrash(@NonNull Boolean setterArg) {
      if (setterArg == null) {
        throw new IllegalStateException("Nonnull field \"didCrash\" is null.");
      }
    ...
    public static final class Builder {
      ...
      private @Nullable Boolean didCrash;

      public @NonNull Builder setDidCrash(@NonNull Boolean setterArg) {
        this.didCrash = setterArg;
        return this;
      }
    ...
    static @NonNull RenderProcessGoneDetailData fromList(@NonNull ArrayList<Object> list) {
      ...
      pigeonResult.setRendererPriorityAtExit((rendererPriorityAtExit == null) ? null : ((rendererPriorityAtExit instanceof Integer) ? (Integer) rendererPriorityAtExit : (Long) rendererPriorityAtExit));
      return pigeonResult;
    }
  }
  ...
  public interface WebViewClientHostApi {
    ...
    void setSynchronousReturnValueForOnRenderProcessGone(@NonNull Long instanceId, @NonNull Boolean value);
    ...
    static void setup(@NonNull BinaryMessenger binaryMessenger, @Nullable WebViewClientHostApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.WebViewClientHostApi.setSynchronousReturnValueForOnRenderProcessGone", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ...
                Boolean valueArg = (Boolean) args.get(1);
                try {
                  api.setSynchronousReturnValueForOnRenderProcessGone((instanceIdArg == null) ? null : instanceIdArg.longValue(), valueArg);
                  wrapped.add(0, null);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
  ...
  private static class WebViewClientFlutterApiCodec extends StandardMessageCodec {
    ...
    protected Object readValueOfType(byte type, @NonNull ByteBuffer buffer) {
      switch (type) {
        case (byte) 128:
          return RenderProcessGoneDetailData.fromList((ArrayList<Object>) readValue(buffer));
        case (byte) 129:
    ...
    @Override
    protected void writeValue(@NonNull ByteArrayOutputStream stream, Object value) {
      if (value instanceof RenderProcessGoneDetailData) {
        stream.write(128);
        writeValue(stream, ((RenderProcessGoneDetailData) value).toList());
  ...
  public static class WebViewClientFlutterApi {
    ...
    public void onRenderProcessGone(@NonNull Long instanceIdArg, @NonNull Long webViewInstanceIdArg, @NonNull RenderProcessGoneDetailData detailArg, @NonNull Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(
              binaryMessenger, "dev.flutter.pigeon.WebViewClientFlutterApi.onRenderProcessGone", getCodec());
      channel.send(
          new ArrayList<Object>(Arrays.asList(instanceIdArg, webViewInstanceIdArg, detailArg)),
          channelReply -> callback.reply(null));
    }
    ...
    public void doUpdateVisitedHistory(@NonNull Long instanceIdArg, @NonNull Long webViewInstanceIdArg, @NonNull String urlArg, @NonNull Boolean isReloadArg, @NonNull Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(
              binaryMessenger, "dev.flutter.pigeon.WebViewClientFlutterApi.doUpdateVisitedHistory", getCodec());
      channel.send(
