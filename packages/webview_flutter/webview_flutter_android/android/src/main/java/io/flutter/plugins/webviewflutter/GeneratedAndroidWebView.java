...
public class GeneratedAndroidWebView {
  ...
  public interface PermissionRequestHostApi {
     ...
     * `binaryMessenger`.
     */
    static void setup(BinaryMessenger binaryMessenger, PermissionRequestHostApi api) {
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
  ...
  public static class PermissionRequestFlutterApi {
    ...
    public PermissionRequestFlutterApi(BinaryMessenger argBinaryMessenger) {
      this.binaryMessenger = argBinaryMessenger;
    }
    ...
    /** Create a new Dart instance and add it to the `InstanceManager`. */
    public void create(
        @NonNull Long instanceIdArg, @NonNull List<String> resourcesArg, Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(
