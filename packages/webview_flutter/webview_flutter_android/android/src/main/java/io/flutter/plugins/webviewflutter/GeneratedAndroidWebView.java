...
public class GeneratedAndroidWebView {
  ...
  public interface WebViewHostApi {
    ...
    void setAuthCredentials(@NonNull Long instanceId, @NonNull String host, @NonNull String realm, @NonNull String username, @NonNull String password, @NonNull Result<Void> result);
    ...
    static void setup(@NonNull BinaryMessenger binaryMessenger, @Nullable WebViewHostApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.WebViewHostApi.setAuthCredentials", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ...
                String realmArg = (String) args.get(2);
                String usernameArg = (String) args.get(3);
                String passwordArg = (String) args.get(4);
                ...
                api.setAuthCredentials((instanceIdArg == null) ? null : instanceIdArg.longValue(), hostArg, realmArg, usernameArg, passwordArg, resultCallback);
              });
        } else {
          channel.setMessageHandler(null);
        }
    ...
    static void setup(@NonNull BinaryMessenger binaryMessenger, @Nullable WebViewClientHostApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger,
                "dev.flutter.pigeon.WebViewClientHostApi.setAuthCredentials",
                getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
  ...
  public static class WebViewClientFlutterApi {
    ...
    public void onReceivedHttpAuthRequest(@NonNull Long instanceIdArg, @NonNull Long webViewInstanceIdArg, @NonNull String hostArg, @NonNull String realmArg, @NonNull Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(
              binaryMessenger, "dev.flutter.pigeon.WebViewClientFlutterApi.onReceivedHttpAuthRequest", getCodec());
      channel.send(
          new ArrayList<Object>(Arrays.asList(instanceIdArg, webViewInstanceIdArg, hostArg, realmArg)),
          channelReply -> callback.reply(null));
    }
    ...
    public void onReceivedHttpAuthRequest(
      ...
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(
              binaryMessenger,
              "dev.flutter.pigeon.WebViewClientFlutterApi.onReceivedHttpAuthRequest",
              getCodec());
      channel.send(
          new ArrayList<Object>(
              Arrays.asList(instanceIdArg, webViewInstanceIdArg, hostArg, realmArg)),
          channelReply -> callback.reply(null));
    }
  }
  /** Generated interface from Pigeon that represents a handler of messages from Flutter. */
