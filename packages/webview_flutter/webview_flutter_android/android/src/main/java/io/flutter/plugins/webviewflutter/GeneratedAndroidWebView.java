...
public class GeneratedAndroidWebView {
  ...
  public static class WebViewFlutterApi {
    ...
    public void onScrollPosChange(@NonNull Long webViewInstanceIdArg, @NonNull Long xArg, @NonNull Long yArg, @NonNull Reply<Void> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(
              binaryMessenger, "dev.flutter.pigeon.WebViewFlutterApi.onScrollPosChange", getCodec());
      channel.send(
          new ArrayList<Object>(Arrays.asList(webViewInstanceIdArg, xArg, yArg)),
          channelReply -> callback.reply(null));
    }
  }
  /** Generated interface from Pigeon that represents a handler of messages from Flutter. */
