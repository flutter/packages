...
class _PigeonInstanceManagerApi {
  ...
  static void setUpMessageHandlers({
  ...
  }) {
    {
      final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<
              Object?>(
          'dev.flutter.pigeon.webview_flutter_android.PigeonInstanceManagerApi.removeStrongReference',
          pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (pigeon_clearHandlers) {
        ...
        __pigeon_channel.setMessageHandler((Object? message) async {
          assert(message != null,
              'Argument for dev.flutter.pigeon.webview_flutter_android.PigeonInstanceManagerApi.removeStrongReference was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_identifier = (args[0] as int?);
          assert(arg_identifier != null,
              'Argument for dev.flutter.pigeon.webview_flutter_android.PigeonInstanceManagerApi.removeStrongReference was null, expected non-null int.');
          try {
  ...
  Future<void> clear() async {
    const String __pigeon_channelName =
        'dev.flutter.pigeon.webview_flutter_android.PigeonInstanceManagerApi.clear';
    final BasicMessageChannel<Object?> __pigeon_channel =
        BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
...
class WebResourceRequest extends PigeonProxyApiBaseClass {
...
class WebResourceError extends PigeonProxyApiBaseClass {
...
class WebViewPoint extends PigeonProxyApiBaseClass {
...
class ConsoleMessage extends PigeonProxyApiBaseClass {
...
class CookieManager extends PigeonProxyApiBaseClass {
  ...
  late final _PigeonProxyApiBaseCodec __pigeon_codecCookieManager =
...
class WebView extends View {
  WebView({
    ...
    final _PigeonProxyApiBaseCodec pigeonChannelCodec = __pigeon_codecWebView;
    final BinaryMessenger? __pigeon_binaryMessenger = pigeon_binaryMessenger;
    () async {
      const String __pigeon_channelName =
  ...
  Future<void> setWebViewClient(WebViewClient? client) async {
    ...
    final List<Object?>? __pigeon_replyList =
        await __pigeon_channel.send(<Object?>[this, client]) as List<Object?>?;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
      throw PlatformException(
  ...
  Future<void> addJavaScriptChannel(JavaScriptChannel channel) async {
    ...
    final List<Object?>? __pigeon_replyList =
        await __pigeon_channel.send(<Object?>[this, channel]) as List<Object?>?;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
      throw PlatformException(
  ...
  Future<void> removeJavaScriptChannel(String name) async {
    ...
    final List<Object?>? __pigeon_replyList =
        await __pigeon_channel.send(<Object?>[this, name]) as List<Object?>?;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
      throw PlatformException(
  ...
  Future<void> setBackgroundColor(int color) async {
    ...
    final List<Object?>? __pigeon_replyList =
        await __pigeon_channel.send(<Object?>[this, color]) as List<Object?>?;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
      throw PlatformException(
...
class WebSettings extends PigeonProxyApiBaseClass {
  ...
  late final _PigeonProxyApiBaseCodec __pigeon_codecWebSettings =
      _PigeonProxyApiBaseCodec(pigeon_instanceManager);
  ...
  Future<void> setDomStorageEnabled(bool flag) async {
    ...
    final List<Object?>? __pigeon_replyList =
        await __pigeon_channel.send(<Object?>[this, flag]) as List<Object?>?;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
      throw PlatformException(
  ...
  Future<void> setSupportMultipleWindows(bool support) async {
    ...
    final List<Object?>? __pigeon_replyList =
        await __pigeon_channel.send(<Object?>[this, support]) as List<Object?>?;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
      throw PlatformException(
  ...
  Future<void> setMediaPlaybackRequiresUserGesture(bool require) async {
    ...
    final List<Object?>? __pigeon_replyList =
        await __pigeon_channel.send(<Object?>[this, require]) as List<Object?>?;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
      throw PlatformException(
  ...
  Future<void> setUseWideViewPort(bool use) async {
    ...
    final List<Object?>? __pigeon_replyList =
        await __pigeon_channel.send(<Object?>[this, use]) as List<Object?>?;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
      throw PlatformException(
  ...
  Future<void> setDisplayZoomControls(bool enabled) async {
    ...
    final List<Object?>? __pigeon_replyList =
        await __pigeon_channel.send(<Object?>[this, enabled]) as List<Object?>?;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
      throw PlatformException(
...
class JavaScriptChannel extends PigeonProxyApiBaseClass {
  JavaScriptChannel({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
    ...
    () async {
      ...
      final List<Object?>? __pigeon_replyList = await __pigeon_channel
              .send(<Object?>[__pigeon_instanceIdentifier, channelName])
          as List<Object?>?;
      if (__pigeon_replyList == null) {
        throw _createConnectionError(__pigeon_channelName);
      } else if (__pigeon_replyList.length > 1) {
  ...
  late final _PigeonProxyApiBaseCodec __pigeon_codecJavaScriptChannel =
      _PigeonProxyApiBaseCodec(pigeon_instanceManager);
...
class WebViewClient extends PigeonProxyApiBaseClass {
  WebViewClient({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
    this.onPageStarted,
  ...
  late final _PigeonProxyApiBaseCodec __pigeon_codecWebViewClient =
      _PigeonProxyApiBaseCodec(pigeon_instanceManager);
...
class DownloadListener extends PigeonProxyApiBaseClass {
  DownloadListener({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
  ...
  late final _PigeonProxyApiBaseCodec __pigeon_codecDownloadListener =
      _PigeonProxyApiBaseCodec(pigeon_instanceManager);
...
class WebChromeClient extends PigeonProxyApiBaseClass {
  WebChromeClient({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
...
class FlutterAssetManager extends PigeonProxyApiBaseClass {
  ...
  late final _PigeonProxyApiBaseCodec __pigeon_codecFlutterAssetManager =
      _PigeonProxyApiBaseCodec(pigeon_instanceManager);
  ...
  Future<List<String?>> list(String path) async {
    ...
    final List<Object?>? __pigeon_replyList =
        await __pigeon_channel.send(<Object?>[this, path]) as List<Object?>?;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
      throw PlatformException(
...
class WebStorage extends PigeonProxyApiBaseClass {
  ...
  late final _PigeonProxyApiBaseCodec __pigeon_codecWebStorage =
      _PigeonProxyApiBaseCodec(pigeon_instanceManager);
...
///
/// See https://developer.android.com/reference/android/webkit/WebChromeClient.FileChooserParams.
class FileChooserParams extends PigeonProxyApiBaseClass {
...
class PermissionRequest extends PigeonProxyApiBaseClass {
  ...
  late final _PigeonProxyApiBaseCodec __pigeon_codecPermissionRequest =
      _PigeonProxyApiBaseCodec(pigeon_instanceManager);
...
class CustomViewCallback extends PigeonProxyApiBaseClass {
  ...
  late final _PigeonProxyApiBaseCodec __pigeon_codecCustomViewCallback =
      _PigeonProxyApiBaseCodec(pigeon_instanceManager);
...
class View extends PigeonProxyApiBaseClass {
  ...
  late final _PigeonProxyApiBaseCodec __pigeon_codecView =
      _PigeonProxyApiBaseCodec(pigeon_instanceManager);
  ...
  Future<void> scrollTo(
    ...
    final _PigeonProxyApiBaseCodec pigeonChannelCodec = __pigeon_codecView;
    final BinaryMessenger? __pigeon_binaryMessenger = pigeon_binaryMessenger;
    const String __pigeon_channelName =
    ...
    final List<Object?>? __pigeon_replyList =
        await __pigeon_channel.send(<Object?>[this, x, y]) as List<Object?>?;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
      throw PlatformException(
...
class GeolocationPermissionsCallback extends PigeonProxyApiBaseClass {
...
class HttpAuthHandler extends PigeonProxyApiBaseClass {
  ...
  late final _PigeonProxyApiBaseCodec __pigeon_codecHttpAuthHandler =
      _PigeonProxyApiBaseCodec(pigeon_instanceManager);
