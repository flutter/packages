...
abstract class WebChromeClientFlutterApi {
  ...
  Future<GeoPermissionsHandleResult> onGeolocationPermissionsShowPrompt(int instanceId, String origin);
    ...
    }
    {
      ...
      if (api == null) {
        ...
        channel.setMessageHandler((Object? message) async {
          ...
          final GeoPermissionsHandleResult output = await api.onGeolocationPermissionsShowPrompt(arg_instanceId!, arg_origin!);
          return output;
        });
      }
    }
