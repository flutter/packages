...
abstract class WebViewClientFlutterApi {
  ...
  void onRenderProcessGone(int instanceId, int webViewInstanceId, bool didCrash,
      ...
      if (api == null) {
        ...
        channel.setMessageHandler((Object? message) async {
          ...
          assert(arg_rendererPriorityAtExit != null,
              'Argument for dev.flutter.pigeon.WebViewClientFlutterApi.onRenderProcessGone was null, expected non-null int.');
          api.onRenderProcessGone(arg_instanceId!, arg_webViewInstanceId!,
              arg_didCrash!, arg_rendererPriorityAtExit!);
          return;
        });
      }
    }
