...
abstract class WebViewClientFlutterApi {
  ...
  void onRenderProcessGone(int instanceId, int webViewInstanceId,
    ...
    }
    {
      ...
      if (api == null) {
        ...
        channel.setMessageHandler((Object? message) async {
          ...
          assert(arg_webViewInstanceId != null,
              'Argument for dev.flutter.pigeon.WebViewClientFlutterApi.onRenderProcessGone was null, expected non-null int.');
          final RenderProcessGoneDetailData? arg_detail =
              (args[2] as RenderProcessGoneDetailData?);
          ...
          api.onRenderProcessGone(
              arg_instanceId!, arg_webViewInstanceId!, arg_detail!);
          return;
        });
      }
    }
