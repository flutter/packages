...
class CookieManagerHostApi {
  ...
  Future<void> attachInstance(int arg_instanceIdentifier) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        ...
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList = await channel.send(<Object?>[arg_instanceIdentifier]) as List<Object?>?;
    if (replyList == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
...
class WebViewClientHostApi {
  ...
  Future<void> setAuthCredentials(int arg_instanceId, String arg_host,
      String arg_realm, String arg_username, String arg_password) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
      ...
      if (api == null) {
        ...
        channel.setMessageHandler((Object? message) async {
          ...
          api.onReceivedHttpAuthRequest(
              arg_instanceId!, arg_webViewInstanceId!, arg_host!, arg_realm!);
          return;
        });
      }
    }
