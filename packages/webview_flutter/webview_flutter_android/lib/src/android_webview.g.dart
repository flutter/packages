      ...
      if (api == null) {
        ...
        channel.setMessageHandler((Object? message) async {
          ...
          assert(arg_request != null,
              'Argument for dev.flutter.pigeon.WebViewClientFlutterApi.onReceivedHttpError was null, expected non-null WebResourceRequestData.');
          final WebResourceResponseData? arg_response =
              (args[3] as WebResourceResponseData?);
          assert(arg_response != null,
              'Argument for dev.flutter.pigeon.WebViewClientFlutterApi.onReceivedHttpError was null, expected non-null WebResourceResponseData.');
