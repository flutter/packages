...
class WebViewClientHostApi {
  ...
  Future<void> setSynchronousReturnValueForOnRenderProcessGone(int arg_instanceId, bool arg_value) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.WebViewClientHostApi.setSynchronousReturnValueForOnRenderProcessGone', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_instanceId, arg_value]) as List<Object?>?;
    if (replyList == null) {
...
abstract class WebViewClientFlutterApi {
  ...
  void onRenderProcessGone(int instanceId, int webViewInstanceId, RenderProcessGoneDetailData detail);
  ...
  static void setup(WebViewClientFlutterApi? api, {BinaryMessenger? binaryMessenger}) {
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.WebViewClientFlutterApi.onRenderProcessGone', codec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        channel.setMessageHandler(null);
      } else {
        channel.setMessageHandler((Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.WebViewClientFlutterApi.onRenderProcessGone was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_instanceId = (args[0] as int?);
          assert(arg_instanceId != null,
              'Argument for dev.flutter.pigeon.WebViewClientFlutterApi.onRenderProcessGone was null, expected non-null int.');
          final int? arg_webViewInstanceId = (args[1] as int?);
          assert(arg_webViewInstanceId != null,
              'Argument for dev.flutter.pigeon.WebViewClientFlutterApi.onRenderProcessGone was null, expected non-null int.');
          final RenderProcessGoneDetailData? arg_detail = (args[2] as RenderProcessGoneDetailData?);
          assert(arg_detail != null,
              'Argument for dev.flutter.pigeon.WebViewClientFlutterApi.onRenderProcessGone was null, expected non-null RenderProcessGoneDetailData.');
          api.onRenderProcessGone(arg_instanceId!, arg_webViewInstanceId!, arg_detail!);
          return;
        });
      }
    }
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.WebViewClientFlutterApi.doUpdateVisitedHistory', codec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        channel.setMessageHandler(null);
      } else {
