...
- (void)didReceiveAuthenticationChallengeForDelegateWithIdentifier:(NSNumber *)identifier webViewIdentifier:(NSNumber *)webViewIdentifier challengeIdentifier:(NSNumber *)challengeIdentifier completion:(void (^)(FWFAuthenticationChallengeResponse *_Nullable, FlutterError *_Nullable))completion;
@end
...
- (void)setCustomUserAgentForWebViewWithIdentifier:(NSNumber *)identifier userAgent:(nullable NSString *)userAgent error:(FlutterError *_Nullable *_Nonnull)error;
...
- (nullable NSString *)customUserAgentForWebViewWithIdentifier:(NSNumber *)identifier error:(FlutterError *_Nullable *_Nonnull)error;
@end
...
- (void)createWithUserWithIdentifier:(NSNumber *)identifier user:(NSString *)user password:(NSString *)password persistence:(FWFNSUrlCredentialPersistence)persistence error:(FlutterError *_Nullable *_Nonnull)error;
@end

extern void FWFNSUrlCredentialHostApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FWFNSUrlCredentialHostApi> *_Nullable api);
...
- (void)createWithIdentifier:(NSNumber *)identifier host:(nullable NSString *)host realm:(nullable NSString *)realm authenticationMethod:(nullable NSString *)authenticationMethod completion:(void (^)(FlutterError *_Nullable))completion;
@end
...
- (instancetype)initWithBinaryMessenger:(id<FlutterBinaryMessenger>)binaryMessenger;
/// Create a new Dart instance and add it to the `InstanceManager`.
- (void)createWithIdentifier:(NSNumber *)identifier protectionSpaceIdentifier:(NSNumber *)protectionSpaceIdentifier completion:(void (^)(FlutterError *_Nullable))completion;
@end
