...
- (void)setContentOffsetForScrollViewWithIdentifier:(NSNumber *)identifier
                                                toX:(NSNumber *)x
                                                  y:(NSNumber *)y
                                              error:(FlutterError *_Nullable *_Nonnull)error;
- (void)setDelegateForScrollViewWithIdentifier:(NSNumber *)identifier
...
extern void FWFUIScrollViewDelegateHostApiSetup(
    id<FlutterBinaryMessenger> binaryMessenger,
...
///
/// See https://developer.apple.com/documentation/uikit/uiscrollviewdelegate?language=objc.
@interface FWFScrollViewDelegateFlutterApi : NSObject
- (instancetype)initWithBinaryMessenger:(id<FlutterBinaryMessenger>)binaryMessenger;
- (void)scrollViewDidScrollWithIdentifier:(NSNumber *)identifier
                   uiScrollViewIdentifier:(NSNumber *)uiScrollViewIdentifier
                               completion:(void (^)(FlutterError *_Nullable))completion;
@end
