...
+ (instancetype)makeWithCode:(NSNumber *)code
        ...
        localizedDescription:(NSString *)localizedDescription
           objectDescription:(NSString *)objectDescription {
  ...
  pigeonResult.objectDescription = objectDescription;
  return pigeonResult;
}
+ (FWFNSErrorData *)fromList:(NSArray *)list {
  FWFNSErrorData *pigeonResult = [[FWFNSErrorData alloc] init];
  ...
  pigeonResult.objectDescription = GetNullableObjectAtIndex(list, 3);
  NSAssert(pigeonResult.objectDescription != nil, @"");
  return pigeonResult;
}
+ (nullable FWFNSErrorData *)nullableFromList:(NSArray *)list {
...
- (NSArray *)toList {
  return @[
    ...
    (self.objectDescription ?: [NSNull null]),
  ];
}
@end
