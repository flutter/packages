...
void FWFUIScrollViewHostApiSetup(id<FlutterBinaryMessenger> binaryMessenger,
  ...
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:@"dev.flutter.pigeon.UIScrollViewHostApi.setDelegate"
        binaryMessenger:binaryMessenger
                  codec:FWFUIScrollViewHostApiGetCodec()];
    if (api) {
...
void FWFUIScrollViewDelegateHostApiSetup(id<FlutterBinaryMessenger> binaryMessenger,
  ...
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:@"dev.flutter.pigeon.UIScrollViewDelegateHostApi.create"
        binaryMessenger:binaryMessenger
...
@interface FWFScrollViewDelegateFlutterApi ()
@property(nonatomic, strong) NSObject<FlutterBinaryMessenger> *binaryMessenger;
@end

@implementation FWFScrollViewDelegateFlutterApi
