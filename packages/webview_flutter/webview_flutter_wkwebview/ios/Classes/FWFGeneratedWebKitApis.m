...
- (void)didReceiveAuthenticationChallengeForDelegateWithIdentifier:(NSNumber *)arg_identifier webViewIdentifier:(NSNumber *)arg_webViewIdentifier challengeIdentifier:(NSNumber *)arg_challengeIdentifier completion:(void (^)(FWFAuthenticationChallengeResponse *_Nullable, FlutterError *_Nullable))completion {
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
      ...
      binaryMessenger:self.binaryMessenger
      codec:FWFWKNavigationDelegateFlutterApiGetCodec()];
  [channel sendMessage:@[arg_identifier ?: [NSNull null], arg_webViewIdentifier ?: [NSNull null], arg_challengeIdentifier ?: [NSNull null]] reply:^(id reply) {
    FWFAuthenticationChallengeResponse *output = reply;
    completion(output, nil);
  }];
}
@end
...
void FWFNSUrlCredentialHostApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FWFNSUrlCredentialHostApi> *api) {
...
- (void)createWithIdentifier:(NSNumber *)arg_identifier host:(nullable NSString *)arg_host realm:(nullable NSString *)arg_realm authenticationMethod:(nullable NSString *)arg_authenticationMethod completion:(void (^)(FlutterError *_Nullable))completion {
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
  ...
  [channel sendMessage:@[arg_identifier ?: [NSNull null], arg_host ?: [NSNull null], arg_realm ?: [NSNull null], arg_authenticationMethod ?: [NSNull null]] reply:^(id reply) {
    completion(nil);
  }];
}
@end
...
- (void)createWithIdentifier:(NSNumber *)arg_identifier protectionSpaceIdentifier:(NSNumber *)arg_protectionSpaceIdentifier completion:(void (^)(FlutterError *_Nullable))completion {
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
  ...
  [channel sendMessage:@[arg_identifier ?: [NSNull null], arg_protectionSpaceIdentifier ?: [NSNull null]] reply:^(id reply) {
    completion(nil);
  }];
}
@end
