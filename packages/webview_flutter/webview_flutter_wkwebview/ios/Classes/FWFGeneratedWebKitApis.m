...
+ (nullable FWFObjectOrIdentifier *)nullableFromList:(NSArray *)list { return (list) ? [FWFObjectOrIdentifier fromList:list] : nil; }
- (NSArray *)toList {
  return @[
...
- (void)writeValue:(id)value 
{
  ...
  if ([value isKindOfClass:[FWFObjectOrIdentifier class]]) {
    [self writeByte:129];
    [self writeValue:[value toList]];
  } else 
{
