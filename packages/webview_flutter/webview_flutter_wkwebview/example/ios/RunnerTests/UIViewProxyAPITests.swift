...
class UIViewProxyAPITests: XCTestCase {
  @MainActor func testSetBackgroundColor() {
    ...
    let value = 0xFFF44336
    try? api.pigeonDelegate.setBackgroundColor(pigeonApi: api, pigeonInstance: instance, value: Int64(value))
    ...
    XCTAssertEqual(instance.backgroundColor, UIColor(red: red, green: green, blue: blue, alpha: alpha))
  }
