...
class ScrollViewProxyAPITests: XCTestCase {
  ...
  @MainActor func testSetShowsVerticalScrollIndicator() {
    ...
    let instance = TestScrollView()
    let value = true
    try? api.pigeonDelegate.setShowsVerticalScrollIndicator(pigeonApi: api, pigeonInstance: instance, value: value)
  ...
  @MainActor func testSetShowsHorizontalScrollIndicator() {
    ...
    let instance = TestScrollView()
    let value = true
    try? api.pigeonDelegate.setShowsHorizontalScrollIndicator(pigeonApi: api, pigeonInstance: instance, value: value)
