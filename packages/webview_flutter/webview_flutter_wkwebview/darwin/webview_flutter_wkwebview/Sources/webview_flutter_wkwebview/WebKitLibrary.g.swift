...
internal final class WebKitLibraryPigeonInternalFinalizer {
  ...
  static func detach(from instance: AnyObject) {
    let finalizer = objc_getAssociatedObject(instance, associatedObjectKey) as? WebKitLibraryPigeonInternalFinalizer
...
open class WebKitLibraryPigeonProxyApiRegistrar {
  ...
  func setUp() {
    ...
    PigeonApiUIColor.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiUIColor(self))
  }
  func tearDown() {
...
protocol PigeonApiDelegateUIView {
  ...
  func setBackgroundColor(pigeonApi: PigeonApiUIView, pigeonInstance: UIView, value: UIColor?) throws
  #endif
  #if !os(macOS)
...
final class PigeonApiUIScrollView: PigeonApiProtocolUIScrollView  {
  ...
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiUIScrollView?) {
    ...
    #endif
    #if !os(macOS)
    let setShowsVerticalScrollIndicatorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.webview_flutter_wkwebview.UIScrollView.setShowsVerticalScrollIndicator", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setShowsVerticalScrollIndicatorChannel.setMessageHandler { message, reply in
        ...
        let valueArg = args[1] as! Bool
        do {
          try api.pigeonDelegate.setShowsVerticalScrollIndicator(pigeonApi: api, pigeonInstance: pigeonInstanceArg, value: valueArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
    ...
    #endif
    #if !os(macOS)
    let setShowsHorizontalScrollIndicatorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.webview_flutter_wkwebview.UIScrollView.setShowsHorizontalScrollIndicator", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setShowsHorizontalScrollIndicatorChannel.setMessageHandler { message, reply in
        ...
        let valueArg = args[1] as! Bool
        do {
          try api.pigeonDelegate.setShowsHorizontalScrollIndicator(pigeonApi: api, pigeonInstance: pigeonInstanceArg, value: valueArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
...
protocol PigeonApiDelegateWKPreferences {
  ...
  func setJavaScriptCanOpenWindowsAutomatically(pigeonApi: PigeonApiWKPreferences, pigeonInstance: WKPreferences, enabled: Bool) throws
}
...
final class PigeonApiWKPreferences: PigeonApiProtocolWKPreferences  {
  ...
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiWKPreferences?) {
    ...
    let setJavaScriptCanOpenWindowsAutomaticallyChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.webview_flutter_wkwebview.WKPreferences.setJavaScriptCanOpenWindowsAutomatically", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setJavaScriptCanOpenWindowsAutomaticallyChannel.setMessageHandler { message, reply in
        ...
        let enabledArg = args[1] as! Bool
        do {
          try api.pigeonDelegate.setJavaScriptCanOpenWindowsAutomatically(pigeonApi: api, pigeonInstance: pigeonInstanceArg, enabled: enabledArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      completion(
        .failure(
          PigeonError(
            ...
            message: "Callback to `WKScriptMessageHandler.didReceiveScriptMessage` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message: "Callback to `WKNavigationDelegate.didFinishNavigation` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message: "Callback to `WKNavigationDelegate.didStartProvisionalNavigation` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message: "Callback to `WKNavigationDelegate.decidePolicyForNavigationAction` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message: "Callback to `WKNavigationDelegate.decidePolicyForNavigationResponse` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message: "Callback to `WKNavigationDelegate.didFailNavigation` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message: "Callback to `WKNavigationDelegate.didFailProvisionalNavigation` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message: "Callback to `WKNavigationDelegate.webViewWebContentProcessDidTerminate` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message: "Callback to `WKNavigationDelegate.didReceiveAuthenticationChallenge` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message: "Callback to `NSObject.observeValue` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message: "Callback to `WKUIDelegate.onCreateWebView` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message: "Callback to `WKUIDelegate.requestMediaCapturePermission` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message: "Callback to `WKUIDelegate.runJavaScriptAlertPanel` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message: "Callback to `WKUIDelegate.runJavaScriptConfirmPanel` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message: "Callback to `WKUIDelegate.runJavaScriptTextInputPanel` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
...
protocol PigeonApiDelegateWKHTTPCookieStore {
  ...
  func getAllCookies(pigeonApi: PigeonApiWKHTTPCookieStore, pigeonInstance: WKHTTPCookieStore, completion: @escaping (Result<[HTTPCookie], Error>) -> Void)
}
...
final class PigeonApiWKHTTPCookieStore: PigeonApiProtocolWKHTTPCookieStore  {
  ...
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiWKHTTPCookieStore?) {
    ...
    let getAllCookiesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.webview_flutter_wkwebview.WKHTTPCookieStore.getAllCookies", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getAllCookiesChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! WKHTTPCookieStore
        api.pigeonDelegate.getAllCookies(pigeonApi: api, pigeonInstance: pigeonInstanceArg) { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
    ...
    if pigeonRegistrar.ignoreCallsToDart {
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message: "Callback to `UIScrollViewDelegate.scrollViewDidScroll` failed because native instance was not in the instance manager.", details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
...
final class PigeonApiUIColor: PigeonApiProtocolUIColor  {
  ...
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiUIColor?) {
    let codec: FlutterStandardMessageCodec =
      ...
      : FlutterStandardMessageCodec.sharedInstance()
    #if !os(macOS)
    let pigeonDefaultConstructorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.webview_flutter_wkwebview.UIColor.pigeon_defaultConstructor", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      pigeonDefaultConstructorChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonIdentifierArg = args[0] as! Int64
        ...
        do {
          api.pigeonRegistrar.instanceManager.addDartCreatedInstance(
try api.pigeonDelegate.pigeonDefaultConstructor(pigeonApi: api, red: redArg, green: greenArg, blue: blueArg, alpha: alphaArg),
withIdentifier: pigeonIdentifierArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
  ...
  func pigeonNewInstance(pigeonInstance: UIColor, completion: @escaping (Result<Void, PigeonError>) -> Void) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
          PigeonError(
      ...
      let binaryMessenger = pigeonRegistrar.binaryMessenger
      let codec = pigeonRegistrar.codec
      let channelName: String = "dev.flutter.pigeon.webview_flutter_wkwebview.UIColor.pigeon_newInstance"
      let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
      channel.sendMessage([pigeonIdentifierArg] as [Any?]) { response in
        guard let listResponse = response as? [Any?] else {
          completion(.failure(createConnectionError(withChannelName: channelName)))
