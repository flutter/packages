...
protocol WebKitLibraryPigeonProxyApiDelegate {
  ...
  /// An implementation of [PigeonApiWKURLSchemeHandler] used to add a new Dart instance of
  /// `WKURLSchemeHandler` to the Dart `InstanceManager` and make calls to Dart.
  func pigeonApiWKURLSchemeHandler(_ registrar: WebKitLibraryPigeonProxyApiRegistrar)
    -> PigeonApiWKURLSchemeHandler
  /// An implementation of [PigeonApiWKURLSchemeTask] used to add a new Dart instance of
  /// `WKURLSchemeTask` to the Dart `InstanceManager` and make calls to Dart.
...
open class WebKitLibraryPigeonProxyApiRegistrar {
  ...
  func setUp() {
    ...
    PigeonApiHTTPURLResponse.setUpMessageHandlers(
      binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiHTTPURLResponse(self))
    PigeonApiURLResponse.setUpMessageHandlers(
      binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiURLResponse(self))
    PigeonApiWKUserScript.setUpMessageHandlers(
      binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiWKUserScript(self))
    PigeonApiNSError.setUpMessageHandlers(
      binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiNSError(self))
    ...
    PigeonApiWKURLSchemeHandler.setUpMessageHandlers(
      binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiWKURLSchemeHandler(self))
    PigeonApiWKURLSchemeTask.setUpMessageHandlers(
      binaryMessenger: binaryMessenger, api: apiDelegate.pigeonApiWKURLSchemeTask(self))
  ...
  func tearDown() {
    ...
    PigeonApiHTTPURLResponse.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiURLResponse.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiWKUserScript.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiNSError.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    ...
    PigeonApiWKURLSchemeHandler.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
    PigeonApiWKURLSchemeTask.setUpMessageHandlers(binaryMessenger: binaryMessenger, api: nil)
...
private class WebKitLibraryPigeonInternalProxyApiCodecReaderWriter: FlutterStandardReaderWriter {
  ...
  private class WebKitLibraryPigeonInternalProxyApiCodecWriter: WebKitLibraryPigeonCodecWriter {
    ...
    override func writeValue(_ value: Any) {
      ...
      if let instance = value as? WKURLSchemeHandler {
        pigeonRegistrar.apiDelegate.pigeonApiWKURLSchemeHandler(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
      ...
      if let instance = value as? WKURLSchemeTask {
        pigeonRegistrar.apiDelegate.pigeonApiWKURLSchemeTask(pigeonRegistrar).pigeonNewInstance(
          pigeonInstance: instance
        ) { _ in }
        super.writeByte(128)
        super.writeValue(
...
final class PigeonApiHTTPURLResponse: PigeonApiProtocolHTTPURLResponse {
  ...
  static func setUpMessageHandlers(
    binaryMessenger: FlutterBinaryMessenger, api: PigeonApiHTTPURLResponse?
  ) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
    ...
    let pigeonDefaultConstructorChannel = FlutterBasicMessageChannel(
      name:
        "dev.flutter.pigeon.webview_flutter_wkwebview.HTTPURLResponse.pigeon_defaultConstructor",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      pigeonDefaultConstructorChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonIdentifierArg = args[0] as! Int64
        let statusCodeArg = args[1] as! Int64
        let urlArg = args[2] as! String
        let httpVersionArg: String? = nilOrValue(args[3])
        let headerFieldsArg: [String: String]? = nilOrValue(args[4])
        do {
          api.pigeonRegistrar.instanceManager.addDartCreatedInstance(
            try api.pigeonDelegate.pigeonDefaultConstructor(
              pigeonApi: api, statusCode: statusCodeArg, url: urlArg, httpVersion: httpVersionArg,
              headerFields: headerFieldsArg),
            withIdentifier: pigeonIdentifierArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
...
protocol PigeonApiDelegateURLResponse {
...
final class PigeonApiURLResponse: PigeonApiProtocolURLResponse {
  ...
  static func setUpMessageHandlers(
    binaryMessenger: FlutterBinaryMessenger, api: PigeonApiURLResponse?
  ) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
      ...
      : FlutterStandardMessageCodec.sharedInstance()
    let pigeonDefaultConstructorChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.webview_flutter_wkwebview.URLResponse.pigeon_defaultConstructor",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      pigeonDefaultConstructorChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonIdentifierArg = args[0] as! Int64
        let urlArg = args[1] as! String
        let mimeTypeArg: String? = nilOrValue(args[2])
        let expectedContentLengthArg = args[3] as! Int64
        let textEncodingNameArg: String? = nilOrValue(args[4])
        do {
          api.pigeonRegistrar.instanceManager.addDartCreatedInstance(
            try api.pigeonDelegate.pigeonDefaultConstructor(
              pigeonApi: api, url: urlArg, mimeType: mimeTypeArg,
              expectedContentLength: expectedContentLengthArg, textEncodingName: textEncodingNameArg
            ),
            withIdentifier: pigeonIdentifierArg)
          reply(wrapResult(nil))
        } catch {
...
final class PigeonApiNSError: PigeonApiProtocolNSError {
  ...
  static func setUpMessageHandlers(binaryMessenger: FlutterBinaryMessenger, api: PigeonApiNSError?)
  {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
      ...
      : FlutterStandardMessageCodec.sharedInstance()
    let pigeonDefaultConstructorChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.webview_flutter_wkwebview.NSError.pigeon_defaultConstructor",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      pigeonDefaultConstructorChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonIdentifierArg = args[0] as! Int64
        let codeArg = args[1] as! Int64
        let domainArg = args[2] as! String
        let userInfoArg = args[3] as! [String: Any?]
        do {
          api.pigeonRegistrar.instanceManager.addDartCreatedInstance(
            try api.pigeonDelegate.pigeonDefaultConstructor(
              pigeonApi: api, code: codeArg, domain: domainArg, userInfo: userInfoArg),
            withIdentifier: pigeonIdentifierArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
...
protocol PigeonApiDelegateWKWebViewConfiguration {
  ...
  func setURLSchemeHandler(
    pigeonApi: PigeonApiWKWebViewConfiguration, pigeonInstance: WKWebViewConfiguration,
    handler: WKURLSchemeHandler?, urlScheme: String) throws
}
...
final class PigeonApiWKWebViewConfiguration: PigeonApiProtocolWKWebViewConfiguration {
  ...
  static func setUpMessageHandlers(
    ...
    let setURLSchemeHandlerChannel = FlutterBasicMessageChannel(
      name:
        "dev.flutter.pigeon.webview_flutter_wkwebview.WKWebViewConfiguration.setURLSchemeHandler",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setURLSchemeHandlerChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! WKWebViewConfiguration
        let handlerArg: WKURLSchemeHandler? = nilOrValue(args[1])
        let urlSchemeArg = args[2] as! String
        do {
          try api.pigeonDelegate.setURLSchemeHandler(
            pigeonApi: api, pigeonInstance: pigeonInstanceArg, handler: handlerArg,
            urlScheme: urlSchemeArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      setURLSchemeHandlerChannel.setMessageHandler(nil)
    }
  }
...
protocol PigeonApiDelegateWKURLSchemeHandler {
  func pigeonDefaultConstructor(pigeonApi: PigeonApiWKURLSchemeHandler) throws -> WKURLSchemeHandler
}

protocol PigeonApiProtocolWKURLSchemeHandler {
...
final class PigeonApiWKURLSchemeHandler: PigeonApiProtocolWKURLSchemeHandler {
  unowned let pigeonRegistrar: WebKitLibraryPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateWKURLSchemeHandler
  ///An implementation of [NSObject] used to access callback methods
  var pigeonApiNSObject: PigeonApiNSObject {
    return pigeonRegistrar.apiDelegate.pigeonApiNSObject(pigeonRegistrar)
  }
  ...
  init(
    pigeonRegistrar: WebKitLibraryPigeonProxyApiRegistrar,
    delegate: PigeonApiDelegateWKURLSchemeHandler
  ) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  static func setUpMessageHandlers(
    binaryMessenger: FlutterBinaryMessenger, api: PigeonApiWKURLSchemeHandler?
  ) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
    ...
    let pigeonDefaultConstructorChannel = FlutterBasicMessageChannel(
      name:
        "dev.flutter.pigeon.webview_flutter_wkwebview.WKURLSchemeHandler.pigeon_defaultConstructor",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      pigeonDefaultConstructorChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
  ...
  ///Creates a Dart instance of WKURLSchemeHandler and attaches it to [pigeonInstance].
  func pigeonNewInstance(
    pigeonInstance: WKURLSchemeHandler, completion: @escaping (Result<Void, PigeonError>) -> Void
  ) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
      ...
      completion(
        .failure(
          PigeonError(
            code: "new-instance-error",
            message:
              "Error: Attempting to create a new Dart instance of WKURLSchemeHandler, but the class has a nonnull callback method.",
            details: "")))
    }
  }
  /// Asks the handler to begin loading the data for the specified resource.
  func startUrlSchemeTask(
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message:
              "Callback to `WKURLSchemeHandler.startUrlSchemeTask` failed because native instance was not in the instance manager.",
            details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
    let channelName: String =
      "dev.flutter.pigeon.webview_flutter_wkwebview.WKURLSchemeHandler.startUrlSchemeTask"
    let channel = FlutterBasicMessageChannel(
      name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([pigeonInstanceArg, webViewArg, urlSchemeTaskArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName: channelName)))
        return
      }
  ...
  func stopUrlSchemeTask(
      ...
      completion(
        .failure(
          PigeonError(
            code: "missing-instance-error",
            message:
              "Callback to `WKURLSchemeHandler.stopUrlSchemeTask` failed because native instance was not in the instance manager.",
            details: "")))
      return
    }
    let binaryMessenger = pigeonRegistrar.binaryMessenger
    let codec = pigeonRegistrar.codec
    let channelName: String =
      "dev.flutter.pigeon.webview_flutter_wkwebview.WKURLSchemeHandler.stopUrlSchemeTask"
    let channel = FlutterBasicMessageChannel(
      name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage([pigeonInstanceArg, webViewArg, urlSchemeTaskArg] as [Any?]) { response in
      guard let listResponse = response as? [Any?] else {
...
protocol PigeonApiDelegateWKURLSchemeTask {
  ...
  func didReceiveData(
    ...
    data: FlutterStandardTypedData) throws
  ...
  func didFailWithError(
    pigeonApi: PigeonApiWKURLSchemeTask, pigeonInstance: WKURLSchemeTask, error: NSError) throws
}

protocol PigeonApiProtocolWKURLSchemeTask {
}

final class PigeonApiWKURLSchemeTask: PigeonApiProtocolWKURLSchemeTask {
  unowned let pigeonRegistrar: WebKitLibraryPigeonProxyApiRegistrar
  let pigeonDelegate: PigeonApiDelegateWKURLSchemeTask
  ///An implementation of [NSObject] used to access callback methods
  var pigeonApiNSObject: PigeonApiNSObject {
    return pigeonRegistrar.apiDelegate.pigeonApiNSObject(pigeonRegistrar)
  }
  ...
  init(
    pigeonRegistrar: WebKitLibraryPigeonProxyApiRegistrar,
    delegate: PigeonApiDelegateWKURLSchemeTask
  ) {
    self.pigeonRegistrar = pigeonRegistrar
    self.pigeonDelegate = delegate
  }
  static func setUpMessageHandlers(
    binaryMessenger: FlutterBinaryMessenger, api: PigeonApiWKURLSchemeTask?
  ) {
    let codec: FlutterStandardMessageCodec =
      api != nil
      ? FlutterStandardMessageCodec(
        readerWriter: WebKitLibraryPigeonInternalProxyApiCodecReaderWriter(
          pigeonRegistrar: api!.pigeonRegistrar))
      : FlutterStandardMessageCodec.sharedInstance()
    let didReceiveResponseChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.webview_flutter_wkwebview.WKURLSchemeTask.didReceiveResponse",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      didReceiveResponseChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! WKURLSchemeTask
        let responseArg = args[1] as! URLResponse
        do {
          try api.pigeonDelegate.didReceiveResponse(
            pigeonApi: api, pigeonInstance: pigeonInstanceArg, response: responseArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      didReceiveResponseChannel.setMessageHandler(nil)
    }
    let didReceiveDataChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.webview_flutter_wkwebview.WKURLSchemeTask.didReceiveData",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      didReceiveDataChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! WKURLSchemeTask
        let dataArg = args[1] as! FlutterStandardTypedData
        do {
          try api.pigeonDelegate.didReceiveData(
            pigeonApi: api, pigeonInstance: pigeonInstanceArg, data: dataArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      didReceiveDataChannel.setMessageHandler(nil)
    }
    let didFinishChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.webview_flutter_wkwebview.WKURLSchemeTask.didFinish",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      didFinishChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! WKURLSchemeTask
        do {
          try api.pigeonDelegate.didFinish(pigeonApi: api, pigeonInstance: pigeonInstanceArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      didFinishChannel.setMessageHandler(nil)
    }
    let didFailWithErrorChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.webview_flutter_wkwebview.WKURLSchemeTask.didFailWithError",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      didFailWithErrorChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let pigeonInstanceArg = args[0] as! WKURLSchemeTask
        let errorArg = args[1] as! NSError
        do {
          try api.pigeonDelegate.didFailWithError(
            pigeonApi: api, pigeonInstance: pigeonInstanceArg, error: errorArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      didFailWithErrorChannel.setMessageHandler(nil)
    }
  }

  ///Creates a Dart instance of WKURLSchemeTask and attaches it to [pigeonInstance].
  func pigeonNewInstance(
    pigeonInstance: WKURLSchemeTask, completion: @escaping (Result<Void, PigeonError>) -> Void
  ) {
    if pigeonRegistrar.ignoreCallsToDart {
      completion(
        .failure(
      ...
      let codec = pigeonRegistrar.codec
      let channelName: String =
        "dev.flutter.pigeon.webview_flutter_wkwebview.WKURLSchemeTask.pigeon_newInstance"
      let channel = FlutterBasicMessageChannel(
        name: channelName, binaryMessenger: binaryMessenger, codec: codec)
      channel.sendMessage([pigeonIdentifierArg, requestArg] as [Any?]) { response in
        guard let listResponse = response as? [Any?] else {
          completion(.failure(createConnectionError(withChannelName: channelName)))
          return
        }
