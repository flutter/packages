...
extern void SetUpFWFWKWebsiteDataStoreHostApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FWFWKWebsiteDataStoreHostApi> *_Nullable api, NSString *messageChannelSuffix);
...
extern void SetUpFWFUIViewHostApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FWFUIViewHostApi> *_Nullable api, NSString *messageChannelSuffix);
...
- (void)setDelegateForScrollViewWithIdentifier:(NSInteger)identifier uiScrollViewDelegateIdentifier:(nullable NSNumber *)uiScrollViewDelegateIdentifier error:(FlutterError *_Nullable *_Nonnull)error;
@end
...
extern void SetUpFWFUIScrollViewHostApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FWFUIScrollViewHostApi> *_Nullable api, NSString *messageChannelSuffix);
...
extern void SetUpFWFWKWebViewConfigurationHostApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FWFWKWebViewConfigurationHostApi> *_Nullable api, NSString *messageChannelSuffix);
...
extern void SetUpFWFWKUserContentControllerHostApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FWFWKUserContentControllerHostApi> *_Nullable api, NSString *messageChannelSuffix);
...
- (void)setJavaScriptCanOpenWindowsAutomaticallyForPreferencesWithIdentifier:(NSInteger)identifier isEnabled:(BOOL)enabled error:(FlutterError *_Nullable *_Nonnull)error;
@end
...
extern void SetUpFWFWKPreferencesHostApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FWFWKPreferencesHostApi> *_Nullable api, NSString *messageChannelSuffix);
...
extern void SetUpFWFWKScriptMessageHandlerHostApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FWFWKScriptMessageHandlerHostApi> *_Nullable api, NSString *messageChannelSuffix);
...
extern void SetUpFWFWKNavigationDelegateHostApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FWFWKNavigationDelegateHostApi> *_Nullable api, NSString *messageChannelSuffix);
...
- (void)decidePolicyForNavigationResponseForDelegateWithIdentifier:(NSInteger)identifier webViewIdentifier:(NSInteger)webViewIdentifier navigationResponse:(FWFWKNavigationResponseData *)navigationResponse completion:(void (^)(FWFWKNavigationResponsePolicyEnumBox *_Nullable, FlutterError *_Nullable))completion;
...
- (void)didReceiveAuthenticationChallengeForDelegateWithIdentifier:(NSInteger)identifier webViewIdentifier:(NSInteger)webViewIdentifier challengeIdentifier:(NSInteger)challengeIdentifier completion:(void (^)(FWFAuthenticationChallengeResponse *_Nullable, FlutterError *_Nullable))completion;
@end
...
extern void SetUpFWFNSObjectHostApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FWFNSObjectHostApi> *_Nullable api, NSString *messageChannelSuffix);
...
extern void SetUpFWFWKWebViewHostApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FWFWKWebViewHostApi> *_Nullable api, NSString *messageChannelSuffix);
...
extern void SetUpFWFWKUIDelegateHostApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FWFWKUIDelegateHostApi> *_Nullable api, NSString *messageChannelSuffix);
...
extern void SetUpFWFWKHttpCookieStoreHostApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FWFWKHttpCookieStoreHostApi> *_Nullable api, NSString *messageChannelSuffix);
...
extern void SetUpFWFNSUrlHostApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FWFNSUrlHostApi> *_Nullable api, NSString *messageChannelSuffix);
...
extern void SetUpFWFUIScrollViewDelegateHostApi(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FWFUIScrollViewDelegateHostApi> *_Nullable api);

extern void SetUpFWFUIScrollViewDelegateHostApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FWFUIScrollViewDelegateHostApi> *_Nullable api, NSString *messageChannelSuffix);
...
- (instancetype)initWithBinaryMessenger:(id<FlutterBinaryMessenger>)binaryMessenger;
- (instancetype)initWithBinaryMessenger:(id<FlutterBinaryMessenger>)binaryMessenger messageChannelSuffix:(nullable NSString *)messageChannelSuffix;
- (void)scrollViewDidScrollWithIdentifier:(NSInteger)identifier UIScrollViewIdentifier:(NSInteger)uiScrollViewIdentifier x:(double)x y:(double)y completion:(void (^)(FlutterError *_Nullable))completion;
@end
...
- (void)createWithUserWithIdentifier:(NSInteger)identifier user:(NSString *)user password:(NSString *)password persistence:(FWFNSUrlCredentialPersistence)persistence error:(FlutterError *_Nullable *_Nonnull)error;
@end

extern void SetUpFWFNSUrlCredentialHostApi(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FWFNSUrlCredentialHostApi> *_Nullable api);

extern void SetUpFWFNSUrlCredentialHostApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FWFNSUrlCredentialHostApi> *_Nullable api, NSString *messageChannelSuffix);
...
- (instancetype)initWithBinaryMessenger:(id<FlutterBinaryMessenger>)binaryMessenger messageChannelSuffix:(nullable NSString *)messageChannelSuffix;
/// Create a new Dart instance and add it to the `InstanceManager`.
- (void)createWithIdentifier:(NSInteger)identifier protectionSpaceIdentifier:(NSInteger)protectionSpaceIdentifier completion:(void (^)(FlutterError *_Nullable))completion;
@end
