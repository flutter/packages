...
- (void)
    didReceiveScriptMessageForHandlerWithIdentifier:(NSInteger)arg_identifier
                    userContentControllerIdentifier:(NSInteger)arg_userContentControllerIdentifier
                                         ...
                                         completion:(void (^)(FlutterError *_Nullable))completion {
  NSString *channelName = @"dev.flutter.pigeon.webview_flutter_wkwebview."
...
- (void)
    decidePolicyForNavigationResponseForDelegateWithIdentifier:(NSInteger)arg_identifier
                                             webViewIdentifier:(NSInteger)arg_webViewIdentifier
                                            navigationResponse:(FWFWKNavigationResponseData *)
                                                                   arg_navigationResponse
                                                    completion:
                                                        (void (^)(
                                                            FWFFWFWKNavigationResponsePolicyEnumBox
                                                                *_Nullable,
                                                            FlutterError *_Nullable))completion {
  NSString *channelName = @"dev.flutter.pigeon.webview_flutter_wkwebview."
                 ...
                 reply:^(NSArray<id> *reply) {
                   if (reply != nil) {
                     if (reply.count > 1) {
                       ...
                       FWFFWFWKNavigationResponsePolicyEnumBox *output =
                           outputAsNumber == nil ? nil
                                                 : [[FWFFWFWKNavigationResponsePolicyEnumBox alloc]
                                             ...
                                             webViewIdentifier:(NSInteger)arg_webViewIdentifier
                                                    ...
                                                    completion:
                                                        (void (^)(
                                                            ...
                                                            FlutterError *_Nullable))completion {
  NSString *channelName = @"dev.flutter.pigeon.webview_flutter_wkwebview.WKUIDelegateFlutterApi."
