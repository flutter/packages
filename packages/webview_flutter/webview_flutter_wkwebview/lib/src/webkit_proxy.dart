...
class WebKitProxy {
  ...
  final WKNavigationDelegate Function({
    void Function(WKNavigationDelegate, WKWebView, String?)?
    didFinishNavigation,
    void Function(WKNavigationDelegate, WKWebView, String?)?
    ...
    void Function(WKNavigationDelegate, WKWebView, NSError)? didFailNavigation,
    void Function(WKNavigationDelegate, WKWebView, NSError)?
    didFailProvisionalNavigation,
    void Function(WKNavigationDelegate, WKWebView)?
  ...
  final Future<URLCredential> Function(String, String, UrlCredentialPersistence)
