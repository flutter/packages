  ...
  static void setup(UIScrollViewDelegateFlutterApi? api,
      {BinaryMessenger? binaryMessenger}) {
    {
      ...
      if (api == null) {
        ...
        channel.setMessageHandler((Object? message) async {
          assert(message != null,
              'Argument for dev.flutter.pigeon.UIScrollViewDelegateFlutterApi.scrollViewDidScroll was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_identifier = (args[0] as int?);
          assert(arg_identifier != null,
              'Argument for dev.flutter.pigeon.UIScrollViewDelegateFlutterApi.scrollViewDidScroll was null, expected non-null int.');
          final int? arg_uiScrollViewIdentifier = (args[1] as int?);
          assert(arg_uiScrollViewIdentifier != null,
              'Argument for dev.flutter.pigeon.UIScrollViewDelegateFlutterApi.scrollViewDidScroll was null, expected non-null int.');
          api.scrollViewDidScroll(arg_identifier!, arg_uiScrollViewIdentifier!);
          return;
        });
      }
    }
