...
class WKPreferencesHostApi {
  ...
  Future<void> setJavaScriptCanOpenWindowsAutomatically(
      int identifier, bool enabled) async {
    final String __pigeon_channelName =
        'dev.flutter.pigeon.webview_flutter_wkwebview.WKPreferencesHostApi.setJavaScriptCanOpenWindowsAutomatically$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel =
        BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
