...
abstract class TestUIScrollViewHostApi {
  ...
  static void setup(TestUIScrollViewHostApi? api,
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.UIScrollViewHostApi.setDelegate', codec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        _testBinaryMessengerBinding!.defaultBinaryMessenger
            .setMockDecodedMessageHandler<Object?>(channel, null);
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
            .setMockDecodedMessageHandler<Object?>(channel,
                (Object? message) async {
          assert(message != null,
              'Argument for dev.flutter.pigeon.UIScrollViewHostApi.setDelegate was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_identifier = (args[0] as int?);
          assert(arg_identifier != null,
              'Argument for dev.flutter.pigeon.UIScrollViewHostApi.setDelegate was null, expected non-null int.');
          final int? arg_uiScrollViewDelegateIdentifier = (args[1] as int?);
          assert(arg_uiScrollViewDelegateIdentifier != null,
              'Argument for dev.flutter.pigeon.UIScrollViewHostApi.setDelegate was null, expected non-null int.');
...
abstract class TestUIScrollViewDelegateHostApi {
  ...
  static void setup(TestUIScrollViewDelegateHostApi? api,
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.UIScrollViewDelegateHostApi.create', codec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        _testBinaryMessengerBinding!.defaultBinaryMessenger
            .setMockDecodedMessageHandler<Object?>(channel, null);
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
            .setMockDecodedMessageHandler<Object?>(channel,
                (Object? message) async {
          assert(message != null,
              'Argument for dev.flutter.pigeon.UIScrollViewDelegateHostApi.create was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_identifier = (args[0] as int?);
          assert(arg_identifier != null,
              'Argument for dev.flutter.pigeon.UIScrollViewDelegateHostApi.create was null, expected non-null int.');
          api.create(arg_identifier!);
          return <Object?>[];
        });
      }
