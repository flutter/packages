...
class MockWebViewPlatformController extends _i1.Mock implements _i10.WebViewPlatformController {
  ...
  @override
  _i9.Future<void> loadHtmlString(String? html, {String? baseUrl}) => (super.noSuchMethod(
  ...
  @override
  _i9.Future<void> loadUrl(String? url, Map<String, String>? headers) => (super.noSuchMethod(
  ...
  @override
  _i9.Future<void> loadRequest(_i5.WebViewRequest? request) => (super.noSuchMethod(
    Invocation.method(#loadRequest, [request]),
    returnValue: _i9.Future<void>.value(),
    returnValueForMissingStub: _i9.Future<void>.value(),
  ) as _i9.Future<void>);

  @override
  _i9.Future<void> updateSettings(_i5.WebSettings? setting) => (super.noSuchMethod(
    Invocation.method(#updateSettings, [setting]),
    returnValue: _i9.Future<void>.value(),
    returnValueForMissingStub: _i9.Future<void>.value(),
  ) as _i9.Future<void>);
  ...
  @override
  _i9.Future<String> evaluateJavascript(String? javascript) => (super.noSuchMethod(
  ...
  @override
  _i9.Future<String> runJavascriptReturningResult(String? javascript) => (super.noSuchMethod(
    Invocation.method(#runJavascriptReturningResult, [javascript]),
    returnValue: _i9.Future<String>.value(
      _i11.dummyValue<String>(this, Invocation.method(#runJavascriptReturningResult, [javascript])),
    ),
  ) as _i9.Future<String>);
