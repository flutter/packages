...
class SampleMenu extends StatelessWidget {
  ...
  final List<DocumentStartJavaScriptRegistration> _documentStartJavaScriptRegistrations =
      <DocumentStartJavaScriptRegistration>[];
  ...
  Future<void> _onNavigationDelegateExample() {
    ...
    return webViewController.loadRequest(Uri.parse('data:text/html;base64,$contentBase64'));
  }
  ...
  Future<void> _onSetCookie() async {
    ...
    await webViewController.loadRequest(Uri.parse('https://httpbin.org/anything'));
  }
  ...
  Future<void> _onDocumentStartJavaScriptExample(BuildContext context) async {
    ...
    for (final DocumentStartJavaScriptRegistration registration
        in _documentStartJavaScriptRegistrations) {
      await registration.remove();
    }
    _documentStartJavaScriptRegistrations.clear();
    ...
    try {
      ...
      _documentStartJavaScriptRegistrations.add(documentStartJavaScriptRegistration);
    } on UnsupportedError {
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
