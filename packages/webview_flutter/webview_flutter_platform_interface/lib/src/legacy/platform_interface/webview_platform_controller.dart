...
abstract class WebViewPlatformController {
  ...
  Future<void> loadFile(String absoluteFilePath) {
    throw UnimplementedError('WebView loadFile is not implemented on the current platform');
  }
  ...
  Future<void> loadFlutterAsset(String key) {
    throw UnimplementedError('WebView loadFlutterAsset is not implemented on the current platform');
  }
  ...
  Future<void> loadHtmlString(String html, {String? baseUrl}) {
    throw UnimplementedError('WebView loadHtmlString is not implemented on the current platform');
  }
  ...
  Future<void> loadRequest(WebViewRequest request) {
    throw UnimplementedError('WebView loadRequest is not implemented on the current platform');
  }
  ...
  Future<void> runJavascript(String javascript) {
    throw UnimplementedError('WebView runJavascript is not implemented on the current platform');
  }
