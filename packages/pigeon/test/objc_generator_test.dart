...
void main() {
  ...
  test('gen one class source with enum', () {
    ...
    expect(code, contains('@implementation Foobar'));
    expect(
        code, contains('pigeonResult.enum1 = [GetNullableObject(dict, @"enum1") integerValue];'));
  });
  ...
  test('bool source', () {
    ...
    final String code = sink.toString();
    expect(code, contains('@implementation Foobar'));
    expect(code, contains('pigeonResult.aBool = GetNullableObject(dict, @"aBool");'));
  });
  ...
  test('nested class source', () {
    ...
    final String code = sink.toString();
    expect(code,
        contains('pigeonResult.nested = [Input fromMap:GetNullableObject(dict, @"nested")];'));
