...
//
// Autogenerated from Pigeon (v4.2.4), do not edit directly.
...
abstract class TestHostApi {
  ...
  Future<MessageSearchReply> search(MessageSearchRequest request);
    ...
    }
    {
      ...
      if (api == null) {
        ...
        channel.setMockMessageHandler((Object? message) async {
          ...
          final MessageSearchReply output = await api.search(arg_request!);
...
abstract class TestNestedApi {
  ...
  ///
  /// This comment also tests multiple line comments.
  Future<MessageSearchReply> search(MessageNested nested);
  static void setup(TestNestedApi? api, {BinaryMessenger? binaryMessenger}) {
    {
      ...
      if (api == null) {
        ...
        channel.setMockMessageHandler((Object? message) async {
          ...
          final MessageSearchReply output = await api.search(arg_nested!);
          return <Object?, Object?>{'result': output};
        });
      }
    }
