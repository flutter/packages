...
public class Pigeon {
  ...
  public static class Nested {
    ...
    public void setRequest(SearchRequest setterArg) { this.request = setterArg; }
  ...
  public static class FlutterSearchApi {
    ...
    public void search(SearchRequest argInput, Reply<SearchReply> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.FlutterSearchApi.search", new StandardMessageCodec());
  ...
  public interface NestedApi {
    ...
    static void setup(BinaryMessenger binaryMessenger, NestedApi api) {
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.NestedApi.search", new StandardMessageCodec());
        if (api != null) {
