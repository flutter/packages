...
public class MessagePigeon {
  ...
  public static class MessageSearchRequest {
    ...
    public @Nullable Long getAnInt() { return anInt; }
  ...
  public static class MessageSearchReply {
    ...
    public @Nullable MessageRequestState getState() { return state; }
  ...
  public static class MessageNested {
    ...
    public @Nullable MessageSearchRequest getRequest() { return request; }
    ...
    static @NonNull MessageNested fromMap(@NonNull Map<String, Object> map) {
      ...
      pigeonResult.setRequest((request == null) ? null : MessageSearchRequest.fromMap((Map)request));
      return pigeonResult;
    }
  }
  private static class MessageApiCodec extends StandardMessageCodec {
    ...
    protected void writeValue(ByteArrayOutputStream stream, Object value)     {
      ...
      if (value instanceof MessageSearchRequest) {
        stream.write(129);
      ...
      } else 
{
  ...
  public interface MessageApi {
    void initialize();
    @NonNull MessageSearchReply search(@NonNull MessageSearchRequest request);
    ...
    static void setup(BinaryMessenger binaryMessenger, MessageApi api) {
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.MessageApi.initialize", getCodec());
        if (api != null) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.MessageApi.search", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
      ...
      } else 
{
  ...
  public interface MessageNestedApi {
    @NonNull MessageSearchReply search(@NonNull MessageNested nested);
    ...
    static void setup(BinaryMessenger binaryMessenger, MessageNestedApi api) {
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.MessageNestedApi.search", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
      ...
      } else 
{
  ...
  public static class MessageFlutterSearchApi {
    ...
    public void search(@NonNull MessageSearchRequest requestArg, Reply<MessageSearchReply> callback) {
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.MessageFlutterSearchApi.search", getCodec());
