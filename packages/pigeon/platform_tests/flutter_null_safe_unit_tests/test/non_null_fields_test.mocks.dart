...
import 'package:flutter_unit_tests/non_null_fields.gen.dart' as _i3;
...
/// A class which mocks [NonNullTypeArgumentFlutterApi].
///
/// See the documentation for Mockito's code generation for more information.
class MockNonNullTypeArgumentFlutterApi extends _i1.Mock
    implements _i3.NonNullTypeArgumentFlutterApi {
  MockNonNullTypeArgumentFlutterApi() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.NonNullTypeArgument doit(_i3.NonNullTypeArgument? arg) =>
      (super.noSuchMethod(Invocation.method(#doit, [arg]),
          returnValue: _FakeNonNullTypeArgument()) as _i3.NonNullTypeArgument);
  @override
  List<int> sum(List<int>? values) => (super
          .noSuchMethod(Invocation.method(#sum, [values]), returnValue: <int>[])
      as List<int>);
  @override
  Map<String, int> update(Map<String, int>? values) =>
      (super.noSuchMethod(Invocation.method(#update, [values]),
