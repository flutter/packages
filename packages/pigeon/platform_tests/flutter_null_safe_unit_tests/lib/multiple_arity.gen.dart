...
class MultipleArityHostApi {
  ...
  MultipleArityHostApi({BinaryMessenger? binaryMessenger}) : _binaryMessenger = binaryMessenger;
  ...
  Future<int> subtract(int arg_x, int arg_y) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.MultipleArityHostApi.subtract', codec, binaryMessenger: _binaryMessenger);
  ...
  static void setup(MultipleArityFlutterApi? api, {BinaryMessenger? binaryMessenger}) {
    {
      ...
      if (api == null) {
        ...
        channel.setMessageHandler((Object? message) async {
          assert(message != null, 'Argument for dev.flutter.pigeon.MultipleArityFlutterApi.subtract was null.');
