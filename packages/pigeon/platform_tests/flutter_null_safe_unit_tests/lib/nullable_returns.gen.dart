...
class NullableReturnHostApi {
  ...
  NullableReturnHostApi({BinaryMessenger? binaryMessenger}) : _binaryMessenger = binaryMessenger;
  ...
  Future<int?> doit() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.NullableReturnHostApi.doit', codec, binaryMessenger: _binaryMessenger);
...
class NullableArgHostApi {
  ...
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  NullableArgHostApi({BinaryMessenger? binaryMessenger}) : _binaryMessenger = binaryMessenger;
  ...
  Future<int> doit(int? arg_x) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.NullableArgHostApi.doit', codec, binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
...
abstract class NullableArgFlutterApi {
  ...
  static void setup(NullableArgFlutterApi? api, {BinaryMessenger? binaryMessenger}) {
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.NullableArgFlutterApi.doit', codec, binaryMessenger: binaryMessenger);
      if (api == null) {
        channel.setMessageHandler(null);
      } else {
        channel.setMessageHandler((Object? message) async {
          assert(message != null, 'Argument for dev.flutter.pigeon.NullableArgFlutterApi.doit was null.');
...
class NullableCollectionReturnHostApi {
  ...
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  NullableCollectionReturnHostApi({BinaryMessenger? binaryMessenger}) : _binaryMessenger = binaryMessenger;

  final BinaryMessenger? _binaryMessenger;

  static const MessageCodec<Object?> codec = _NullableCollectionReturnHostApiCodec();

  Future<List<String?>?> doit() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.NullableCollectionReturnHostApi.doit', codec, binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
        await channel.send(null) as Map<Object?, Object?>?;
    if (replyMap == null) {
      throw PlatformException(
...
abstract class NullableCollectionReturnFlutterApi {
  static const MessageCodec<Object?> codec = _NullableCollectionReturnFlutterApiCodec();
...
class NullableCollectionArgHostApi {
  ...
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  NullableCollectionArgHostApi({BinaryMessenger? binaryMessenger}) : _binaryMessenger = binaryMessenger;

  final BinaryMessenger? _binaryMessenger;

  static const MessageCodec<Object?> codec = _NullableCollectionArgHostApiCodec();

  Future<List<String?>> doit(List<String?>? arg_x) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.NullableCollectionArgHostApi.doit', codec, binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
        await channel.send(<Object?>[arg_x]) as Map<Object?, Object?>?;
    if (replyMap == null) {
      throw PlatformException(
...
abstract class NullableCollectionArgFlutterApi {
  static const MessageCodec<Object?> codec = _NullableCollectionArgFlutterApiCodec();
  ...
  static void setup(NullableCollectionArgFlutterApi? api, {BinaryMessenger? binaryMessenger}) {
    {
      ...
      if (api == null) {
        ...
        channel.setMessageHandler((Object? message) async {
          assert(message != null, 'Argument for dev.flutter.pigeon.NullableCollectionArgFlutterApi.doit was null.');
          final List<Object?> args = (message as List<Object?>?)!;
