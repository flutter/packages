...
class _ApiCodec extends StandardMessageCodec{
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 131:       
        return FlutterSearchRequests.decode(readValue(buffer)! as List<Object?>);
...
class Api {
  ...
  Future<FlutterSearchReplies> doSearches(FlutterSearchRequests arg_request) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
  ...
  Future<int> anInt(int arg_value) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.Api.anInt', codec, binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
