...
@property(nonatomic, strong, nullable) AllNullableListTypes *allNullableLists;
@property(nonatomic, strong, nullable) AllNullableMapTypes *allNullableMaps;
