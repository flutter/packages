...
import 'native_interop_test_types.dart' as native_interop_types;
...
void runComparisonBenchmarks(TargetGenerator targetGenerator) {
  group('Comparison Benchmarks (MethodChannel vs Native Interop)', () {
    ...
    final nativeInteropRegistrar = native_interop.NativeInteropFlutterIntegrationCoreApiRegistrar();
    nativeInteropRegistrar.register(NativeInteropFlutterIntegrationCoreApiImpl());
    ...
    testWidgets('Uint8List Echo 1MB Comparison', (WidgetTester _) async {
      ...
      if (nativeInteropApi != null) {
        ...
        nativeInteropApi.echoUint8List(data);
        niStopwatch.stop();
    ...
    testWidgets('Large Object List 15 Comparison', (WidgetTester _) async {
      ...
      final niList = List<native_interop.NativeInteropAllNullableTypes?>.generate(
        15,
      ...
      if (nativeInteropApi != null) {
        final niStopwatch = Stopwatch()..start();
        nativeInteropApi.echoClassList(niList);
        niStopwatch.stop();
    ...
    testWidgets('Large Int List 200 Comparison', (WidgetTester _) async {
      ...
      if (nativeInteropApi != null) {
        final niStopwatch = Stopwatch()..start();
        nativeInteropApi.echoIntList(list);
        niStopwatch.stop();
    ...
    testWidgets('Large Int Map 200 Comparison', (WidgetTester _) async {
      ...
      if (nativeInteropApi != null) {
        final niStopwatch = Stopwatch()..start();
        nativeInteropApi.echoIntMap(map);
        niStopwatch.stop();
    ...
    testWidgets('Small String Echo Comparison (x200)', (WidgetTester _) async {
      ...
      if (nativeInteropApi != null) {
        final niStopwatch = Stopwatch()..start();
        for (var i = 0; i < 200; i++) {
          nativeInteropApi.echoString(text);
        }
        niStopwatch.stop();
    ...
    testWidgets('Small Int Echo Comparison (x200)', (WidgetTester _) async {
      ...
      if (nativeInteropApi != null) {
        final niStopwatch = Stopwatch()..start();
        for (var i = 0; i < 200; i++) {
          nativeInteropApi.echoInt(value);
        }
        niStopwatch.stop();
    ...
    testWidgets('Flutter String Echo Comparison (x200)', (WidgetTester _) async {
      ...
      final niStopwatch = Stopwatch()..start();
      for (var i = 0; i < 200; i++) {
        nativeInteropApi!.callFlutterEchoString(text);
      }
      niStopwatch.stop();
    ...
    testWidgets('Flutter Int Echo Comparison (x200)', (WidgetTester _) async {
      ...
      final niStopwatch = Stopwatch()..start();
      for (var i = 0; i < 200; i++) {
        nativeInteropApi!.callFlutterEchoInt(value);
      }
      niStopwatch.stop();
    ...
    testWidgets('Flutter Uint8List Echo 1MB Comparison', (WidgetTester _) async {
      ...
      // Native Interop
      final niStopwatch = Stopwatch()..start();
      nativeInteropApi!.callFlutterEchoUint8List(data);
      niStopwatch.stop();
    ...
    testWidgets('Flutter Large Object List 15 Comparison', (WidgetTester _) async {
      ...
      // Native Interop
      final niStopwatch = Stopwatch()..start();
      nativeInteropApi!.callFlutterEchoClassList(niList);
      niStopwatch.stop();
    ...
    testWidgets('Flutter Large Int List 200 Comparison', (WidgetTester _) async {
      ...
      // Native Interop
      final niStopwatch = Stopwatch()..start();
      nativeInteropApi!.callFlutterEchoList(list);
      niStopwatch.stop();
    ...
    testWidgets('Flutter Large Int Map 200 Comparison', (WidgetTester _) async {
      ...
      // Native Interop
      final niStopwatch = Stopwatch()..start();
      nativeInteropApi!.callFlutterEchoIntMap(map);
      niStopwatch.stop();
