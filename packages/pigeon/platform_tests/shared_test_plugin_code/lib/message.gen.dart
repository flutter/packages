...
class MessageSearchRequest {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(query, other.query) && _deepEquals(anInt, other.anInt) && _deepEquals(aBool, other.aBool);
  }
...
class MessageSearchReply {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(result, other.result) && _deepEquals(error, other.error) && _deepEquals(state, other.state);
  }
...
class MessageApi {
  ...
  Future<void> initialize() async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.shared_test_plugin_code.MessageApi.initialize$pigeonVar_messageChannelSuffix';
...
abstract class MessageFlutterSearchApi {
  ...
  static void setUp(MessageFlutterSearchApi? api, {BinaryMessenger? binaryMessenger, String messageChannelSuffix = '',}) {
    ...
    {
      final pigeonVar_channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.shared_test_plugin_code.MessageFlutterSearchApi.search$messageChannelSuffix', pigeonChannelCodec,
      ...
      if (api == null) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.shared_test_plugin_code.MessageFlutterSearchApi.search was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final MessageSearchRequest? arg_request = (args[0] as MessageSearchRequest?);
          assert(arg_request != null,
              'Argument for dev.flutter.pigeon.shared_test_plugin_code.MessageFlutterSearchApi.search was null, expected non-null MessageSearchRequest.');
          try {
