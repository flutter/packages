  ...
  group('Host sync API tests', () {
    ...
    group('Host async API tests', () {
      ...
      testWidgets('enum lists serialize and deserialize correctly', (
        ...
        final List<NIAnEnum?> echoObject = await api!.echoAsyncEnumList(
          enumList,
        );
        expect(listEquals(echoObject, enumList), true);
      });
      ...
      testWidgets('enums serialize and deserialize correctly (again)', (
        ...
        const NIAnotherEnum sentEnum = NIAnotherEnum.justInCase;
        final NIAnotherEnum echoEnum = await api!.echoAnotherAsyncEnum(
          sentEnum,
        );
        expect(echoEnum, sentEnum);
      });
      ...
      testWidgets(
        'nullable Doubles async serialize and deserialize correctly',
        (WidgetTester _) async {
          final NIHostIntegrationCoreApiForNativeInterop? api =
              NIHostIntegrationCoreApiForNativeInterop.getInstance();
      ...
      testWidgets(
        'nullable booleans async serialize and deserialize correctly',
        (WidgetTester _) async {
          final NIHostIntegrationCoreApiForNativeInterop? api =
              NIHostIntegrationCoreApiForNativeInterop.getInstance();

          for (final bool sentBool in <bool>[true, false]) {
            final bool? receivedBool = await api!.echoAsyncNullableBool(
              sentBool,
            );
            expect(receivedBool, sentBool);
          }
      ...
      testWidgets(
        'nullable strings async serialize and deserialize correctly',
        (WidgetTester _) async {
          final NIHostIntegrationCoreApiForNativeInterop? api =
              NIHostIntegrationCoreApiForNativeInterop.getInstance();
          ...
          final String? echoObject = await api!.echoAsyncNullableString(
            sentObject,
          );
          expect(echoObject, sentObject);
        },
      ...
      testWidgets('nullable lists serialize and deserialize correctly', (
        ...
        final List<Object?>? echoObject = await api!.echoAsyncNullableList(
          list,
        );
        expect(listEquals(echoObject, list), true);
      });
      ...
      testWidgets(
        'nullable enums serialize and deserialize correctly (again)',
        (WidgetTester _) async {
          final NIHostIntegrationCoreApiForNativeInterop? api =
              NIHostIntegrationCoreApiForNativeInterop.getInstance();
          ...
          final NIAnotherEnum? echoEnum = await api!
              .echoAnotherAsyncNullableEnum(sentEnum);
          expect(echoEnum, sentEnum);
        },
      );
