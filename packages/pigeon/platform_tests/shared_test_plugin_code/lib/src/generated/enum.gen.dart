...
class EnumApi2Host {
  ...
  static const MessageCodec<Object?> $_codec = _EnumApi2HostCodec();
  ...
  Future<DataWithEnum> echo(DataWithEnum data) async {
    ...
    final List<Object?>? $_replyList =
        await $_channel.send(<Object?>[data]) as List<Object?>?;
    if ($_replyList == null) {
      ...
      return ($_replyList[0] as DataWithEnum?)!;
    }
  }
}
...
abstract class EnumApi2Flutter {
  static const MessageCodec<Object?> $_codec = _EnumApi2FlutterCodec();
