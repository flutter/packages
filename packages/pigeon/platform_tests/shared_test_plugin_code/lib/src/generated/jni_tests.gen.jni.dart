...
class JniMessageApiAsync extends jni$_.JObject {
  ...
  /// from: `public abstract java.lang.Object doNothing(kotlin.coroutines.Continuation continuation)`
  /// The returned object must be released after use, by calling the [release] method.
  ...
  core$_.Future<jni$_.JLong> echoInt(
    ...
    return $o.as(const jni$_.JLongType(), releaseOriginal: true);
  }
  ...
  core$_.Future<jni$_.JDouble> echoDouble(
    ...
    return $o.as(const jni$_.JDoubleType(), releaseOriginal: true);
  }
  ...
  core$_.Future<jni$_.JBoolean> echoBool(
    ...
    return $o.as(const jni$_.JBooleanType(), releaseOriginal: true);
  }
  ...
  /// from: `public abstract java.lang.Object sendSomeTypes(SomeTypes someTypes, kotlin.coroutines.Continuation continuation)`
  /// The returned object must be released after use, by calling the [release] method.
  core$_.Future<SomeTypes> sendSomeTypes(
    ...
    return $o.as(const $SomeTypes$Type(), releaseOriginal: true);
  }
}
...
class JniMessageApiAsyncRegistrar extends JniMessageApiAsync {
  ...
  /// from: `public java.lang.Object doNothing(kotlin.coroutines.Continuation continuation)`
  /// The returned object must be released after use, by calling the [release] method.
  core$_.Future<jni$_.JObject> doNothing() async {
    final $p = jni$_.ReceivePort();
    final _$continuation = jni$_.ProtectedJniExtensions.newPortContinuation($p);
  ...
  /// from: `public java.lang.Object sendSomeTypes(SomeTypes someTypes, kotlin.coroutines.Continuation continuation)`
  /// The returned object must be released after use, by calling the [release] method.
  core$_.Future<SomeTypes> sendSomeTypes(
    SomeTypes someTypes,
  ) async {
...
class SomeNullableTypes$Companion extends jni$_.JObject {
  ...
  /// from: `public final SomeNullableTypes fromList(java.util.List list)`
  /// The returned object must be released after use, by calling the [release] method.
