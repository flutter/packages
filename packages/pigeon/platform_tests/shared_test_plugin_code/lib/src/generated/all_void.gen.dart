...
abstract class AllVoidFlutterApi {
  ...
  void doit();
  static void setup(AllVoidFlutterApi? api, {BinaryMessenger? binaryMessenger}) {
    {
...
class AllVoidHostApi {
  ...
  AllVoidHostApi({BinaryMessenger? binaryMessenger}) : _binaryMessenger = binaryMessenger;
  ...
  Future<void> doit() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.AllVoidHostApi.doit', codec, binaryMessenger: _binaryMessenger);
