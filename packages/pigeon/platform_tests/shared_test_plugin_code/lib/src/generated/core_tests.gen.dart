...
class HostIntegrationCoreApi {
  ...
  Future<bool> isBackgroundThread() async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.isBackgroundThread$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
