...
public class MultipleArityTest {
  ...
  public void subtract() {
    ...
    doAnswer(
        invocation -> {
          ...
          ArrayList<Object> args =
              (ArrayList<Object>) AllDatatypes.FlutterEverything.getCodec().decodeMessage(message);
          Long arg0 = (Long)args.get(0);
          Long arg1 = (Long)args.get(1);
          ByteBuffer replyData = AllDatatypes.FlutterEverything.getCodec().encodeMessage(arg0 - arg1);
    ...
    api.subtract(30L, 20L, (Long result) -> {
