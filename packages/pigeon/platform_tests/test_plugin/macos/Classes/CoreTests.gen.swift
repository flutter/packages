...
class HostIntegrationCoreApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: HostIntegrationCoreApi?, messageChannelSuffix: String = "") {
    /// A no-op function taking no arguments and returning no value, to sanity
    /// test basic calling.
    let noopChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.noop\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed object, to test serialization and deserialization.
    let echoAllTypesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoAllTypes\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns an error, to test error handling.
    let throwErrorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.throwError\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns an error from a void function, to test error handling.
    let throwErrorFromVoidChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.throwErrorFromVoid\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns a Flutter error, to test error handling.
    let throwFlutterErrorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.throwFlutterError\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns passed in int.
    let echoIntChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoInt\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns passed in double.
    let echoDoubleChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoDouble\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed in boolean.
    let echoBoolChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoBool\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed in string.
    let echoStringChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoString\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed in Uint8List.
    let echoUint8ListChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoUint8List\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed in generic Object.
    let echoObjectChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoObject\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed list, to test serialization and deserialization.
    let echoListChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoList\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed map, to test serialization and deserialization.
    let echoMapChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoMap\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed map to test nested class serialization and deserialization.
    let echoClassWrapperChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoClassWrapper\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed enum to test serialization and deserialization.
    let echoEnumChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoEnum\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the default string.
    let echoNamedDefaultStringChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoNamedDefaultString\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns passed in double.
    let echoOptionalDefaultDoubleChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoOptionalDefaultDouble\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns passed in int.
    let echoRequiredIntChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoRequiredInt\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed object, to test serialization and deserialization.
    let echoAllNullableTypesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoAllNullableTypes\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the inner `aString` value from the wrapped object, to test
    /// sending of nested objects.
    let extractNestedNullableStringChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.extractNestedNullableString\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the inner `aString` value from the wrapped object, to test
    /// sending of nested objects.
    let createNestedNullableStringChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.createNestedNullableString\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns passed in arguments of multiple types.
    let sendMultipleNullableTypesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.sendMultipleNullableTypes\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns passed in int.
    let echoNullableIntChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoNullableInt\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns passed in double.
    let echoNullableDoubleChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoNullableDouble\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed in boolean.
    let echoNullableBoolChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoNullableBool\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed in string.
    let echoNullableStringChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoNullableString\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed in Uint8List.
    let echoNullableUint8ListChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoNullableUint8List\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed in generic Object.
    let echoNullableObjectChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoNullableObject\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed list, to test serialization and deserialization.
    let echoNullableListChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoNullableList\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed map, to test serialization and deserialization.
    let echoNullableMapChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoNullableMap\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let echoNullableEnumChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoNullableEnum\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns passed in int.
    let echoOptionalNullableIntChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoOptionalNullableInt\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed in string.
    let echoNamedNullableStringChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoNamedNullableString\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// A no-op function taking no arguments and returning no value, to sanity
    /// test basic asynchronous calling.
    let noopAsyncChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.noopAsync\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns passed in int asynchronously.
    let echoAsyncIntChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoAsyncInt\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns passed in double asynchronously.
    let echoAsyncDoubleChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoAsyncDouble\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed in boolean asynchronously.
    let echoAsyncBoolChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoAsyncBool\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed string asynchronously.
    let echoAsyncStringChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoAsyncString\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed in Uint8List asynchronously.
    let echoAsyncUint8ListChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoAsyncUint8List\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed in generic Object asynchronously.
    let echoAsyncObjectChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoAsyncObject\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed list, to test asynchronous serialization and deserialization.
    let echoAsyncListChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoAsyncList\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed map, to test asynchronous serialization and deserialization.
    let echoAsyncMapChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoAsyncMap\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed enum, to test asynchronous serialization and deserialization.
    let echoAsyncEnumChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoAsyncEnum\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Responds with an error from an async function returning a value.
    let throwAsyncErrorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.throwAsyncError\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Responds with an error from an async void function.
    let throwAsyncErrorFromVoidChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.throwAsyncErrorFromVoid\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Responds with a Flutter error from an async function returning a value.
    let throwAsyncFlutterErrorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.throwAsyncFlutterError\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed object, to test async serialization and deserialization.
    let echoAsyncAllTypesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoAsyncAllTypes\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed object, to test serialization and deserialization.
    let echoAsyncNullableAllNullableTypesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoAsyncNullableAllNullableTypes\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns passed in int asynchronously.
    let echoAsyncNullableIntChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoAsyncNullableInt\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns passed in double asynchronously.
    let echoAsyncNullableDoubleChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoAsyncNullableDouble\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed in boolean asynchronously.
    let echoAsyncNullableBoolChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoAsyncNullableBool\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed string asynchronously.
    let echoAsyncNullableStringChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoAsyncNullableString\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed in Uint8List asynchronously.
    let echoAsyncNullableUint8ListChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoAsyncNullableUint8List\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed in generic Object asynchronously.
    let echoAsyncNullableObjectChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoAsyncNullableObject\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed list, to test asynchronous serialization and deserialization.
    let echoAsyncNullableListChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoAsyncNullableList\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed map, to test asynchronous serialization and deserialization.
    let echoAsyncNullableMapChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoAsyncNullableMap\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed enum, to test asynchronous serialization and deserialization.
    let echoAsyncNullableEnumChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoAsyncNullableEnum\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let callFlutterNoopChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.callFlutterNoop\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let callFlutterThrowErrorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.callFlutterThrowError\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let callFlutterThrowErrorFromVoidChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.callFlutterThrowErrorFromVoid\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let callFlutterEchoAllTypesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.callFlutterEchoAllTypes\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let callFlutterEchoAllNullableTypesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.callFlutterEchoAllNullableTypes\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let callFlutterSendMultipleNullableTypesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.callFlutterSendMultipleNullableTypes\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let callFlutterEchoBoolChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.callFlutterEchoBool\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let callFlutterEchoIntChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.callFlutterEchoInt\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let callFlutterEchoDoubleChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.callFlutterEchoDouble\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let callFlutterEchoStringChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.callFlutterEchoString\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let callFlutterEchoUint8ListChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.callFlutterEchoUint8List\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let callFlutterEchoListChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.callFlutterEchoList\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let callFlutterEchoMapChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.callFlutterEchoMap\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let callFlutterEchoEnumChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.callFlutterEchoEnum\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let callFlutterEchoNullableBoolChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.callFlutterEchoNullableBool\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let callFlutterEchoNullableIntChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.callFlutterEchoNullableInt\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let callFlutterEchoNullableDoubleChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.callFlutterEchoNullableDouble\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let callFlutterEchoNullableStringChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.callFlutterEchoNullableString\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let callFlutterEchoNullableUint8ListChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.callFlutterEchoNullableUint8List\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let callFlutterEchoNullableListChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.callFlutterEchoNullableList\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let callFlutterEchoNullableMapChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.callFlutterEchoNullableMap\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let callFlutterEchoNullableEnumChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.callFlutterEchoNullableEnum\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let callFlutterSmallApiEchoStringChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.callFlutterSmallApiEchoString\(messageChannelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
class HostTrivialApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: HostTrivialApi?, messageChannelSuffix: String = "") {
    let noopChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostTrivialApi.noop\(messageChannelSuffix)", binaryMessenger: binaryMessenger)
    if let api = api {
      noopChannel.setMessageHandler { _, reply in
        do {
          try api.noop()
...
class HostSmallApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: HostSmallApi?, messageChannelSuffix: String = "") {
    let echoChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostSmallApi.echo\(messageChannelSuffix)", binaryMessenger: binaryMessenger)
    if let api = api {
    ...
    let voidVoidChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostSmallApi.voidVoid\(messageChannelSuffix)", binaryMessenger: binaryMessenger)
    if let api = api {
