// Generated by Apple Swift version 6.4 effective-5.10 (swiftlang-6.4.0.34.1
// clang-2100.3.34.1)
...
#define SWIFT_AVAILABILITY_DOMAIN(dom, ...) \
  __attribute__((availability(domain : dom, __VA_ARGS__)))
#endif
...
SWIFT_ENUM_FWD_DECL(NSInteger, NativeInteropAnEnum)
SWIFT_ENUM_FWD_DECL(NSInteger, NativeInteropAnotherEnum)
