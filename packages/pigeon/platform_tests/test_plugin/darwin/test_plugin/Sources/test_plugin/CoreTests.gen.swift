...
struct AllClassesWrapper: Hashable, CustomStringConvertible {
  ...
  static func == (lhs: AllClassesWrapper, rhs: AllClassesWrapper) -> Bool {
    ...
    return CoreTestsPigeonInternal.deepEquals(lhs.allNullableTypes, rhs.allNullableTypes) && CoreTestsPigeonInternal.deepEquals(lhs.allNullableTypesWithoutRecursion, rhs.allNullableTypesWithoutRecursion) && CoreTestsPigeonInternal.deepEquals(lhs.allTypes, rhs.allTypes) && CoreTestsPigeonInternal.deepEquals(lhs.classList, rhs.classList) && CoreTestsPigeonInternal.deepEquals(lhs.nullableClassList, rhs.nullableClassList) && CoreTestsPigeonInternal.deepEquals(lhs.classMap, rhs.classMap) && CoreTestsPigeonInternal.deepEquals(lhs.nullableClassMap, rhs.nullableClassMap) && CoreTestsPigeonInternal.deepEquals(lhs.anEmptyClass, rhs.anEmptyClass)
  }
...
protocol HostIntegrationCoreApi {
  ...
  /// Returns the passed object, to test serialization and deserialization.
  func echoAsync(_ everything: AllNullableTypesWithoutRecursion?) async throws -> AllNullableTypesWithoutRecursion?
  /// Returns passed in int asynchronously.
  ...
  /// Returns the passed in Uint8List asynchronously.
  func echoAsyncNullable(_ aUint8List: FlutterStandardTypedData?) async throws -> FlutterStandardTypedData?
  /// Returns the passed in generic Object asynchronously.
  ...
  /// Returns the passed map, to test asynchronous serialization and deserialization.
  func echoAsyncNullable(classMap: [Int64?: AllNullableTypes?]?) async throws -> [Int64?: AllNullableTypes?]?
  /// Returns the passed enum, to test asynchronous serialization and deserialization.
  ...
  func callFlutterSendMultipleNullableTypes(aBool aNullableBool: Bool?, anInt aNullableInt: Int64?, aString aNullableString: String?) async throws -> AllNullableTypes
  func callFlutterEcho(_ everything: AllNullableTypesWithoutRecursion?) async throws -> AllNullableTypesWithoutRecursion?
  func callFlutterSendMultipleNullableTypesWithoutRecursion(aBool aNullableBool: Bool?, anInt aNullableInt: Int64?, aString aNullableString: String?) async throws -> AllNullableTypesWithoutRecursion
  ...
  func callFlutterEcho(classMap: [Int64?: AllNullableTypes?]) async throws -> [Int64?: AllNullableTypes?]
  ...
  func callFlutterEchoNonNull(classMap: [Int64: AllNullableTypes]) async throws -> [Int64: AllNullableTypes]
  ...
  func callFlutterEchoNullable(_ list: FlutterStandardTypedData?) async throws -> FlutterStandardTypedData?
  ...
  func callFlutterEchoNullableNonNull(classList: [AllNullableTypes]?) async throws -> [AllNullableTypes]?
  ...
  func callFlutterEchoNullable(classMap: [Int64?: AllNullableTypes?]?) async throws -> [Int64?: AllNullableTypes?]?
  func callFlutterEchoNullableNonNull(stringMap: [String: String]?) async throws -> [String: String]?
  ...
  func callFlutterEchoNullableNonNull(classMap: [Int64: AllNullableTypes]?) async throws -> [Int64: AllNullableTypes]?
...
class HostIntegrationCoreApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: HostIntegrationCoreApi?, messageChannelSuffix: String = "") {
    ...
    /// Returns the passed list, to test serialization and deserialization.
    let echoStringListChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoStringList\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed list, to test serialization and deserialization.
    let echoIntListChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoIntList\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed list, to test serialization and deserialization.
    let echoDoubleListChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoDoubleList\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns the passed list, to test serialization and deserialization.
    let echoBoolListChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.echoBoolList\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    /// Returns true if the handler is run on a non-main thread, which should be
    /// true for any platform with TaskQueue support.
    let asyncTaskQueueIsBackgroundThreadChannel = taskQueue == nil
      ? FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.asyncTaskQueueIsBackgroundThread\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
      : FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.asyncTaskQueueIsBackgroundThread\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec, taskQueue: taskQueue)
    if let api = api {
    ...
    if let api = api {
      callFlutterSendMultipleNullableTypesChannel.setMessageHandler { message, reply in
        ...
        Task { @MainActor in
          do {
            let result = try await api.callFlutterSendMultipleNullableTypes(aBool: aNullableBoolArg, anInt: aNullableIntArg, aString: aNullableStringArg)
            reply(wrapResult(result))
          } catch {
            reply(wrapError(error))
          }
    ...
    if let api = api {
      callFlutterSendMultipleNullableTypesWithoutRecursionChannel.setMessageHandler { message, reply in
        ...
        Task { @MainActor in
          do {
            let result = try await api.callFlutterSendMultipleNullableTypesWithoutRecursion(aBool: aNullableBoolArg, anInt: aNullableIntArg, aString: aNullableStringArg)
            reply(wrapResult(result))
          } catch {
            reply(wrapError(error))
          }
    ...
    let callFlutterCallbackNoopChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.callFlutterCallbackNoop\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let callFlutterCallbackEchoStringChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.callFlutterCallbackEchoString\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let callFlutterCallbackThrowErrorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.callFlutterCallbackThrowError\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let callFlutterCallbackThrowErrorFromVoidChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostIntegrationCoreApi.callFlutterCallbackThrowErrorFromVoid\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
class FlutterCallbackCoreApi: FlutterCallbackCoreApiProtocol {
  ...
  func noop(completion: @escaping (Result<Void, PigeonError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.pigeon_integration_tests.FlutterCallbackCoreApi.noop\(messageChannelSuffix)"
  ...
  func echo(string aStringArg: String, completion: @escaping (Result<String, PigeonError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.pigeon_integration_tests.FlutterCallbackCoreApi.echoString\(messageChannelSuffix)"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
  ...
  func throwError(completion: @escaping (Result<Any?, PigeonError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.pigeon_integration_tests.FlutterCallbackCoreApi.throwError\(messageChannelSuffix)"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage(nil) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName: channelName)))
  ...
  func throwErrorFromVoid(completion: @escaping (Result<Void, PigeonError>) -> Void) {
    let channelName: String = "dev.flutter.pigeon.pigeon_integration_tests.FlutterCallbackCoreApi.throwErrorFromVoid\(messageChannelSuffix)"
    let channel = FlutterBasicMessageChannel(name: channelName, binaryMessenger: binaryMessenger, codec: codec)
    channel.sendMessage(nil) { response in
      guard let listResponse = response as? [Any?] else {
        completion(.failure(createConnectionError(withChannelName: channelName)))
...
protocol FlutterIntegrationCoreApiProtocol {
  ...
  func sendMultipleNullableTypes(aBool aNullableBoolArg: Bool?, anInt aNullableIntArg: Int64?, aString aNullableStringArg: String?) async throws -> AllNullableTypes
  /// Returns the passed object, to test serialization and deserialization.
  func echoNullable(_ everythingArg: AllNullableTypesWithoutRecursion?) async throws -> AllNullableTypesWithoutRecursion?
  /// Returns passed in arguments of multiple types.
  ///
  /// Tests multiple-arity FlutterApi handling.
  func sendMultipleNullableTypesWithoutRecursion(aBool aNullableBoolArg: Bool?, anInt aNullableIntArg: Int64?, aString aNullableStringArg: String?) async throws -> AllNullableTypesWithoutRecursion
  ...
  /// Returns the passed map, to test serialization and deserialization.
  func echo(classMap classMapArg: [Int64?: AllNullableTypes?]) async throws -> [Int64?: AllNullableTypes?]
  /// Returns the passed map, to test serialization and deserialization.
  ...
  /// Returns the passed map, to test serialization and deserialization.
  func echoNonNull(classMap classMapArg: [Int64: AllNullableTypes]) async throws -> [Int64: AllNullableTypes]
  /// Returns the passed enum to test serialization and deserialization.
  ...
  /// Returns the passed list, to test serialization and deserialization.
  func echoNullable(classList classListArg: [AllNullableTypes?]?) async throws -> [AllNullableTypes?]?
  /// Returns the passed list, to test serialization and deserialization.
  func echoNullableNonNull(enumList enumListArg: [AnEnum]?) async throws -> [AnEnum]?
  /// Returns the passed list, to test serialization and deserialization.
  func echoNullableNonNull(classList classListArg: [AllNullableTypes]?) async throws -> [AllNullableTypes]?
  /// Returns the passed map, to test serialization and deserialization.
  ...
  /// Returns the passed map, to test serialization and deserialization.
  func echoNullable(classMap classMapArg: [Int64?: AllNullableTypes?]?) async throws -> [Int64?: AllNullableTypes?]?
  /// Returns the passed map, to test serialization and deserialization.
  func echoNullableNonNull(stringMap stringMapArg: [String: String]?) async throws -> [String: String]?
  /// Returns the passed map, to test serialization and deserialization.
  ...
  /// Returns the passed map, to test serialization and deserialization.
  func echoNullableNonNull(classMap classMapArg: [Int64: AllNullableTypes]?) async throws -> [Int64: AllNullableTypes]?
  /// Returns the passed enum to test serialization and deserialization.
...
class HostCallbackCoreApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: HostCallbackCoreApi?, messageChannelSuffix: String = "") {
    let channelSuffix = messageChannelSuffix.count > 0 ? ".\(messageChannelSuffix)" : ""
    #if os(iOS)
      let taskQueue = binaryMessenger.makeBackgroundTaskQueue?()
    #else
      let taskQueue: FlutterTaskQueue? = nil
    #endif
    let noopChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostCallbackCoreApi.noop\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      noopChannel.setMessageHandler { _, reply in
        api.noop { result in
          switch result {
    ...
    let echoStringChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostCallbackCoreApi.echoString\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      echoStringChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let aStringArg = args[0] as! String
    ...
    let echoAllTypesChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostCallbackCoreApi.echoAllTypes\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      echoAllTypesChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let everythingArg = args[0] as! AllTypes
    ...
    let echoNullableStringChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostCallbackCoreApi.echoNullableString\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      echoNullableStringChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let aStringArg: String? = nilOrValue(args[0])
    ...
    let throwErrorChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostCallbackCoreApi.throwError\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      throwErrorChannel.setMessageHandler { _, reply in
    ...
    let throwErrorFromVoidChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostCallbackCoreApi.throwErrorFromVoid\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      throwErrorFromVoidChannel.setMessageHandler { _, reply in
    ...
    let taskQueueIsBackgroundThreadChannel = taskQueue == nil
      ? FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostCallbackCoreApi.taskQueueIsBackgroundThread\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
      : FlutterBasicMessageChannel(name: "dev.flutter.pigeon.pigeon_integration_tests.HostCallbackCoreApi.taskQueueIsBackgroundThread\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec, taskQueue: taskQueue)
    if let api = api {
      taskQueueIsBackgroundThreadChannel.setMessageHandler { _, reply in
