...
EncodableList AllTypes::ToEncodableList() const {
  ...
  list.push_back(EncodableValue(an_object_));
  return list;
}
...
AllTypes AllTypes::FromEncodableList(const EncodableList& list) {
  AllTypes decoded(
      ...
      std::get<std::string>(list[11]), std::get<EncodableValue>(list[12]));
  return decoded;
}
...
EncodableList AllNullableTypes::ToEncodableList() const {
  ...
  list.push_back(a_nullable_string_ ? EncodableValue(*a_nullable_string_)
                                    : EncodableValue());
  list.push_back(a_nullable_object_ ? EncodableValue(*a_nullable_object_)
                                    : EncodableValue());
  return list;
}
...
AllNullableTypes AllNullableTypes::FromEncodableList(
  ...
  if (!encodable_a_nullable_object.IsNull()) {
    decoded.set_a_nullable_object(
        std::get<EncodableValue>(encodable_a_nullable_object));
  }
  return decoded;
}
