...
class TestPlugin : public flutter::Plugin,
 ...
 public:
  ...
  SendMultipleTypes(bool a_bool, int64_t an_int, const std::string& a_string);
  EchoInt(int64_t an_int);
  ...
  void EchoAsyncBool(
      ...
      std::function<void(core_tests_pigeontest::ErrorOr<std::bool> reply)>
          result) override;
