...
SWIFT_CLASS("_TtC11test_plugin25HostIntegrationCoreApiFfi")
@interface HostIntegrationCoreApiFfi : NSObject
- (nonnull instancetype)initWithName:(NSString *_Nonnull)name
    OBJC_DESIGNATED_INITIALIZER;
+ (HostIntegrationCoreApiFfi *_Nullable)getInstanceWithName:
