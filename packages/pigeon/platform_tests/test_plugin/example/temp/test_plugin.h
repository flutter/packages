// Generated by Apple Swift version 6.1 effective-5.10 (swiftlang-6.1.0.106.4
// clang-1700.0.9.2)
...
/// Generated protocol from Pigeon that represents a handler of messages from
/// Flutter.
...
- (NSString *_Nonnull)echoStringWithAString:(NSString *_Nonnull)aString
...
@interface JniHostIntegrationCoreApiSetup : NSObject <JniHostIntegrationCoreApi>
