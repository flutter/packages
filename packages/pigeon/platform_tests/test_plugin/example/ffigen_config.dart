  ...
  final List<String> enums = <String>[
    ...
    await SwiftGen(
      ...
      input: ObjCCompatibleSwiftFileInput(
        module: 'test_plugin',
        files: <Uri>[Uri.file('/Users/tarrinneal/work/packages/packages/pigeon/platform_tests/test_plugin/ios/Classes/NiTests.gen.swift')],
      ),
      tempDirectory: Uri.directory('temp'),
      outputModule: 'test_plugin',
      ffigen: FfiGenConfig(
        output: Uri.file('/Users/tarrinneal/work/packages/packages/pigeon/platform_tests/shared_test_plugin_code/lib/src/generated/ni_tests.gen.ffi.dart'),
        outputObjC: Uri.file('/Users/tarrinneal/work/packages/packages/pigeon/platform_tests/shared_test_plugin_code/lib/src/generated/ni_tests.gen.m'),
