...
@testable import swift_concurrency_test_plugin
...
final class FlutterApiFromProtocol: FlutterSmallApiProtocol {
  ...
  func echo(_ msgArg: swift_concurrency_test_plugin.TestMessage) async throws
    -> swift_concurrency_test_plugin.TestMessage
  {
    return msgArg
  }
}
