...
- (BOOL)isEqual:(id)object {
  ...
  return FLTPigeonDeepEquals(self.name, other.name) && FLTPigeonDeepEquals(self.description, other.description) && self.code == other.code && FLTPigeonDeepEquals(self.data, other.data);
}
