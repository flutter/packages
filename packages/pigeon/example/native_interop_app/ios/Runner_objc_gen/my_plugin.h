...
// clang-1700.0.13.5)
#ifndef MY_PLUGIN_SWIFT_H
#define MY_PLUGIN_SWIFT_H
...
#undef any
#pragma clang attribute push(__attribute__((external_source_symbol(            \
                                 language = "Swift", defined_in = "my_plugin", \
...
SWIFT_CLASS("_TtC9my_plugin28NativeInteropExampleApiSetup")
...
- (void)doSomethingWithWrappedError:(PigeonError* _Nonnull)wrappedError;
@end

@class NSNumber;
SWIFT_CLASS("_TtC9my_plugin33NativeInteropExampleNumberWrapper")
@interface NativeInteropExampleNumberWrapper : NSObject <NSCopying>
...
SWIFT_CLASS("_TtC9my_plugin38NativeInteropExamplePigeonInternalNull")
@interface NativeInteropExamplePigeonInternalNull : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class NSData;
SWIFT_CLASS("_TtC9my_plugin35NativeInteropExamplePigeonTypedData")
SWIFT_AVAILABILITY(macos, introduced = 10.15)
SWIFT_AVAILABILITY(ios, introduced = 13)
...
SWIFT_CLASS("_TtC9my_plugin11PigeonError")
