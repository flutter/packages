                             ...
                             : @"";
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
           initWithName:[NSString stringWithFormat:@"%@%@",
                                                   ...
                                                   @"ExampleHostApi.determineHostLanguage",
                                                   messageChannelSuffix]
        binaryMessenger:binaryMessenger
                  codec:PGNGetMessagesCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(determineHostLanguageWithError:)],
                @"PGNExampleHostApi api (%@) doesn't respond to "
                @"@selector(determineHostLanguageWithError:)",
                api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        FlutterError *error;
        NSString *output = [api determineHostLanguageWithError:&error];
