...
@class PigeonError;
@class NSNumber;
@class MessageDataBridge;
/// Generated setup class from Pigeon to register implemented ExampleHostApi
/// classes.
...
- (NSString* _Nullable)determineHostLanguageWithWrappedError:
    (PigeonError* _Nonnull)wrappedError SWIFT_WARN_UNUSED_RESULT;
- (NSNumber* _Nullable)addWithA:(int64_t)a
                              b:(int64_t)b
                   wrappedError:(PigeonError* _Nonnull)wrappedError
    SWIFT_WARN_UNUSED_RESULT;
- (void)sendMessageWithMessage:(MessageDataBridge* _Nonnull)message
                  wrappedError:(PigeonError* _Nonnull)wrappedError
             completionHandler:
...
- (nonnull instancetype)
    ...
    messageDescription:(NSString* _Nullable)messageDescription
                  code:(enum Code)code
                  data:(NSDictionary<id<NSCopying>, NSObject*>* _Nonnull)data
    OBJC_DESIGNATED_INITIALIZER;
@property(nonatomic, strong) NSString* _Nullable name;
@property(nonatomic, strong) NSString* _Nullable messageDescription;
@property(nonatomic) enum Code code;
@property(nonatomic, copy)
    NSDictionary<id<NSCopying>, NSObject*>* _Nonnull data;
