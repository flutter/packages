...
G_DECLARE_FINAL_TYPE(
    ...
    PIGEON_EXAMPLE_PACKAGE, EXAMPLE_HOST_API_DETERMINE_HOST_LANGUAGE_RESPONSE,
    GObject)

/**
 * pigeon_example_package_example_host_api_determine_host_language_response_new:
 *
 * Creates a new response to ExampleHostApi.determineHostLanguage.
 *
 * Returns: a new
 * #PigeonExamplePackageExampleHostApiDetermineHostLanguageResponse
 */
 ...
 *
 * Creates a new error response to ExampleHostApi.determineHostLanguage.
 *
 * Returns: a new
 * #PigeonExamplePackageExampleHostApiDetermineHostLanguageResponse
 */
...
typedef struct {
  PigeonExamplePackageExampleHostApiDetermineHostLanguageResponse* (
      *determine_host_language)(gpointer user_data);
