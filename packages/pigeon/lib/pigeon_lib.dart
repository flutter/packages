...
class _RootBuilder extends dart_ast_visitor.RecursiveAstVisitor<Object?> {
  ...
  NamedType formalParameterToField(dart_ast.FormalParameter parameter) {
    ...
    if (namedType != null) {
      final String argTypeBaseName = namedType.qualifiedName;
      ...
      _currentApi!.methods.add(
        Method(
          ...
          returnType: TypeDeclaration(
              baseName: returnType.qualifiedName,
              typeArguments:
...
extension on dart_ast.NamedType {
  String get qualifiedName {
    final dart_ast.ImportPrefixReference? importPrefix = this.importPrefix;
