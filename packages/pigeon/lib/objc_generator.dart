...
const Map<String, String> _objcTypeForDartTypeMap = {
  'bool': 'NSNumber *',
  'int': 'NSNumber *',
  'String': 'NSString *',
  'double': 'NSNumber *',
...
const Map<String, String> _propertyTypeForDartTypeMap = {
  'String': 'copy',
  'bool': 'strong',
  'int': 'strong',
  'double': 'strong',
...
void generateObjcSource(ObjcOptions options, Root root, StringSink sink) {
  ...
  final List<String> classnames = root.classes.map((x) => x.name).toList();
