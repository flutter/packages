...
abstract class InternalOptions {
  ...
  Iterable<String>? get copyrightHeader;
}
...
abstract class StructuredGenerator<T extends InternalOptions>
  ...
  ///
  /// This provides a default implementation of `writeFilePrologue` directly in
  /// `StructuredGenerator`. It handles appending the user-defined
  /// `copyrightHeader`, followed by the standard autogenerated warning.
  ///
  /// Languages needing additional specific lines (like Dart or Kotlin adding
  /// `@Suppress` or `ignore_for_file`) should override this method, call
  /// `super.writeFilePrologue(...)`, and then append their specific lines.
