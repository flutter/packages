  ...
  await SwiftGenerator(
    ...
    inputs: <SwiftGenInput>[
      ObjCCompatibleSwiftFileInput(
        files: <Uri>[
          Uri.file(
            '/Users/tarrinneal/work/packages/packages/pigeon/platform_tests/test_plugin/darwin/test_plugin/Sources/test_plugin/NativeInteropTests.gen.swift',
          ),
        ],
      ),
    ],
    ...
    output: Output(
      module: 'test_plugin',
      dartFile: Uri.file(
        '/Users/tarrinneal/work/packages/packages/pigeon/platform_tests/shared_test_plugin_code/lib/src/generated/native_interop_tests.gen.ffi.dart',
      ),
      objectiveCFile: Uri.file(
        '/Users/tarrinneal/work/packages/packages/pigeon/platform_tests/test_plugin/darwin/test_plugin/Sources/test_plugin_objc_gen/NativeInteropTests.gen.m',
      ),
      preamble: '''
