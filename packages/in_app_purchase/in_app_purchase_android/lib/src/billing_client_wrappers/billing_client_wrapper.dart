...
class BillingClient {
  ...
  Future<PurchasesHistoryResult> queryPurchaseHistory(ProductType productType) async {
    return purchaseHistoryResultFromPlatform(
      await _hostApi.queryPurchaseHistoryAsync(platformProductTypeFromWrapper(productType)),
    );
  }
