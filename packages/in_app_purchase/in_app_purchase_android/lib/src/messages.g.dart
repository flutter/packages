...
class PlatformQueryProduct {
  ...
  bool operator ==(Object other) {
    if (other is! PlatformQueryProduct || other.runtimeType != runtimeType) {
      return false;
    }
...
class PlatformBillingResult {
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! PlatformBillingResult || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
    }
    return _deepEquals(responseCode, other.responseCode) && _deepEquals(debugMessage, other.debugMessage) && _deepEquals(subResponseCode, other.subResponseCode);
  }
...
class PlatformProductDetails {
  ...
  static PlatformProductDetails decode(Object result) {
    ...
    return PlatformProductDetails(
      ...
      oneTimePurchaseOfferDetailsList: (result[6] as List<Object?>?)?.cast<PlatformOneTimePurchaseOfferDetails>(),
      subscriptionOfferDetails: (result[7] as List<Object?>?)?.cast<PlatformSubscriptionOfferDetails>(),
    );
  }
...
class PlatformProductDetailsResponse {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(billingResult, other.billingResult) && _deepEquals(productDetails, other.productDetails) && _deepEquals(unfetchedProductList, other.unfetchedProductList);
  }
...
class PlatformPricingPhase {
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! PlatformPricingPhase || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
...
class PlatformSubscriptionOfferDetails {
  ...
  static PlatformSubscriptionOfferDetails decode(Object result) {
    ...
    return PlatformSubscriptionOfferDetails(
      ...
      pricingPhases: (result[4]! as List<Object?>).cast<PlatformPricingPhase>(),
...
class PlatformUserChoiceDetails {
  ...
  static PlatformUserChoiceDetails decode(Object result) {
    ...
    return PlatformUserChoiceDetails(
      ...
      externalTransactionToken: result[1]! as String,
      products: (result[2]! as List<Object?>).cast<PlatformUserChoiceProduct>(),
    );
  }
...
class PlatformPendingPurchasesParams {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(enablePrepaidPlans, other.enablePrepaidPlans);
  }
