...
public class Messages {
  ...
  public interface InAppPurchaseApi {
    ...
    void startConnection(@NonNull Long callbackHandle, @NonNull PlatformBillingChoiceMode billingMode, @NonNull PendingPurchasesParams pendingPurchasesParams, @NonNull Result<PlatformBillingResult> result);
        ...
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ...
                PendingPurchasesParams pendingPurchasesParamsArg = (PendingPurchasesParams) args.get(2);
