...
class SK2SubscriptionPeriodMessage {
  ...
  static SK2SubscriptionPeriodMessage decode(Object result) {
    ...
    return SK2SubscriptionPeriodMessage(
      ...
      unit: SK2SubscriptionPeriodUnitMessage.values[result[1]! as int],
    );
  }
}
...
class SK2ProductMessage {
  ...
  static SK2ProductMessage decode(Object result) {
    ...
    return SK2ProductMessage(
      ...
      type: SK2ProductTypeMessage.values[result[5]! as int],
      subscription: result[6] != null
          ? SK2SubscriptionInfoMessage.decode(result[6]! as List<Object?>)
          : null,
      priceLocale: SK2PriceLocaleMessage.decode(result[7]! as List<Object?>),
    );
  }
}
...
class _InAppPurchase2APICodec extends StandardMessageCodec {
  const _InAppPurchase2APICodec();
  @override
...
class InAppPurchase2API {
  ...
  InAppPurchase2API({BinaryMessenger? binaryMessenger})
