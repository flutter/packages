...
interface SharedPreferencesApi {
  ...
  fun setString(key: String, value: String, options: SharedPreferencesPigeonOptions): Boolean
  /** Adds property to shared preferences data set of type int. */
  fun setInt(key: String, value: Long, options: SharedPreferencesPigeonOptions): Boolean
  /** Adds property to shared preferences data set of type double. */
  fun setDouble(key: String, value: Double, options: SharedPreferencesPigeonOptions): Boolean
  /** Adds property to shared preferences data set of type List<String>. */
  fun setStringList(key: String, value: List<String>, options: SharedPreferencesPigeonOptions): Boolean
  ...
  fun clear(allowList: List<String>?, options: SharedPreferencesPigeonOptions): Boolean
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            try {
              wrapped = listOf<Any?>(api.setBool(keyArg, valueArg, optionsArg))
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            var wrapped: List<Any?>
            try {
              wrapped = listOf<Any?>(api.setString(keyArg, valueArg, optionsArg))
            } catch (exception: Throwable) {
              wrapped = wrapError(exception)
            }
            reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            var wrapped: List<Any?>
            try {
              wrapped = listOf<Any?>(api.setInt(keyArg, valueArg, optionsArg))
            } catch (exception: Throwable) {
              wrapped = wrapError(exception)
            }
            reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            var wrapped: List<Any?>
            try {
              wrapped = listOf<Any?>(api.setDouble(keyArg, valueArg, optionsArg))
            } catch (exception: Throwable) {
              wrapped = wrapError(exception)
            }
            reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            var wrapped: List<Any?>
            try {
              wrapped = listOf<Any?>(api.setStringList(keyArg, valueArg, optionsArg))
            } catch (exception: Throwable) {
              wrapped = wrapError(exception)
            }
            reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            var wrapped: List<Any?>
            try {
              wrapped = listOf<Any?>(api.clear(allowListArg, optionsArg))
            } catch (exception: Throwable) {
              wrapped = wrapError(exception)
            }
            reply.reply(wrapped)
