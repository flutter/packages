      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
            .setMockDecodedMessageHandler<Object?>(channel,
                (Object? message) async {
          assert(message != null,
              'Argument for dev.flutter.pigeon.SharedPreferencesApi.clearWithPrefix was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final String? arg_prefix = (args[0] as String?);
          assert(arg_prefix != null,
              'Argument for dev.flutter.pigeon.SharedPreferencesApi.clearWithPrefix was null, expected non-null String.');
          final bool output = api.clearWithPrefix(arg_prefix!);
          return <Object?>[output];
        });
      }
    }
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
            .setMockDecodedMessageHandler<Object?>(channel,
                (Object? message) async {
          assert(message != null,
              'Argument for dev.flutter.pigeon.SharedPreferencesApi.getAllWithPrefix was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final String? arg_prefix = (args[0] as String?);
          assert(arg_prefix != null,
              'Argument for dev.flutter.pigeon.SharedPreferencesApi.getAllWithPrefix was null, expected non-null String.');
