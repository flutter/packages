...
void main() {
  ...
  group('SharedPreferencesLinux', () {
    ...
    group('withPrefix', () {
      ...
      testWidgets('get all with prefix', (WidgetTester _) async {
        final Map<String, Object> values = await preferences.getAllWithPrefix('prefix.');
      ...
      testWidgets('clearWithPrefix', (WidgetTester _) async {
        ...
        Map<String, Object> values = await preferences.getAllWithPrefix('prefix.');
  ...
  group('shared_preferences_async', () {
    ...
    Future<SharedPreferencesAsyncPlatform> getPreferences({bool clear = true}) async {
    ...
    testWidgets('getStringList does not throw cast error', (WidgetTester _) async {
      final SharedPreferencesAsyncPlatform preferences = await getPreferences();
