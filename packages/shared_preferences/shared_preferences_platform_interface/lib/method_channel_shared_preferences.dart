...
class MethodChannelSharedPreferencesStore extends SharedPreferencesStorePlatform {
  ...
  Future<bool> remove(String key) async {
    return (await _kChannel.invokeMethod<bool>('remove', <String, dynamic>{'key': key}))!;
  }

  @override
  Future<bool> setValue(String valueType, String key, Object value) async {
    return (await _kChannel.invokeMethod<bool>('set$valueType', <String, dynamic>{
      'key': key,
      'value': value,
    }))!;
  }
  ...
  Future<bool> clearWithParameters(ClearParameters parameters) async {
    ...
    return (await _kChannel.invokeMethod<bool>('clearWithParameters', <String, dynamic>{
  ...
  Future<Map<String, Object>> getAll() async {
    return await _kChannel.invokeMapMethod<String, Object>('getAll') ?? <String, Object>{};
  }

  @override
  @Deprecated('Use getAllWithParameters instead')
  Future<Map<String, Object>> getAllWithPrefix(String prefix, {Set<String>? allowList}) async {
  ...
  Future<Map<String, Object>> getAllWithParameters(GetAllParameters parameters) async {
    ...
    return await _kChannel.invokeMapMethod<String, Object>(
          ...
          <String, dynamic>{'prefix': filter.prefix, 'allowList': allowListAsList},
        ) ??
        <String, Object>{};
  }
}
