  ...
  group('Async', () {
    ...
    test('getAll', () async {
      ...
      final Map<String, Object?> gotAll = await preferences
          .getAll(const GetPreferencesParameters(filter: PreferencesFilter()));
    ...
    test('getKeys', () async {
      ...
      final Set<String?> keys = await preferences
          .getKeys(const GetPreferencesParameters(filter: PreferencesFilter()));
    ...
    test('clear', () async {
      ...
      store.log.clear();
      await preferences
          .clear(const ClearParameters(filter: PreferencesFilter()));
      expect(
    ...
    setUp(() async {
      ...
      preferences = SharedPreferencesWithCache(
        ...
        cacheOptions: SharedPreferencesWithCacheOptions(
          filter: const PreferencesFilter(),
        ),
      );
  ...
  group('withCache with filter', () {
    ...
    setUp(() async {
      ...
      preferences = SharedPreferencesWithCache(
        ...
        cacheOptions: SharedPreferencesWithCacheOptions(
          filter:
              const PreferencesFilter(allowList: <String>{stringKey, boolKey}),
        ),
      );
...
base class FakeSharedPreferencesAsync
  ...
  @override
  Future<bool> clear(
      ClearParameters parameters, SharedPreferencesOptions options) {
