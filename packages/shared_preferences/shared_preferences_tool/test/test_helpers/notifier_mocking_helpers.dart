...
@GenerateNiceMocks(<MockSpec<dynamic>>[MockSpec<SharedPreferencesStateNotifier>()])
...
void setupDummies() {
  setUpAll(() {
    provideDummy(
      const AsyncState<SharedPreferencesData>.data(SharedPreferencesData.int(value: 42)),
    );
    provideDummy(const AsyncState<SharedPreferencesState>.data(SharedPreferencesState()));
  });
}
