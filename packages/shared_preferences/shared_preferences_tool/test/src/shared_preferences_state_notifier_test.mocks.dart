...
class MockSharedPreferencesToolEval extends _i1.Mock implements _i3.SharedPreferencesToolEval {
  ...
  @override
  _i2.Future<void> deleteKey(String? key, bool? legacy) => (super.noSuchMethod(
...
class MockConnectedApp extends _i1.Mock implements _i6.ConnectedApp {
  ...
  _i2.Completer<bool> get initialized => (super.noSuchMethod(
    ...
    returnValueForMissingStub: _FakeCompleter_0<bool>(this, Invocation.getter(#initialized)),
  ...
  String get operatingSystem => (super.noSuchMethod(
    ...
    returnValueForMissingStub: _i5.dummyValue<String>(this, Invocation.getter(#operatingSystem)),
  ) as String);
  ...
  @override
  _i2.Future<void> initializeValues({void Function()? onComplete}) => (super.noSuchMethod(
