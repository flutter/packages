...
#pragma clang attribute push(                                             \
    __attribute__((external_source_symbol(                                \
        language = "Swift", defined_in = "shared_preferences_foundation", \
...
/// LegacyUserDefaultsApi classes.
SWIFT_CLASS("_TtC29shared_preferences_foundation26LegacyUserDefaultsApiSetup")
@interface LegacyUserDefaultsApiSetup : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
+ (LegacyUserDefaultsApiSetup* _Nullable)getInstanceWithName:
    (NSString* _Nonnull)name SWIFT_WARN_UNUSED_RESULT;
- (void)removeWithKey:(NSString* _Nonnull)key
         wrappedError:(PigeonError* _Nonnull)wrappedError;
- (void)setBoolWithKey:(NSString* _Nonnull)key
                 value:(BOOL)value
          wrappedError:(PigeonError* _Nonnull)wrappedError;
- (void)setDoubleWithKey:(NSString* _Nonnull)key
                   value:(double)value
            wrappedError:(PigeonError* _Nonnull)wrappedError;
- (void)setValueWithKey:(NSString* _Nonnull)key
                  value:(NSObject* _Nonnull)value
           wrappedError:(PigeonError* _Nonnull)wrappedError;
- (NSDictionary<id<NSCopying>, NSObject*>* _Nullable)
    getAllWithPrefix:(NSString* _Nonnull)prefix
           allowList:(NSArray<NSObject*>* _Nullable)allowList
        wrappedError:(PigeonError* _Nonnull)wrappedError
    SWIFT_WARN_UNUSED_RESULT;
- (NSNumber* _Nullable)clearWithPrefix:(NSString* _Nonnull)prefix
                             allowList:(NSArray<NSObject*>* _Nullable)allowList
                          wrappedError:(PigeonError* _Nonnull)wrappedError
    SWIFT_WARN_UNUSED_RESULT;
@end

SWIFT_CLASS("_TtC29shared_preferences_foundation21MessagesNumberWrapper")
@interface MessagesNumberWrapper : NSObject <NSCopying>
...
SWIFT_CLASS("_TtC29shared_preferences_foundation26MessagesPigeonInternalNull")
@interface MessagesPigeonInternalNull : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class NSData;
SWIFT_CLASS("_TtC29shared_preferences_foundation23MessagesPigeonTypedData")
...
SWIFT_CLASS("_TtC29shared_preferences_foundation11PigeonError")
@interface PigeonError : NSObject
...
/// Objective-C.
SWIFT_CLASS(
    "_TtC29shared_preferences_foundation36SharedPreferencesPigeonOptionsBridge")
@interface SharedPreferencesPigeonOptionsBridge : NSObject
- (nonnull instancetype)initWithSuiteName:(NSString* _Nullable)suiteName
    OBJC_DESIGNATED_INITIALIZER;
@property(nonatomic, strong) NSString* _Nullable suiteName;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

/// Generated setup class from Pigeon to register implemented UserDefaultsApi
/// classes.
SWIFT_CLASS("_TtC29shared_preferences_foundation20UserDefaultsApiSetup")
@interface UserDefaultsApiSetup : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
+ (UserDefaultsApiSetup* _Nullable)getInstanceWithName:(NSString* _Nonnull)name
    SWIFT_WARN_UNUSED_RESULT;
/// Adds property to shared preferences data set of type String.
- (void)setWithKey:(NSString* _Nonnull)key
             value:(NSObject* _Nonnull)value
           options:(SharedPreferencesPigeonOptionsBridge* _Nonnull)options
      wrappedError:(PigeonError* _Nonnull)wrappedError;
/// Removes all properties from shared preferences data set with matching
/// prefix.
- (void)clearWithAllowList:(NSArray<NSObject*>* _Nullable)allowList
                   options:
                       (SharedPreferencesPigeonOptionsBridge* _Nonnull)options
              wrappedError:(PigeonError* _Nonnull)wrappedError;
/// Gets all properties from shared preferences data set with matching prefix.
- (NSDictionary<id<NSCopying>, NSObject*>* _Nullable)
    getAllWithAllowList:(NSArray<NSObject*>* _Nullable)allowList
                options:(SharedPreferencesPigeonOptionsBridge* _Nonnull)options
           wrappedError:(PigeonError* _Nonnull)wrappedError
    SWIFT_WARN_UNUSED_RESULT;
/// Gets individual value stored with [key], if any.
- (NSObject* _Nullable)
    getValueWithKey:(NSString* _Nonnull)key
            options:(SharedPreferencesPigeonOptionsBridge* _Nonnull)options
       wrappedError:(PigeonError* _Nonnull)wrappedError
    SWIFT_WARN_UNUSED_RESULT;
/// Gets all properties from shared preferences data set with matching prefix.
- (NSArray<NSObject*>* _Nullable)
    getKeysWithAllowList:(NSArray<NSObject*>* _Nullable)allowList
                 options:(SharedPreferencesPigeonOptionsBridge* _Nonnull)options
            wrappedError:(PigeonError* _Nonnull)wrappedError
    SWIFT_WARN_UNUSED_RESULT;
@end
