...
import 'package:shared_preferences_foundation/shared_preferences_async_foundation.dart';
...
void main() {
  ...
  late SharedPreferencesAsyncFoundation preferences;
  ...
  setUp(() async {
    ...
    preferences = SharedPreferencesAsyncFoundation(api: api);
  });
