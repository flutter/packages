...
abstract class TestSharedPreferencesAsyncApi {
  ...
  List<String?>? getStringList(
      String key, SharedPreferencesPigeonOptions options);
  ...
  static void setup(TestSharedPreferencesAsyncApi? api,
      ...
      if (api == null) {
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
            .setMockDecodedMessageHandler<Object?>(__pigeon_channel,
                (Object? message) async {
          assert(message != null,
              'Argument for dev.flutter.pigeon.shared_preferences_foundation.UserDefaultsApi.getString was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final String? arg_key = (args[0] as String?);
          assert(arg_key != null,
              'Argument for dev.flutter.pigeon.shared_preferences_foundation.UserDefaultsApi.getString was null, expected non-null String.');
          final SharedPreferencesPigeonOptions? arg_options =
              (args[1] as SharedPreferencesPigeonOptions?);
          assert(arg_options != null,
    ...
    }
    {
      final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<
              Object?>(
          'dev.flutter.pigeon.shared_preferences_foundation.UserDefaultsApi.getStringList',
          pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        _testBinaryMessengerBinding!.defaultBinaryMessenger
        ...
        _testBinaryMessengerBinding!.defaultBinaryMessenger
            .setMockDecodedMessageHandler<Object?>(__pigeon_channel,
                (Object? message) async {
          assert(message != null,
              'Argument for dev.flutter.pigeon.shared_preferences_foundation.UserDefaultsApi.getStringList was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final String? arg_key = (args[0] as String?);
          assert(arg_key != null,
              'Argument for dev.flutter.pigeon.shared_preferences_foundation.UserDefaultsApi.getStringList was null, expected non-null String.');
          final SharedPreferencesPigeonOptions? arg_options =
              (args[1] as SharedPreferencesPigeonOptions?);
          assert(arg_options != null,
              'Argument for dev.flutter.pigeon.shared_preferences_foundation.UserDefaultsApi.getStringList was null, expected non-null SharedPreferencesPigeonOptions.');
          try {
            final List<String?>? output =
                api.getStringList(arg_key!, arg_options!);
            return <Object?>[output];
          } on PlatformException catch (e) {
            return wrapResponse(error: e);
          } catch (e) {
