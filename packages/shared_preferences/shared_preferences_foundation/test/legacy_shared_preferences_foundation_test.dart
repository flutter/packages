...
import 'package:shared_preferences_foundation/legacy_shared_preferences_foundation.dart';
...
void main() {
  ...
  test('registerWith', () async {
    ...
    expect(SharedPreferencesStorePlatform.instance,
        isA<LegacySharedPreferencesFoundation>());
  });

  test('remove', () async {
    final LegacySharedPreferencesFoundation plugin =
        LegacySharedPreferencesFoundation();
