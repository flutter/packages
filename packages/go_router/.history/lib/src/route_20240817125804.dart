...
class GoRoute extends RouteBase {
  ...
  RegExpMatch? matchPatternAsPrefix(String loc) {
    ...
    final RegExpMatch? pathMatch =
        _pathRE.matchAsPrefix(uri.path) as RegExpMatch?;
    ...
    if (fragment != null && fragment != uri.fragment) {
      return null;
    }
    return pathMatch;
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(StringProperty('fragment', fragment));
    properties.add(
