  ...
  group('onEnter', () {
      ...
      router = GoRouter(
        ...
        routes: <RouteBase>[
          GoRoute(
            ...
            builder:
                (_, __) => const Scaffold(body: Center(child: Text('Home Screen'))), // Unique text
          ),
          GoRoute(
            path: '/protected',
      ...
      router = GoRouter(
        ...
        routes: <RouteBase>[
          GoRoute(
            ...
            routes: <RouteBase>[
              GoRoute(path: 'b', builder: (_, __) => const Scaffold(body: Text('B'))),
            ],
          ),
        ],
      );
    ...
    testWidgets('restore navigation calls onEnter for re-validation', (WidgetTester tester) async {
      ...
      router = GoRouter(
        ...
        routes: <RouteBase>[
          ...
          GoRoute(path: '/protected', builder: (_, __) => const Scaffold(body: Text('Protected'))),
        ],
      );
    ...
    testWidgets('goNamed supports fragment (hash) and preserves it in state.uri', (
      ...
      router = GoRouter(
        initialLocation: '/',
        routes: <RouteBase>[
          GoRoute(path: '/', builder: (_, __) => const Scaffold(body: Center(child: Text('Root')))),
          GoRoute(
            path: '/article/:id',
            name: 'article',
    ...
    testWidgets('onEnter blocking prevents stale state restoration (pop case)', (
      ...
      router = GoRouter(
        initialLocation: '/home',
        onEnter:
            (_, __, GoRouterState next, ___) =>
                next.uri.path == '/blocked' ? const Block.stop() : const Allow(),
        routes: <RouteBase>[
          GoRoute(path: '/home', builder: (_, __) => const Scaffold(body: Text('Home'))),
          GoRoute(path: '/allowed', builder: (_, __) => const Scaffold(body: Text('Allowed'))),
          GoRoute(path: '/blocked', builder: (_, __) => const Scaffold(body: Text('Blocked'))),
        ],
      );
