...
class _ShellRouteDataPageBuilder extends ShellRouteData {
  ...
  Page<void> pageBuilder(BuildContext context, GoRouterState state, Widget navigator) =>
      MaterialPage<void>(child: SizedBox(key: const Key('page-builder'), child: navigator));
}
            ...
            routes: <RouteBase>[
              GoRouteData.$route(
                ...
                routes: <RouteBase>[
                  ShellRouteData.$route(
                    factory:
                        (GoRouterState state) => const _ShellRouteDataWithKey(Key('above-shell')),
                    navigatorKey: inner,
                    ...
                    routes: <RouteBase>[
                      GoRouteData.$route(
                        ...
                        path: 'test',
                        factory:
                            (GoRouterState state) => const _GoRouteDataBuildWithKey(Key('above')),
                      ),
                    ],
                  ),
                ],
