...
void main() {
  ...
  group('path routes', () {
    ...
    testWidgets('repeatedly pops imperative route does not crash', (WidgetTester tester) async {
      ...
      final routes = <GoRoute>[
        GoRoute(path: '/', builder: (_, __) => DummyScreen(key: home)),
        GoRoute(path: '/settings', builder: (_, __) => DummyScreen(key: settings)),
      ];
      ...
      showDialog<void>(context: navKey.currentContext!, builder: (_) => DummyScreen(key: dialog));
      await tester.pumpAndSettle();
    ...
    testWidgets('can correctly pop stacks of repeated pages', (WidgetTester tester) async {
      ...
      final navKey = GlobalKey<NavigatorState>();
      final routes = <GoRoute>[
        GoRoute(path: '/', pageBuilder: (_, __) => const MaterialPage<Object>(child: HomeScreen())),
        GoRoute(
          path: '/page1',
    ...
    testWidgets('Handles the Android back button correctly with ShellRoute', (
      ...
      final routes = <RouteBase>[
        ShellRoute(
          builder: (BuildContext context, GoRouterState state, Widget child) {
            return Scaffold(appBar: AppBar(title: const Text('Shell')), body: child);
          },
          routes: <GoRoute>[
            GoRoute(
              path: '/a',
    ...
    final routes = <GoRoute>[
      GoRoute(
        ...
        pageBuilder: (BuildContext context, GoRouterState state) {
          final String value =
              context.dependOnInheritedWidgetOfExactType<TestInheritedNotifier>()!.notifier!.value;
  ...
  group('report correct url', () {
    ...
    testWidgets('works correctly with async redirect', (WidgetTester tester) async {
      ...
      final routes = <GoRoute>[
        GoRoute(path: '/', builder: (_, __) => const DummyScreen()),
        GoRoute(path: '/login', builder: (_, __) => DummyScreen(key: login)),
      ];
  ...
  group('go relative', () {
    ...
    testWidgets('preserve query param spaces and slashes', (WidgetTester tester) async {
      ...
      final loc =
          Uri(path: 'page1', queryParameters: <String, dynamic>{'param1': param1}).toString();
      router.go('./$loc');
    ...
    testWidgets('error thrown during redirect can be caught by onException', (
      ...
      final routes = <GoRoute>[
        ...
        GoRoute(
          path: '/trigger-error',
          builder:
              (BuildContext context, GoRouterState state) => const Text('should not reach here'),
        ),
      ];
    ...
    test('error: duplicate path param', () {
      try {
        GoRouter(
          ...
          errorBuilder:
              (BuildContext context, GoRouterState state) => TestErrorScreen(state.error!),
    ...
    testWidgets('Pops from the correct Navigator when the Android back button is pressed', (
      ...
      final routes = <RouteBase>[
        ShellRoute(
          builder: (BuildContext context, GoRouterState state, Widget child) {
            return Scaffold(
              body: Column(children: <Widget>[const Text('Screen A'), Expanded(child: child)]),
            );
          },
          routes: <RouteBase>[
            GoRoute(
                ...
                StatefulShellBranch(
                  routes: <GoRoute>[
                    GoRoute(
                      path: 'a',
                      builder:
                          (BuildContext context, GoRouterState state) => const Text('Screen A'),
                    ),
                  ],
                ),
                StatefulShellBranch(
                  routes: <GoRoute>[
                    GoRoute(
                      path: 'b',
                      builder:
                          (BuildContext context, GoRouterState state) => const Text('Screen B'),
                    ),
                  ],
                ),
              ],
                ...
                GoRoute(
                  ...
                  routes: <RouteBase>[
                    GoRoute(
                      path: 'detailA',
                      builder:
                          (BuildContext context, GoRouterState state) => Column(
                            children: <Widget>[
                    ...
                    StatefulShellBranch(
                      routes: <RouteBase>[
                        GoRoute(
                          path: '/c',
                          builder:
                              (BuildContext context, GoRouterState state) => const Text('Screen C'),
                        ),
                      ],
                    ),
                  ],
          ...
          routes: <RouteBase>[
            ShellRoute(
              ...
              builder: (BuildContext context, GoRouterState state, Widget child) {
                return Scaffold(
                  body: Center(
                    child: Column(children: <Widget>[const Text('Shell'), Expanded(child: child)]),
                  ),
                );
              },
                ...
                ShellRoute(
                  ...
                  builder: (BuildContext context, GoRouterState state, Widget child) {
                    return Scaffold(
                      body: Center(
                        child: Column(
                          children: <Widget>[const Text('Shell'), Expanded(child: child)],
                        ),
                      ),
                    );
                  },
  ...
  group('of', () {
    testWidgets('It should return the go router instance of the widget tree', (
      ...
      const key = Key('key');
      final routes = <RouteBase>[GoRoute(path: '/', builder: (_, __) => const SizedBox(key: key))];
          ...
          GoRoute(
            ...
            routes: <RouteBase>[
              GoRoute(
                ...
                builder:
                    (BuildContext context, GoRouterState state) => const Text('/grand-child-route'),
              ),
              GoRoute(
