...
abstract class RouteMatchBase with Diagnosticable {
  ...
  static Map<GlobalKey<NavigatorState>?, List<RouteMatchBase>> _matchByNavigatorKeyForShellRoute({
    ...
    final GlobalKey<NavigatorState>? parentKey =
        route.parentNavigatorKey == scopedNavigatorKey ? null : route.parentNavigatorKey;
  ...
  static Map<GlobalKey<NavigatorState>?, List<RouteMatchBase>> _matchByNavigatorKeyForGoRoute({
    ...
    final Map<String, String> currentPathParameter = encodedParams
        .map<String, String>((String key, String value) => MapEntry<String, String>(key, Uri.decodeComponent(value)));
    ...
    final String childRestLoc = uri.path.substring(newMatchedLocation.length + (newMatchedLocation == '/' ? 0 : 1));
...
class ImperativeRouteMatch extends RouteMatch {
  ...
  @override
  bool operator ==(Object other) {
    return other is ImperativeRouteMatch && completer == other.completer && matches == other.matches && super == other;
  }
...
class RouteMatchList with Diagnosticable {
  ...
  static RouteMatchList empty =
      RouteMatchList(matches: const <RouteMatchBase>[], uri: Uri(), pathParameters: const <String, String>{});
  ...
  static String _generateFullPath(Iterable<RouteMatchBase> matches) {
    ...
    for (final RouteMatchBase match in matches.where((RouteMatchBase match) => match is! ImperativeRouteMatch)) {
      if (addsSlash) {
        buffer.write('/');
      }
  ...
  static List<RouteMatchBase> _createNewMatchUntilIncompatible(
    ...
    if (otherMatches.last is ShellRouteMatch &&
      ...
      final ShellRouteMatch lastShellRouteMatch = newMatches.removeLast() as ShellRouteMatch;
      newMatches.add(
        // Create a new copy of the `lastShellRouteMatch`.
        lastShellRouteMatch.copyWith(
          matches: _createNewMatchUntilIncompatible(
              lastShellRouteMatch.matches, (otherMatches.last as ShellRouteMatch).matches, match),
        ),
      );
      return newMatches;
    }
  ...
  static RouteMatchBase _cloneBranchAndInsertImperativeMatch(RouteMatchBase branch, ImperativeRouteMatch match) {
  ...
  RouteMatchList remove(RouteMatchBase match) {
    ...
    final Map<String, String> newPathParameters = Map<String, String>.fromEntries(
      pathParameters.entries.where((MapEntry<String, String> value) => validParameters.contains(value.key)),
    );
  ...
  /// order is removed.
  static List<RouteMatchBase> _removeRouteMatchFromList(List<RouteMatchBase> matches, RouteMatchBase target) {
  ...
  int get hashCode {
    return Object.hash(
      ...
      Object.hashAllUnordered(
        pathParameters.entries.map<int>((MapEntry<String, String> entry) => Object.hash(entry.key, entry.value)),
      ),
    );
  }
...
class _RouteMatchListEncoder extends Converter<RouteMatchList, Map<Object?, Object?>> {
  ...
  Map<Object?, Object?> convert(RouteMatchList input) {
    final List<ImperativeRouteMatch> imperativeMatches = <ImperativeRouteMatch>[];
    ...
    final List<Map<Object?, Object?>> encodedImperativeMatches = imperativeMatches
        .map((ImperativeRouteMatch e) =>
            _toPrimitives(e.matches.uri.toString(), e.matches.extra, pageKey: e.pageKey.value))
        .toList();

    return _toPrimitives(input.uri.toString(), input.extra, imperativeMatches: encodedImperativeMatches);
  }
...
class _RouteMatchListDecoder extends Converter<Map<Object?, Object?>, RouteMatchList> {
  ...
  RouteMatchList convert(Map<Object?, Object?> input) {
    final String rootLocation = input[RouteMatchListCodec._locationKey]! as String;
    final Map<Object?, Object?> encodedExtra = input[RouteMatchListCodec._extraKey]! as Map<Object?, Object?>;
    final Object? extra;
    ...
    RouteMatchList matchList = configuration.findMatch(rootLocation, extra: extra);

    final List<Object?>? imperativeMatches = input[RouteMatchListCodec._imperativeMatchesKey] as List<Object?>?;
    if (imperativeMatches != null) {
      for (final Map<Object?, Object?> encodedImperativeMatch in imperativeMatches.whereType<Map<Object?, Object?>>()) {
        final RouteMatchList imperativeMatchList = convert(encodedImperativeMatch);
        final ValueKey<String> pageKey =
            ValueKey<String>(encodedImperativeMatch[RouteMatchListCodec._pageKey]! as String);
