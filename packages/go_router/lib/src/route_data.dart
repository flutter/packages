...
_GoRouteParameters _createGoRouteParameters<T extends _GoRouteDataBase>({
  ...
  return _GoRouteParameters(
    ...
    pageBuilder:
        (BuildContext context, GoRouterState state) => factoryImpl(state).buildPage(context, state),
    redirect:
        (BuildContext context, GoRouterState state) => factoryImpl(state).redirect(context, state),
    onExit:
