...
void main() {
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final StatelessElement destMaterialElement = tester.firstElement(
        find.ancestor(
          of: find.text('Closed'),
          matching: find.byType(Material),
        ),
      ...
      expect(find.text('Open'), findsOneWidget);
      final StatelessElement finalMaterialElement = tester.firstElement(
        find.ancestor(
          of: find.text('Open'),
          matching: find.byType(Material),
        ),
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(find.text('Open'), findsOneWidget);
      final StatelessElement initialMaterialElement = tester.firstElement(
        find.ancestor(
          of: find.text('Open'),
          matching: find.byType(Material),
        ),
      ...
      expect(find.text('Closed'), findsOneWidget);
      expect(find.text('Open'), findsOneWidget);
      final StatelessElement materialElement = tester.firstElement(
        find.ancestor(
          of: find.text('Open'),
          matching: find.byType(Material),
        ),
