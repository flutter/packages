...
/// A animated builder that animates its [child] with different transitions
/// based on the [AnimationStatus] of the provided [animation].
///
...
class DualTransitionBuilder extends StatefulWidget {
  ...
  /// A builder for a transition that wraps [child].
  ///
  ...
  ///
  /// This builder should be used to create the animation that makes the [child]
  /// appear on screen. The [child] should be fully visible when the `animation`
  /// reaches 1.0.
  ///
  ...
  ///
  /// This builder should be used to create the animation that makes the [child]
  /// disappear from the screen. The [child] should be fully invisible when the
  ...
  ///
  /// This widget will be wrapped by the transitions built by
