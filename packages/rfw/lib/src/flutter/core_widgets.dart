...
Map<String, LocalWidgetBuilder> get _coreWidgetsDefinitions => <String, LocalWidgetBuilder>{
  ...
  'ClipRRect': (BuildContext context, DataSource source) {
    return ClipRRect(
      ...
      clipBehavior:
          ArgumentDecoders.enumValue<Clip>(Clip.values, source, ['clipBehavior']) ?? Clip.antiAlias,
      child: source.optionalChild(['child']),
    );
  },
  ...
  'Container': (BuildContext context, DataSource source) {
    return AnimatedContainer(
      ...
      clipBehavior:
          ArgumentDecoders.enumValue<Clip>(Clip.values, source, ['clipBehavior']) ?? Clip.none,
      onEnd: source.voidHandler(['onEnd']),
      child: source.optionalChild(['child']),
    );
  },
  ...
  'DefaultTextStyle': (BuildContext context, DataSource source) {
    return AnimatedDefaultTextStyle(
      ...
      overflow:
          ArgumentDecoders.enumValue<TextOverflow>(TextOverflow.values, source, ['overflow']) ??
          TextOverflow.clip,
      maxLines: source.v<int>(['maxLines']),
      textWidthBasis:
          ArgumentDecoders.enumValue<TextWidthBasis>(TextWidthBasis.values, source, [
            'textWidthBasis',
          ]) ??
  ...
  'Directionality': (BuildContext context, DataSource source) {
    return Directionality(
      textDirection:
          ArgumentDecoders.enumValue<TextDirection>(TextDirection.values, source, [
            'textDirection',
          ]) ??
          TextDirection.ltr,
      child: source.child(['child']),
  ...
  'Expanded': (BuildContext context, DataSource source) {
    return Expanded(flex: source.v<int>(['flex']) ?? 1, child: source.child(['child']));
  },
  ...
  'GestureDetector': (BuildContext context, DataSource source) {
    return GestureDetector(
      ...
      behavior: ArgumentDecoders.enumValue<HitTestBehavior>(HitTestBehavior.values, source, [
        'behavior',
      ]),
      child: source.optionalChild(['child']),
    );
  ...
  'GridView': (BuildContext context, DataSource source) {
    return GridView.builder(
      scrollDirection:
          ArgumentDecoders.enumValue<Axis>(Axis.values, source, ['scrollDirection']) ??
          Axis.vertical,
      ...
      dragStartBehavior:
          ArgumentDecoders.enumValue<DragStartBehavior>(DragStartBehavior.values, source, [
            'dragStartBehavior',
          ]) ??
      ...
      clipBehavior:
          ArgumentDecoders.enumValue<Clip>(Clip.values, source, ['clipBehavior']) ?? Clip.hardEdge,
    );
  },
  ...
  'IntrinsicHeight': (BuildContext context, DataSource source) {
    return IntrinsicHeight(child: source.optionalChild(['child']));
  },
  ...
  'Image': (BuildContext context, DataSource source) {
    return Image(
      ...
      colorBlendMode: ArgumentDecoders.enumValue<BlendMode>(BlendMode.values, source, [
        'blendMode',
      ]),
      fit: ArgumentDecoders.enumValue<BoxFit>(BoxFit.values, source, ['fit']),
      alignment: ArgumentDecoders.alignment(source, ['alignment']) ?? Alignment.center,
      repeat:
          ArgumentDecoders.enumValue<ImageRepeat>(ImageRepeat.values, source, ['repeat']) ??
      ...
      filterQuality:
          ArgumentDecoders.enumValue<FilterQuality>(FilterQuality.values, source, [
            'filterQuality',
          ]) ??
          FilterQuality.low,
    );
  ...
  'ListBody': (BuildContext context, DataSource source) {
    return ListBody(
      mainAxis:
          ArgumentDecoders.enumValue<Axis>(Axis.values, source, ['mainAxis']) ?? Axis.vertical,
      reverse: source.v<bool>(['reverse']) ?? false,
      children: source.childList(['children']),
    );
  },
  ...
  'Rotation': (BuildContext context, DataSource source) {
    return AnimatedRotation(
      ...
      alignment: (ArgumentDecoders.alignment(source, ['alignment']) ?? Alignment.center).resolve(
        Directionality.of(context),
      ),
      filterQuality: ArgumentDecoders.enumValue<FilterQuality>(FilterQuality.values, source, [
        'filterQuality',
      ]),
      onEnd: source.voidHandler(['onEnd']),
      child: source.optionalChild(['child']),
  ...
  'SafeArea': (BuildContext context, DataSource source) {
    return SafeArea(
      ...
      minimum: (ArgumentDecoders.edgeInsets(source, ['minimum']) ?? EdgeInsets.zero).resolve(
        Directionality.of(context),
      ),
  ...
  'SizedBoxExpand': (BuildContext context, DataSource source) {
    return SizedBox.expand(child: source.optionalChild(['child']));
  },

  'SizedBoxShrink': (BuildContext context, DataSource source) {
    return SizedBox.shrink(child: source.optionalChild(['child']));
  },

  'Spacer': (BuildContext context, DataSource source) {
    return Spacer(flex: source.v<int>(['flex']) ?? 1);
  },
  ...
  'Text': (BuildContext context, DataSource source) {
    ...
    return Text(
      ...
      textWidthBasis: ArgumentDecoders.enumValue<TextWidthBasis>(TextWidthBasis.values, source, [
        'textWidthBasis',
      ]),
      textHeightBehavior: ArgumentDecoders.textHeightBehavior(source, ['textHeightBehavior']),
    );
  ...
  'Wrap': (BuildContext context, DataSource source) {
    return Wrap(
      direction:
          ArgumentDecoders.enumValue<Axis>(Axis.values, source, ['direction']) ?? Axis.horizontal,
      alignment:
          ArgumentDecoders.enumValue<WrapAlignment>(WrapAlignment.values, source, ['alignment']) ??
          WrapAlignment.start,
      spacing: source.v<double>(['spacing']) ?? 0.0,
      runAlignment:
          ArgumentDecoders.enumValue<WrapAlignment>(WrapAlignment.values, source, [
            'runAlignment',
          ]) ??
          WrapAlignment.start,
      runSpacing: source.v<double>(['runSpacing']) ?? 0.0,
      crossAxisAlignment:
          ArgumentDecoders.enumValue<WrapCrossAlignment>(WrapCrossAlignment.values, source, [
            'crossAxisAlignment',
          ]) ??
