...
get _coreWidgetsDefinitions => <String, LocalWidgetBuilder>{
  ...
  'Align': (BuildContext context, DataSource source) {
    return AnimatedAlign(
      ...
      curve: ArgumentDecoders.curve(source, ['curve'], context),
      alignment:
          ArgumentDecoders.alignment(source, ['alignment']) ?? Alignment.center,
  ...
  'ColoredBox': (BuildContext context, DataSource source) {
    return ColoredBox(
      color:
          ArgumentDecoders.color(source, ['color']) ?? const Color(0xFF000000),
      child: source.optionalChild(['child']),
    );
  },
  ...
  'Container': (BuildContext context, DataSource source) {
    return AnimatedContainer(
      ...
      foregroundDecoration: ArgumentDecoders.decoration(source, [
      ...
      transformAlignment: ArgumentDecoders.alignment(source, [
        'transformAlignment',
      ]),
      clipBehavior:
          ArgumentDecoders.enumValue<Clip>(Clip.values, source, [
  ...
  'DefaultTextStyle': (BuildContext context, DataSource source) {
    return AnimatedDefaultTextStyle(
      ...
      overflow:
          ArgumentDecoders.enumValue<TextOverflow>(
            TextOverflow.values,
            source,
            ['overflow'],
          ) ??
      ...
      textWidthBasis:
          ArgumentDecoders.enumValue<TextWidthBasis>(
            TextWidthBasis.values,
            source,
            ['textWidthBasis'],
          ) ??
          TextWidthBasis.parent,
      textHeightBehavior: ArgumentDecoders.textHeightBehavior(source, [
        'textHeightBehavior',
      ]),
      onEnd: source.voidHandler(['onEnd']),
      child: source.child(['child']),
  ...
  'Directionality': (BuildContext context, DataSource source) {
    return Directionality(
      textDirection:
          ArgumentDecoders.enumValue<TextDirection>(
            TextDirection.values,
            source,
            ['textDirection'],
          ) ??
  ...
  'FittedBox': (BuildContext context, DataSource source) {
    return FittedBox(
      fit:
          ArgumentDecoders.enumValue<BoxFit>(BoxFit.values, source, ['fit']) ??
          BoxFit.contain,
      alignment:
          ArgumentDecoders.alignment(source, ['alignment']) ?? Alignment.center,
      clipBehavior:
  ...
  'GridView': (BuildContext context, DataSource source) {
    return GridView.builder(
      scrollDirection:
          ArgumentDecoders.enumValue<Axis>(Axis.values, source, [
            'scrollDirection',
          ]) ??
          Axis.vertical,
  ...
  'Image': (BuildContext context, DataSource source) {
    return Image(
      image:
          ArgumentDecoders.imageProvider(source, []) ??
      ...
      alignment:
          ArgumentDecoders.alignment(source, ['alignment']) ?? Alignment.center,
      repeat:
          ArgumentDecoders.enumValue<ImageRepeat>(ImageRepeat.values, source, [
            'repeat',
          ]) ??
      ...
      filterQuality:
          ArgumentDecoders.enumValue<FilterQuality>(
  ...
  'ListBody': (BuildContext context, DataSource source) {
    return ListBody(
      mainAxis:
          ArgumentDecoders.enumValue<Axis>(Axis.values, source, ['mainAxis']) ??
          Axis.vertical,
      reverse: source.v<bool>(['reverse']) ?? false,
      children: source.childList(['children']),
    );
  ...
  'Padding': (BuildContext context, DataSource source) {
    return AnimatedPadding(
      ...
      curve: ArgumentDecoders.curve(source, ['curve'], context),
      padding:
          ArgumentDecoders.edgeInsets(source, ['padding']) ?? EdgeInsets.zero,
      onEnd: source.voidHandler(['onEnd']),
      child: source.optionalChild(['child']),
    );
  },
  ...
  'Placeholder': (BuildContext context, DataSource source) {
    return Placeholder(
      color:
          ArgumentDecoders.color(source, ['color']) ?? const Color(0xFF455A64),
  ...
  'SafeArea': (BuildContext context, DataSource source) {
    return SafeArea(
      ...
      minimum:
          (ArgumentDecoders.edgeInsets(source, ['minimum']) ?? EdgeInsets.zero)
              .resolve(Directionality.of(context)),
  ...
  'Stack': (BuildContext context, DataSource source) {
    return Stack(
      ...
      fit:
          ArgumentDecoders.enumValue<StackFit>(StackFit.values, source, [
            'fit',
          ]) ??
          StackFit.loose,
      clipBehavior:
  ...
  'Wrap': (BuildContext context, DataSource source) {
    return Wrap(
      direction:
          ...
          Axis.horizontal,
      alignment:
          ArgumentDecoders.enumValue<WrapAlignment>(
      ...
      crossAxisAlignment:
          ArgumentDecoders.enumValue<WrapCrossAlignment>(
