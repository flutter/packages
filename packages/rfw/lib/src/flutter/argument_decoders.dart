...
class ArgumentDecoders {
  ...
  static BorderSide? borderSide(DataSource source, List<Object> key) {
    ...
    return BorderSide(
      ...
      style:
          enumValue<BorderStyle>(BorderStyle.values, source, [
            ...key,
            'style',
          ]) ??
          BorderStyle.solid,
    ...
    switch (type) {
      ...
      case 'mode':
        return ColorFilter.mode(
          ...
          enumValue<BlendMode>(BlendMode.values, source, [
                ...key,
                'blendMode',
              ]) ??
              BlendMode.srcOver,
    ...
    switch (type) {
      ...
      case 'box':
        return BoxDecoration(
          ...
          backgroundBlendMode: enumValue<BlendMode>(BlendMode.values, source, [
            ...key,
            'backgroundBlendMode',
          ]),
          shape:
      ...
      case 'flutterLogo':
        return FlutterLogoDecoration(
          ...
          style:
              enumValue<FlutterLogoStyle>(FlutterLogoStyle.values, source, [
                ...key,
                'style',
              ]) ??
  ...
  static DecorationImage? decorationImage(DataSource source, List<Object> key) {
    ...
    return DecorationImage(
      ...
      repeat:
          enumValue<ImageRepeat>(ImageRepeat.values, source, [
            ...key,
            'repeat',
          ]) ??
      ...
      filterQuality:
          enumValue<FilterQuality>(FilterQuality.values, source, [
            ...key,
            'filterQuality',
          ]) ??
  ...
  static FontFeature fontFeature(DataSource source, List<Object> key) {
    return FontFeature(
      source.v<String>([...key, 'feature']) ?? 'NONE',
    ...
    switch (type) {
      ...
      case 'linear':
        return LinearGradient(
          ...
          tileMode:
              enumValue<TileMode>(TileMode.values, source, [
                ...key,
                'tileMode',
              ]) ??
              TileMode.clamp,
  ...
  static Paint? paint(DataSource source, List<Object> key) {
    ...
    final BlendMode? paintBlendMode = enumValue<BlendMode>(
      BlendMode.values,
      source,
      [...key, 'blendMode'],
    );
    ...
    final ColorFilter? paintColorFilter = colorFilter(source, [
      ...key,
      'colorFilter',
    ]);
    ...
    final MaskFilter? paintMaskFilter = maskFilter(source, [
      ...key,
      'maskFilter',
    ]);
  ...
  static ShapeBorder? shapeBorder(DataSource source, List<Object> key) {
    final List<ShapeBorder?>? shapes = list<ShapeBorder?>(
      source,
      key,
      shapeBorder,
    );
    ...
    switch (type) {
      ...
      case 'beveled':
        return BeveledRectangleBorder(
          ...
          borderRadius:
              borderRadius(source, [...key, 'borderRadius']) ??
              BorderRadius.zero,
        );
      case 'circle':
        return CircleBorder(
    ...
    switch (type) {
      ...
      case 'sweep':
        return gradient(source, key)!.createShader(
          ...
          textDirection:
              enumValue<TextDirection>(TextDirection.values, source, [
                'textDirection',
              ]) ??
              TextDirection.ltr,
        );
  ...
  static StrutStyle? strutStyle(DataSource source, List<Object> key) {
    ...
    return StrutStyle(
      fontFamily: source.v<String>([...key, 'fontFamily']),
      fontFamilyFallback: list<String>(source, [
        ...key,
        'fontFamilyFallback',
      ], string),
      ...
      fontWeight: enumValue<FontWeight>(FontWeight.values, source, [
        ...key,
        'fontWeight',
      ]),
      fontStyle: enumValue<FontStyle>(FontStyle.values, source, [
        ...key,
        'fontStyle',
      ]),
  ...
  static TextHeightBehavior? textHeightBehavior(
    ...
    return TextHeightBehavior(
      ...
      leadingDistribution:
          enumValue<TextLeadingDistribution>(
            TextLeadingDistribution.values,
            source,
            [...key, 'leadingDistribution'],
          ) ??
  ...
  static TextDecoration textDecoration(DataSource source, List<Object> key) {
    final List<TextDecoration>? decorations = list<TextDecoration>(
      source,
      key,
      textDecoration,
    );
  ...
  static TextStyle? textStyle(DataSource source, List<Object> key) {
    ...
    return TextStyle(
      ...
      textBaseline: enumValue<TextBaseline>(TextBaseline.values, source, [
        'textBaseline',
      ]),
      height: source.v<double>([...key, 'height']),
      leadingDistribution: enumValue<TextLeadingDistribution>(
      ...
      shadows: list<BoxShadow>(source, [...key, 'shadows'], boxShadow),
      fontFeatures: list<FontFeature>(source, [
        ...key,
        'fontFeatures',
      ], fontFeature),
      ...
      overflow: enumValue<TextOverflow>(TextOverflow.values, source, [
        'overflow',
      ]),
    );
  }
