...
class SourceLocation implements Comparable<SourceLocation> {
  ...
  bool operator ==(Object other) {
    ...
    return other is SourceLocation && source == other.source && offset == other.offset;
  }
...
class FullyQualifiedWidgetName implements Comparable<FullyQualifiedWidgetName> {
  ...
  bool operator ==(Object other) {
    ...
    return other is FullyQualifiedWidgetName && library == other.library && widget == other.widget;
  }
...
class RemoteWidgetLibrary extends WidgetLibrary {
  ...
  @override
  String toString() =>
      const Iterable<Object>.empty().followedBy(imports).followedBy(widgets).join('\n');
}
