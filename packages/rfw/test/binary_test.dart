...
void main() {
  ...
  testWidgets('Signature check in decoders', (WidgetTester tester) async {
    ...
    try {
      decodeLibraryBlob(Uint8List.fromList(<int>[
        0xFE,
        0x52,
        0x57,
        0x44,
  ...
  testWidgets('Trailing byte check', (WidgetTester tester) async {
    try {
      decodeDataBlob(
          Uint8List.fromList(<int>[0xFE, 0x52, 0x57, 0x44, 0x00, 0x00]));
      fail('did not throw exception');
    } on FormatException catch (e) {
  ...
  testWidgets('Incomplete files in signatures', (WidgetTester tester) async {
    try {
      ...
      expect('$e',
          contains('Could not read byte at offset 3: unexpected end of file.'));
    }
    try {
  ...
  testWidgets('Incomplete files after signatures', (WidgetTester tester) async {
    try {
      ...
      expect('$e',
          contains('Could not read byte at offset 4: unexpected end of file.'));
    }
    try {
  ...
  testWidgets('Invalid value tag', (WidgetTester tester) async {
    try {
      ...
      expect(
          '$e', contains('Unrecognized data type 0xCC while decoding blob.'));
    }
  });

  testWidgets('Library encoder smoke test', (WidgetTester tester) async {
    final Uint8List bytes = encodeLibraryBlob(
        const RemoteWidgetLibrary(<Import>[], <WidgetDeclaration>[]));
    expect(bytes, <int>[
      0xFE,
      0x52,
      0x46,
  ...
  testWidgets('Library encoder: imports', (WidgetTester tester) async {
    final Uint8List bytes =
        encodeLibraryBlob(const RemoteWidgetLibrary(<Import>[
  ...
  testWidgets('Library decoder: invalid widget declaration root',
  ...
  testWidgets('Library encoder: args references', (WidgetTester tester) async {
    ...
    expect(
        (value.widgets.first.root as ConstructorCall).arguments, hasLength(1));
    expect((value.widgets.first.root as ConstructorCall).arguments.keys,
        <Object?>['c']);
    expect((value.widgets.first.root as ConstructorCall).arguments['c'],
        hasLength(1));
    expect(
        ((value.widgets.first.root as ConstructorCall).arguments['c']!
            as DynamicList)[0],
        isA<ArgsReference>());
    expect(
        (((value.widgets.first.root as ConstructorCall).arguments['c']!
                as DynamicList)[0]! as ArgsReference)
            .parts,
        hasLength(2));
    expect(
        (((value.widgets.first.root as ConstructorCall).arguments['c']!
  ...
  testWidgets('Library encoder: invalid args references',
      (WidgetTester tester) async {
    try {
      encodeLibraryBlob(
          const RemoteWidgetLibrary(<Import>[], <WidgetDeclaration>[
  ...
  testWidgets('Library decoder: invalid args references',
      (WidgetTester tester) async {
    final bytes = Uint8List.fromList(<int>[
      0xfe,
      0x52,
    ...
    try {
      ...
      expect(
          '$e', contains('Invalid reference type 0xAC while decoding blob.'));
    }
  });
          ...
          ConstructorCall('b', <String, Object?>{
            'c': <Object?>[
              Loop(
                  <Object?>[],
                  ConstructorCall('d',
                      <String, Object?>{'e': LoopReference(0, <Object>[])})),
            ]
          })),
    ]));
    expect(bytes, <int>[
  ...
  testWidgets('Library encoder: event handler', (WidgetTester tester) async {
    final Uint8List bytes = encodeLibraryBlob(
      ...
      WidgetDeclaration(
          ...
          null,
          ConstructorCall('b',
              <String, Object?>{'c': EventHandler('d', <String, Object?>{})})),
    ]));
    expect(bytes, <int>[
      0xfe,
      0x52,
  ...
  testWidgets('Library encoder: state setter', (WidgetTester tester) async {
    final Uint8List bytes = encodeLibraryBlob(
      ...
      WidgetDeclaration(
          ...
          null,
          ConstructorCall('b', <String, Object?>{
            'c': SetStateHandler(StateReference(<Object>['d']), false)
          })),
    ]));
    expect(bytes, <int>[
      0xfe,
  ...
  testWidgets('Library encoder: switch', (WidgetTester tester) async {
    final Uint8List bytes = encodeLibraryBlob(
      ...
      WidgetDeclaration(
          ...
          null,
          ConstructorCall(
              'b', <String, Object?>{'c': Switch(false, <Object?, Object>{})})),
    ]));
    expect(bytes, <int>[
      0xfe,
      0x52,
  ...
  testWidgets('Library encoder: initial state', (WidgetTester tester) async {
    final Uint8List bytes = encodeLibraryBlob(
        const RemoteWidgetLibrary(<Import>[], <WidgetDeclaration>[
      WidgetDeclaration(
          'a', <String, Object?>{}, ConstructorCall('b', <String, Object?>{})),
    ]));
    expect(bytes, <int>[
      0xfe,
      0x52,
  ...
  testWidgets('Library encoder: initial state', (WidgetTester tester) async {
    final Uint8List bytes = encodeLibraryBlob(
        const RemoteWidgetLibrary(<Import>[], <WidgetDeclaration>[
      WidgetDeclaration('a', <String, Object?>{'b': false},
          ConstructorCall('c', <String, Object?>{})),
    ]));
    expect(bytes, <int>[
      0xfe,
      0x52,
  ...
  testWidgets('Library encoder: widget builders work',
      (WidgetTester tester) async {
    const source = '''
      widget Foo = Builder(
  ...
  testWidgets('Library encoder: widget builders throws',
      (WidgetTester tester) async {
      ...
      <WidgetDeclaration>[
        WidgetDeclaration(
          ...
          ConstructorCall(
            ...
            <String, Object?>{
              'builder':
                  WidgetBuilderDeclaration('scope', ArgsReference(<Object>[])),
            },
          ),
        ),
      ],
