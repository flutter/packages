...
void main() {
  ...
  testWidgets('Signature check in decoders', (WidgetTester tester) async {
    try {
      ...
      expect(
        '$e',
        contains('File signature mismatch. Expected FE 52 57 44 but found FE 52 46 57.'),
      );
    }
    try {
      decodeLibraryBlob(
      ...
      expect(
        '$e',
        contains('File signature mismatch. Expected FE 52 46 57 but found FE 52 57 44.'),
      );
    }
  });
  ...
  testWidgets('Library encoder: args references', (WidgetTester tester) async {
    ...
    expect(
      ((value.widgets.first.root as ConstructorCall).arguments['c']! as DynamicList)[0],
      isA<ArgsReference>(),
    );
    expect(
      (((value.widgets.first.root as ConstructorCall).arguments['c']! as DynamicList)[0]!
  ...
  testWidgets('Library encoder: loops', (WidgetTester tester) async {
        ...
        WidgetDeclaration(
          ...
          ConstructorCall('b', <String, Object?>{
            'c': <Object?>[
              Loop(
                <Object?>[],
                ConstructorCall('d', <String, Object?>{'e': LoopReference(0, <Object>[])}),
              ),
            ],
          }),
        ),
    ...
    expect(
      (((value.widgets.first.root as ConstructorCall).arguments['c']! as DynamicList)[0]! as Loop)
          .input,
      isEmpty,
    );
    expect(
  ...
  testWidgets('Library encoder: data references', (WidgetTester tester) async {
    ...
    expect(
      ((value.widgets.first.root as ConstructorCall).arguments['c']! as DataReference).parts,
      const <Object>['d'],
    );
  });
  ...
  testWidgets('Library encoder: state references', (WidgetTester tester) async {
    ...
    expect(
      ((value.widgets.first.root as ConstructorCall).arguments['c']! as StateReference).parts,
      const <Object>['d'],
    );
  });
  ...
  testWidgets('Library encoder: event handler', (WidgetTester tester) async {
    final Uint8List bytes = encodeLibraryBlob(
      const RemoteWidgetLibrary(<Import>[], <WidgetDeclaration>[
        WidgetDeclaration(
          'a',
          null,
          ConstructorCall('b', <String, Object?>{'c': EventHandler('d', <String, Object?>{})}),
        ),
      ]),
    );
    expect(bytes, <int>[
    ...
    expect(
      ((value.widgets.first.root as ConstructorCall).arguments['c']! as EventHandler).eventName,
      'd',
    );
    expect(
      ((value.widgets.first.root as ConstructorCall).arguments['c']! as EventHandler)
          .eventArguments,
      isEmpty,
    );
  });
  ...
  testWidgets('Library encoder: state setter', (WidgetTester tester) async {
    ...
    expect(
      ((value.widgets.first.root as ConstructorCall).arguments['c']! as SetStateHandler)
          .stateReference
          .parts,
      <Object>['d'],
    );
    expect(
      ((value.widgets.first.root as ConstructorCall).arguments['c']! as SetStateHandler).value,
      false,
    );
  });
  ...
  testWidgets('Library encoder: switch', (WidgetTester tester) async {
    final Uint8List bytes = encodeLibraryBlob(
      const RemoteWidgetLibrary(<Import>[], <WidgetDeclaration>[
        WidgetDeclaration(
          'a',
          null,
          ConstructorCall('b', <String, Object?>{'c': Switch(false, <Object?, Object>{})}),
        ),
      ]),
    );
    expect(bytes, <int>[
    ...
    expect(
      ((value.widgets.first.root as ConstructorCall).arguments['c']! as Switch).outputs,
      isEmpty,
    );
  });
  ...
  testWidgets('Library encoder: initial state', (WidgetTester tester) async {
    final Uint8List bytes = encodeLibraryBlob(
      const RemoteWidgetLibrary(<Import>[], <WidgetDeclaration>[
        WidgetDeclaration('a', <String, Object?>{
          'b': false,
  ...
  testWidgets('Library encoder: widget builders throws', (WidgetTester tester) async {
    const remoteWidgetLibrary = RemoteWidgetLibrary(<Import>[], <WidgetDeclaration>[
      WidgetDeclaration(
        'a',
        <String, Object?>{},
        ConstructorCall('c', <String, Object?>{
