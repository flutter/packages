...
void main() {
  testWidgets('Core widgets', (WidgetTester tester) async {
    ...
    await tester.pump();
    expect(
      tester.widget<Padding>(find.byType(Padding)).padding.resolve(TextDirection.ltr),
    ...
    expect(
      tester.widget<FractionallySizedBox>(find.byType(FractionallySizedBox)).alignment,
      Alignment.center,
    );
    imageCache.clear();
  });
