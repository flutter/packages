...
void main() {
  ...
  testWidgets('error handling in parseDataFile', (WidgetTester tester) async {
    ...
    test(
      '{ a: 0e-0',
      'Expected symbol "}" but found <EOF> at line 1 column 9.',
    );
    ...
    test(
      '{ a: "\\',
      'Unexpected end of file inside string at line 1 column 7.',
    );
    test('{ a: ."hello"', 'Unexpected . at line 1 column 7.');
    test(
      '{ "a": \'hello\'.\'hello\'',
  ...
  testWidgets('valid values in parseDataFile', (WidgetTester tester) async {
    ...
    expect(parseDataFile('{ a: 123.456e7 }'), <String, Object?>{
      'a': 123.456e7,
    });
    ...
    expect(parseDataFile('{ "a": -0, b: "x" }'), <String, Object?>{
      'a': 0,
      'b': 'x',
    });
    ...
    expect(parseDataFile('{ "a": -1e-8 }'), <String, Object?>{
      'a': -0.00000001,
    });
    expect(parseDataFile('{ "a": -1e-9 }'), <String, Object?>{
      'a': -0.000000001,
    });
    expect(parseDataFile('{ "a": -1e-10 }'), <String, Object?>{
      'a': -0.0000000001,
    });
    expect(parseDataFile('{ "a": -1e-11 }'), <String, Object?>{
      'a': -0.00000000001,
    });
    expect(parseDataFile('{ "a": -1e-12 }'), <String, Object?>{
      'a': -0.000000000001,
    });
    expect(parseDataFile('{ "a": -1e-13 }'), <String, Object?>{
      'a': -0.0000000000001,
    });
    expect(parseDataFile('{ "a": -1e-14 }'), <String, Object?>{
      'a': -0.00000000000001,
    });
    expect(parseDataFile('{ "a": -1e-15 }'), <String, Object?>{
      'a': -0.000000000000001,
    });
    expect(parseDataFile('{ "a": -1e-16 }'), <String, Object?>{
      'a': -0.0000000000000001,
    });
    expect(parseDataFile('{ "a": -1e-17 }'), <String, Object?>{
      'a': -0.00000000000000001,
    });
    expect(parseDataFile('{ "a": -1e-18 }'), <String, Object?>{
      'a': -0.000000000000000001,
    });
    expect(parseDataFile('{ "a": -1e-19 }'), <String, Object?>{
  ...
  testWidgets('parseLibraryFile: loops', (WidgetTester tester) async {
    final RemoteWidgetLibrary result = parseLibraryFile(
      'widget a = b(c: [ ...for d in []: "e" ]);',
    );
    expect(result.imports, isEmpty);
    expect(result.widgets, hasLength(1));
    expect(
      result.widgets.single.toString(),
  ...
  testWidgets('parseLibraryFile: switch', (WidgetTester tester) async {
    expect(
      parseLibraryFile('widget a = switch 0 { 0: a() };').toString(),
      'widget a = switch 0 {0: a({})};',
    );
    expect(
      parseLibraryFile('widget a = switch 0 { default: a() };').toString(),
      'widget a = switch 0 {null: a({})};',
    );
    expect(
      parseLibraryFile('widget a = b(c: switch 1 { 2: 3 });').toString(),
  ...
  testWidgets('parseLibraryFile: references', (WidgetTester tester) async {
    expect(
      parseLibraryFile('widget a = b(c:data.11234567890."e");').toString(),
      'widget a = b({c: data.11234567890.e});',
    );
    expect(
      parseLibraryFile('widget a = b(c: [...for d in []: d]);').toString(),
      'widget a = b({c: [...for loop in []: loop0.]});',
    );
    expect(
      parseLibraryFile('widget a = b(c:args.foo.bar);').toString(),
      'widget a = b({c: args.foo.bar});',
    );
    expect(
      parseLibraryFile('widget a = b(c:data.foo.bar);').toString(),
      'widget a = b({c: data.foo.bar});',
    );
    expect(
      parseLibraryFile('widget a = b(c:state.foo.bar);').toString(),
      'widget a = b({c: state.foo.bar});',
    );
    expect(
      parseLibraryFile('widget a = b(c: [...for d in []: d.bar]);').toString(),
    ...
    expect(
      parseLibraryFile(
        'widget a = b(c: [...for d in []: d."bar"]);',
      ).toString(),
      'widget a = b({c: [...for loop in []: loop0.bar]});',
    );
    expect(
      parseLibraryFile('widget a = b(c:args.foo.9);').toString(),
      'widget a = b({c: args.foo.9});',
    );
    expect(
      parseLibraryFile('widget a = b(c:data.foo.9);').toString(),
      'widget a = b({c: data.foo.9});',
    );
    expect(
      parseLibraryFile('widget a = b(c:state.foo.9);').toString(),
    ...
    expect(
      parseLibraryFile('widget a = b(c:args.foo.12);').toString(),
      'widget a = b({c: args.foo.12});',
    );
    expect(
      parseLibraryFile('widget a = b(c:data.foo.12);').toString(),
      'widget a = b({c: data.foo.12});',
    );
    expect(
      parseLibraryFile('widget a = b(c:state.foo.12);').toString(),
    ...
    expect(
      parseLibraryFile('widget a = b(c:args.foo.98);').toString(),
      'widget a = b({c: args.foo.98});',
    );
    expect(
      parseLibraryFile('widget a = b(c:data.foo.98);').toString(),
      'widget a = b({c: data.foo.98});',
    );
    expect(
      parseLibraryFile('widget a = b(c:state.foo.98);').toString(),
    ...
    expect(
      parseLibraryFile('widget a = b(c:args.foo.000);').toString(),
      'widget a = b({c: args.foo.0});',
    );
    expect(
      parseLibraryFile('widget a = b(c:data.foo.000);').toString(),
      'widget a = b({c: data.foo.0});',
    );
    expect(
      parseLibraryFile('widget a = b(c:state.foo.000);').toString(),
      'widget a = b({c: state.foo.0});',
    );
    expect(
      parseLibraryFile('widget a = b(c: [...for d in []: d.000]);').toString(),
  ...
  testWidgets('parseLibraryFile: event handlers', (WidgetTester tester) async {
    expect(
      parseLibraryFile('widget a = b(c: event "d" { });').toString(),
      'widget a = b({c: event d {}});',
    );
    expect(
      parseLibraryFile('widget a = b(c: set state.d = 0);').toString(),
  ...
  testWidgets('parseLibraryFile: stateful widgets', (
    ...
    expect(
      parseLibraryFile('widget a {} = c();').toString(),
      'widget a = c({});',
    );
    expect(
      parseLibraryFile('widget a {b: 0} = c();').toString(),
      'widget a = c({});',
    );
    final RemoteWidgetLibrary result = parseLibraryFile(
      'widget a {b: 0} = c();',
