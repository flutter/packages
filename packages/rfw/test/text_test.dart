...
void main() {
  ...
  testWidgets('error handling in parseDataFile', (WidgetTester tester) async {
    void test(String input, String expectedMessage) {
      try {
        parseDataFile(input);
        fail(
            'parsing `$input` did not result in an error (expected "$expectedMessage").');
    ...
    test('{ a: -',
        'Unexpected end of file after minus sign at line 1 column 6.');
    test('{ a: -a',
    ...
    test('{ a: 0e',
        'Unexpected end of file after exponent separator at line 1 column 7.');
    test('{ a: 0ee',
    ...
    test('{ a: 0e-e',
        'Unexpected character U+0065 ("e") in exponent at line 1 column 9.');
    test('{ a: 0e-f',
        'Unexpected character U+0066 ("f") in exponent at line 1 column 9.');
    test('{ a: 0e-.',
        'Unexpected character U+002E (".") in exponent at line 1 column 9.');
    test('{ a: 0e- ',
        'Unexpected character U+0020 in exponent at line 1 column 9.');
    test(
        '{ a: 0e-0', 'Expected symbol "}" but found <EOF> at line 1 column 9.');
    test('{ a: 0e-0{', 'Expected symbol "}" but found { at line 1 column 10.');
    test('{ a: 0e-0;', 'Expected symbol "}" but found ; at line 1 column 10.');
    test('{ a: 0e-0e',
        'Unexpected character U+0065 ("e") in exponent at line 1 column 10.');
    test('{ a: 0 ', 'Expected symbol "}" but found <EOF> at line 1 column 7.');
    test('{ a: 0.',
        'Unexpected end of file after decimal point at line 1 column 7.');
    test('{ a: 0.e',
        'Unexpected character U+0065 ("e") in fraction component at line 1 column 8.');
    test('{ a: 0. ',
        'Unexpected character U+0020 in fraction component at line 1 column 8.');
    test('{ a: 00', 'Expected symbol "}" but found <EOF> at line 1 column 7.');
    test('{ a: 00e',
        'Unexpected end of file after exponent separator at line 1 column 8.');
    test('{ a: 00ee',
    ...
    test('{ a: -0', 'Expected symbol "}" but found <EOF> at line 1 column 7.');
    test('{ a: -0.',
        'Unexpected end of file after decimal point at line 1 column 8.');
    test('{ a: -0. ',
        'Unexpected character U+0020 in fraction component at line 1 column 9.');
    test(
        '{ a: -0.0', 'Expected symbol "}" but found <EOF> at line 1 column 9.');
    test('{ a: -0.0 ',
        'Expected symbol "}" but found <EOF> at line 1 column 10.');
    test('{ a: -0.0e',
        'Unexpected end of file after exponent separator at line 1 column 10.');
    test('{ a: -0.0ee',
    ...
    test('{ a: -00', 'Expected symbol "}" but found <EOF> at line 1 column 8.');
    test('{ a: 0f',
        'Unexpected character U+0066 ("f") after zero at line 1 column 7.');
    test('{ a: -0f',
    ...
    test('{ a: test.0 ', 'Unexpected test at line 1 column 10.');
    test('{ a: 0x',
        'Unexpected end of file after 0x prefix at line 1 column 7.');
    test('{ a: 0xg',
        'Unexpected character U+0067 ("g") after 0x prefix at line 1 column 8.');
    test('{ a: 0xx',
        'Unexpected character U+0078 ("x") after 0x prefix at line 1 column 8.');
    test('{ a: 0x}',
        'Unexpected character U+007D ("}") after 0x prefix at line 1 column 8.');
    test('{ a: 0x0', 'Expected symbol "}" but found <EOF> at line 1 column 8.');
    test(
        '{ a: 0xff', 'Expected symbol "}" but found <EOF> at line 1 column 9.');
    test('{ a: 0xfg',
        'Unexpected character U+0067 ("g") in hex literal at line 1 column 9.');
    test('{ a: ."hello"', 'Unexpected . at line 1 column 7.');
    test('{ a: "hello"."hello"',
        'Expected symbol "}" but found . at line 1 column 14.');
    test('{ a: "hello"',
        'Expected symbol "}" but found <EOF> at line 1 column 12.');
    test('{ a: "\n"',
    ...
    test('{ a: ."hello"', 'Unexpected . at line 1 column 7.');
    test('{ "a": \'hello\'.\'hello\'',
        'Expected symbol "}" but found . at line 1 column 16.');
    test('{ "a": \'hello\'',
        'Expected symbol "}" but found <EOF> at line 1 column 14.');
    test('{ "a": \'hello\'h',
    ...
    test('{ "a": \'hello\n\'',
        'Unexpected end of line inside string at line 2 column 0.');
    test('{ "a": \'\\',
        'Unexpected end of file inside string at line 1 column 9.');
    test('{ "a": \'\\\'',
        'Unexpected end of file inside string at line 1 column 10.');
    test('{ "a": \'\\u',
        'Unexpected end of file inside Unicode escape at line 1 column 10.');
    test('{ "a": \'\\u0',
        'Unexpected end of file inside Unicode escape at line 1 column 11.');
    test('{ "a": \'\\u00',
        'Unexpected end of file inside Unicode escape at line 1 column 12.');
    test('{ "a": \'\\u000',
        'Unexpected end of file inside Unicode escape at line 1 column 13.');
    test('{ "a": \'\\u0000',
        'Unexpected end of file inside string at line 1 column 14.');
    test('{ "a": \'\\u|',
    ...
    test('{ "a": \'\\u0000|',
        'Unexpected end of file inside string at line 1 column 15.');
    test('{ "a": \'\\U263A\' }',
    ...
    test('{ "a": /',
        'Unexpected end of file inside comment delimiter at line 1 column 8.');
    test('{ "a": /.',
        'Unexpected character U+002E (".") inside comment delimiter at line 1 column 9.');
    test('{ "a": //', 'Unexpected <EOF> at line 1 column 9.');
    test('{ "a": /*',
        'Unexpected end of file in block comment at line 1 column 9.');
    test('{ "a": /*/',
        'Unexpected end of file in block comment at line 1 column 10.');
    test('{ "a": /**',
        'Unexpected end of file in block comment at line 1 column 10.');
    test('{ "a": /* *',
        'Unexpected end of file in block comment at line 1 column 11.');
  });
  ...
  testWidgets('valid values in parseDataFile', (WidgetTester tester) async {
    ...
    expect(parseDataFile('{ a: [ "b", 9 ] }'), <String, Object?>{
      'a': <Object?>['b', 9]
    });
    expect(parseDataFile('{ a: { } }'),
        <String, Object?>{'a': <String, Object?>{}});
    expect(
        parseDataFile('{ a: 123.456e7 }'), <String, Object?>{'a': 123.456e7});
    ...
    expect(parseDataFile('{ "a": -0, b: "x" }'),
        <String, Object?>{'a': 0, 'b': 'x'});
    ...
    expect(
        parseDataFile('{ "a": -1e-8 }'), <String, Object?>{'a': -0.00000001});
    expect(
        parseDataFile('{ "a": -1e-9 }'), <String, Object?>{'a': -0.000000001});
    expect(parseDataFile('{ "a": -1e-10 }'),
        <String, Object?>{'a': -0.0000000001});
    expect(parseDataFile('{ "a": -1e-11 }'),
        <String, Object?>{'a': -0.00000000001});
    expect(parseDataFile('{ "a": -1e-12 }'),
        <String, Object?>{'a': -0.000000000001});
    expect(parseDataFile('{ "a": -1e-13 }'),
        <String, Object?>{'a': -0.0000000000001});
    expect(parseDataFile('{ "a": -1e-14 }'),
        <String, Object?>{'a': -0.00000000000001});
    expect(parseDataFile('{ "a": -1e-15 }'),
        <String, Object?>{'a': -0.000000000000001});
    expect(parseDataFile('{ "a": -1e-16 }'),
        <String, Object?>{'a': -0.0000000000000001});
    expect(parseDataFile('{ "a": -1e-17 }'),
        <String, Object?>{'a': -0.00000000000000001});
    expect(parseDataFile('{ "a": -1e-18 }'),
        <String, Object?>{'a': -0.000000000000000001});
    expect(parseDataFile('{ "a": -1e-19 }'),
        <String, Object?>{'a': -0.0000000000000000001});
    ...
    expect(
        parseDataFile('{ "a": \'\\u0000\' }'), <String, Object?>{'a': '\x00'});
    ...
    expect(parseDataFile('{ "a": \'\\udddd\' }'),
        <String, Object?>{'a': '\u{dddd}'}); // low surragate
    expect(parseDataFile('{ "a": \'\\ueeee\' }'),
        <String, Object?>{'a': '\u{eeee}'}); // private use area
    expect(parseDataFile('{ "a": \'\\uffff\' }'), <String, Object?>{
      'a': '\u{ffff}'
    }); // not technically a valid Unicode character
    expect(parseDataFile('{ "a": \'\\uAAAA\' }'), <String, Object?>{'a': 'ꪪ'});
    expect(parseDataFile('{ "a": \'\\uBBBB\' }'), <String, Object?>{'a': '뮻'});
    expect(parseDataFile('{ "a": \'\\uCCCC\' }'), <String, Object?>{'a': '쳌'});
    expect(parseDataFile('{ "a": \'\\uDDDD\' }'),
        <String, Object?>{'a': '\u{dddd}'});
    expect(parseDataFile('{ "a": \'\\uEEEE\' }'),
        <String, Object?>{'a': '\u{eeee}'});
    expect(parseDataFile('{ "a": \'\\uFFFF\' }'),
        <String, Object?>{'a': '\u{ffff}'});
    expect(parseDataFile('{ "a": /**/ "1" }'), <String, Object?>{'a': '1'});
    expect(parseDataFile('{ "a": /* */ "1" }'), <String, Object?>{'a': '1'});
    expect(parseDataFile('{ "a": /*\n*/ "1" }'), <String, Object?>{'a': '1'});
  });

  testWidgets('error handling in parseLibraryFile',
    ...
    test('import foo.+',
        'Unexpected character U+002B ("+") after period at line 1 column 12.');
    test('import foo."',
        'Unexpected end of file inside string at line 1 column 12.');
    test('import foo. "',
        'Unexpected end of file inside string at line 1 column 13.');
    test('import foo.\'',
        'Unexpected end of file inside string at line 1 column 12.');
    test('import foo. \'',
        'Unexpected end of file inside string at line 1 column 13.');
    test('widget a = b(c: [ ...for args in []: "e" ]);',
        'args is a reserved word at line 1 column 30.');
    test('widget a = switch 0 { 0: a(), 0: b() };',
        'Switch has duplicate cases for key 0 at line 1 column 32.');
    test('widget a = switch 0 { default: a(), default: b() };',
        'Switch has multiple default cases at line 1 column 44.');
    test('widget a = b(c: args)',
        'Expected symbol "." but found ) at line 1 column 21.');
    test('widget a = b(c: args.=)', 'Unexpected = at line 1 column 22.');
    test('widget a = b(c: args.0',
        'Expected symbol ")" but found <EOF> at line 1 column 22.');
    test('widget a = b(c: args.0 ',
        'Expected symbol ")" but found <EOF> at line 1 column 23.');
    test('widget a = b(c: args.0)',
        'Expected symbol ";" but found <EOF> at line 1 column 23.');
    test('widget a = b(c: args.0f',
    ...
    test('widget a = b(c: [ ... ]);',
        'Expected identifier but found ] at line 1 column 23.');
    test('widget a = b(c: [ ...baa ]);',
        'Expected for but found baa at line 1 column 25.');
    test('widget a = 0;',
        'Expected identifier but found 0 at line 1 column 13.');
    test('widget a = a.',
        'Expected symbol "(" but found . at line 1 column 13.');
    test('widget a = a. ',
        'Expected symbol "(" but found . at line 1 column 14.');
    test('widget a = a.0',
        'Expected symbol "(" but found . at line 1 column 14.');
  ...
  testWidgets('parseLibraryFile: loops', (WidgetTester tester) async {
    final RemoteWidgetLibrary result =
        parseLibraryFile('widget a = b(c: [ ...for d in []: "e" ]);');
    expect(result.imports, isEmpty);
    expect(result.widgets, hasLength(1));
    expect(result.widgets.single.toString(),
        'widget a = b({c: [...for loop in []: e]});');
  });

  testWidgets('parseLibraryFile: switch', (WidgetTester tester) async {
    expect(parseLibraryFile('widget a = switch 0 { 0: a() };').toString(),
        'widget a = switch 0 {0: a({})};');
    expect(parseLibraryFile('widget a = switch 0 { default: a() };').toString(),
        'widget a = switch 0 {null: a({})};');
    expect(parseLibraryFile('widget a = b(c: switch 1 { 2: 3 });').toString(),
        'widget a = b({c: switch 1 {2: 3}});');
  });

  testWidgets('parseLibraryFile: references', (WidgetTester tester) async {
    expect(parseLibraryFile('widget a = b(c:data.11234567890."e");').toString(),
        'widget a = b({c: data.11234567890.e});');
    expect(parseLibraryFile('widget a = b(c: [...for d in []: d]);').toString(),
        'widget a = b({c: [...for loop in []: loop0.]});');
    expect(parseLibraryFile('widget a = b(c:args.foo.bar);').toString(),
        'widget a = b({c: args.foo.bar});');
    expect(parseLibraryFile('widget a = b(c:data.foo.bar);').toString(),
        'widget a = b({c: data.foo.bar});');
    expect(parseLibraryFile('widget a = b(c:state.foo.bar);').toString(),
        'widget a = b({c: state.foo.bar});');
    expect(
        parseLibraryFile('widget a = b(c: [...for d in []: d.bar]);')
            .toString(),
    ...
    expect(
        parseLibraryFile('widget a = b(c: [...for d in []: d."bar"]);')
            .toString(),
        'widget a = b({c: [...for loop in []: loop0.bar]});');
    expect(parseLibraryFile('widget a = b(c:args.foo.9);').toString(),
        'widget a = b({c: args.foo.9});');
    expect(parseLibraryFile('widget a = b(c:data.foo.9);').toString(),
        'widget a = b({c: data.foo.9});');
    expect(parseLibraryFile('widget a = b(c:state.foo.9);').toString(),
        'widget a = b({c: state.foo.9});');
    expect(
        parseLibraryFile('widget a = b(c: [...for d in []: d.9]);').toString(),
        'widget a = b({c: [...for loop in []: loop0.9]});');
    expect(parseLibraryFile('widget a = b(c:args.foo.12);').toString(),
        'widget a = b({c: args.foo.12});');
    expect(parseLibraryFile('widget a = b(c:data.foo.12);').toString(),
        'widget a = b({c: data.foo.12});');
    expect(parseLibraryFile('widget a = b(c:state.foo.12);').toString(),
        'widget a = b({c: state.foo.12});');
    expect(
        parseLibraryFile('widget a = b(c: [...for d in []: d.12]);').toString(),
        'widget a = b({c: [...for loop in []: loop0.12]});');
    expect(parseLibraryFile('widget a = b(c:args.foo.98);').toString(),
        'widget a = b({c: args.foo.98});');
    expect(parseLibraryFile('widget a = b(c:data.foo.98);').toString(),
        'widget a = b({c: data.foo.98});');
    expect(parseLibraryFile('widget a = b(c:state.foo.98);').toString(),
        'widget a = b({c: state.foo.98});');
    expect(
        parseLibraryFile('widget a = b(c: [...for d in []: d.98]);').toString(),
        'widget a = b({c: [...for loop in []: loop0.98]});');
    expect(parseLibraryFile('widget a = b(c:args.foo.000);').toString(),
    ...
    expect(
        parseLibraryFile('widget a = b(c: [...for d in []: d.000]);')
            .toString(),
        'widget a = b({c: [...for loop in []: loop0.0]});');
  });

  testWidgets('parseLibraryFile: event handlers', (WidgetTester tester) async {
    expect(parseLibraryFile('widget a = b(c: event "d" { });').toString(),
        'widget a = b({c: event d {}});');
    expect(parseLibraryFile('widget a = b(c: set state.d = 0);').toString(),
        'widget a = b({c: set state.d = 0});');
  });

  testWidgets('parseLibraryFile: stateful widgets',
      (WidgetTester tester) async {
    expect(
        parseLibraryFile('widget a {} = c();').toString(), 'widget a = c({});');
    expect(parseLibraryFile('widget a {b: 0} = c();').toString(),
        'widget a = c({});');
    final RemoteWidgetLibrary result =
        parseLibraryFile('widget a {b: 0} = c();');
    expect(result.widgets.single.initialState, <String, Object?>{'b': 0});
  });

  testWidgets('parseLibraryFile: widgetBuilders work',
      (WidgetTester tester) async {
    final RemoteWidgetLibrary libraryFile = parseLibraryFile('''
      widget a = Builder(builder: (scope) => Container());
    ''');
    expect(libraryFile.toString(),
        'widget a = Builder({builder: (scope) => Container({})});');
  });

  testWidgets('parseLibraryFile: widgetBuilders work with arguments',
      (WidgetTester tester) async {
    final RemoteWidgetLibrary libraryFile = parseLibraryFile('''
  ...
  testWidgets('parseLibraryFile: widgetBuilder arguments are lexical scoped',
      (WidgetTester tester) async {
    final RemoteWidgetLibrary libraryFile = parseLibraryFile('''
      widget a = A(
        a: (s1) => B(
  ...
  testWidgets('parseLibraryFile: widgetBuilder arguments can be shadowed',
      (WidgetTester tester) async {
    final RemoteWidgetLibrary libraryFile = parseLibraryFile('''
      widget a = A(
        a: (s1) => B(
  ...
  testWidgets('parseLibraryFile: widgetBuilders check the returned value',
      (WidgetTester tester) async {
    void test(String input, String expectedMessage) {
      try {
        parseLibraryFile(input);
  ...
  testWidgets('parseLibraryFile: widgetBuilders check reserved words',
      (WidgetTester tester) async {
    void test(String input, String expectedMessage) {
      try {
        parseLibraryFile(input);
    ...
    test('widget a = Builder(builder: (args) => Container(width: args.width));',
  ...
  testWidgets('parseLibraryFile: switch works with widgetBuilders',
      (WidgetTester tester) async {
    final RemoteWidgetLibrary libraryFile = parseLibraryFile('''
      widget a = A(
        b: switch args.down {
  ...
  testWidgets('parseLibraryFile: widgetBuilders work with switch',
      (WidgetTester tester) async {
    final RemoteWidgetLibrary libraryFile = parseLibraryFile('''
      widget a = A(
  ...
  testWidgets('parseLibraryFile: widgetBuilders work with lists',
      (WidgetTester tester) async {
    final RemoteWidgetLibrary libraryFile = parseLibraryFile('''
      widget a = A(
        b: (s1) => B(c: [s1.c]),
    ...
    ''');
    expect(
        libraryFile.toString(), 'widget a = A({b: (s1) => B({c: [s1.c]})});');
  });

  testWidgets('parseLibraryFile: widgetBuilders work with maps',
      (WidgetTester tester) async {
    final RemoteWidgetLibrary libraryFile = parseLibraryFile('''
      widget a = A(
        b: (s1) => B(c: {d: s1.d}),
  ...
  testWidgets('parseLibraryFile: widgetBuilders work with setters',
      (WidgetTester tester) async {
    final RemoteWidgetLibrary libraryFile = parseLibraryFile('''
      widget a {foo: 0} = A(
  ...
  testWidgets('parseLibraryFile: widgetBuilders work with events',
      (WidgetTester tester) async {
    final RemoteWidgetLibrary libraryFile = parseLibraryFile('''
      widget a {foo: 0} = A(
