...
void main() {
  testWidgets('adaptive scaffold lays out slots as expected',
    ...
    await tester.pumpWidget(SimulatedLayout.small.scaffold());
    ...
    await tester.pumpWidget(SimulatedLayout.medium.scaffold());
    await tester.pumpAndSettle();
    ...
    await tester.pumpWidget(SimulatedLayout.mediumLarge.scaffold());
    await tester.pumpAndSettle();
    ...
    await tester.pumpWidget(SimulatedLayout.large.scaffold());
    await tester.pumpAndSettle();
    ...
    await tester.pumpWidget(SimulatedLayout.extraLarge.scaffold());
    await tester.pumpAndSettle();
  ...
  testWidgets('adaptive scaffold animations can be disabled',
    ...
    await tester.binding.setSurfaceSize(SimulatedLayout.small.size);
    await tester.pumpWidget(SimulatedLayout.small.scaffold(animations: false));

    await tester.binding.setSurfaceSize(SimulatedLayout.medium.size);
    await tester.pumpWidget(SimulatedLayout.medium.scaffold(animations: false));
  ...
  testWidgets('tapping navigation elements calls onSelectedIndexChange',
    ...
    await Future.forEach(SimulatedLayout.values,
      ...
      int selectedIndex = 0;
      final MaterialApp app = region.scaffold(initialIndex: selectedIndex);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(SimulatedLayout.medium
          .scaffold(appBarBreakpoint: AppBarAlwaysOnBreakpoint()));
      await tester.pumpAndSettle();
