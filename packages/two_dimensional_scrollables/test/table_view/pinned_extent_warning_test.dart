...
void main() {
  group('TableView pinned extent warnings', () {
    ...
    testWidgets('Warns when pinned rows fully consume viewport height and there are unpinned rows', (
      WidgetTester tester,
    ) async {
      // Regression test for https://github.com/flutter/flutter/issues/136833
      final log = <String>[];
    ...
    testWidgets('Does not warn when all columns are pinned even if they consume viewport', (
      WidgetTester tester,
    ) async {
      // Regression test for https://github.com/flutter/flutter/issues/136833
      final log = <String>[];
