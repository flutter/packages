...
public class Messages {
  ...
  public static final class PlatformHeatmap {
    ...
    public boolean equals(Object o) {
      ...
      return heatmapId.equals(that.heatmapId) && data.equals(that.data) && Objects.equals(gradient, that.gradient) && opacity.equals(that.opacity) && radius.equals(that.radius) && Objects.equals(maxIntensity, that.maxIntensity);
    }
  ...
  public static final class PlatformHeatmapGradient {
    ...
    public boolean equals(Object o) {
      ...
      return colors.equals(that.colors) && startPoints.equals(that.startPoints) && colorMapSize.equals(that.colorMapSize);
    }
   ...
   * Generated class from Pigeon that represents data sent in messages.
   */
  public static final class PlatformPointOfInterest {
    private @NonNull PlatformLatLng position;
    ...
    public void setPlaceId(@NonNull String setterArg) {
      if (setterArg == null) {
        throw new IllegalStateException("Nonnull field \"placeId\" is null.");
      }
    ...
    public boolean equals(Object o) {
      ...
      return position.equals(that.position) && Objects.equals(name, that.name) && placeId.equals(that.placeId);
    }
    ...
    static @NonNull PlatformPointOfInterest fromList(@NonNull ArrayList<Object> pigeonVar_list) {
  ...
  public static final class PlatformGroundOverlay {
    ...
    public boolean equals(Object o) {
      ...
      return groundOverlayId.equals(that.groundOverlayId) && image.equals(that.image) && Objects.equals(position, that.position) && Objects.equals(bounds, that.bounds) && Objects.equals(width, that.width) && Objects.equals(height, that.height) && Objects.equals(anchor, that.anchor) && transparency.equals(that.transparency) && bearing.equals(that.bearing) && zIndex.equals(that.zIndex) && visible.equals(that.visible) && clickable.equals(that.clickable);
    }

    @Override
    public int hashCode() {
      return Objects.hash(groundOverlayId, image, position, bounds, width, height, anchor, transparency, bearing, zIndex, visible, clickable);
    }
  ...
  private static class PigeonCodec extends StandardMessageCodec {
    ...
    protected Object readValueOfType(byte type, @NonNull ByteBuffer buffer) {
      switch (type) {
        ...
        case (byte) 154:
          return PlatformPointOfInterest.fromList((ArrayList<Object>) readValue(buffer));
        case (byte) 155:
    ...
    protected void writeValue(@NonNull ByteArrayOutputStream stream, Object value) {
      ...
      } else if (value instanceof PlatformPointOfInterest) {
        stream.write(154);
        writeValue(stream, ((PlatformPointOfInterest) value).toList());
  ...
  public interface MapsApi {
    ...
    void updateGroundOverlays(@NonNull List<PlatformGroundOverlay> toAdd, @NonNull List<PlatformGroundOverlay> toChange, @NonNull List<String> idsToRemove);
     ...
     */
    void animateCamera(@NonNull PlatformCameraUpdate cameraUpdate, @Nullable Long durationMilliseconds);
  ...
  public static class MapsCallbackApi {
    ...
    public void onPoiTap(@NonNull PlatformPointOfInterest poiArg, @NonNull VoidResult result) {
      final String channelName = "dev.flutter.pigeon.google_maps_flutter_android.MapsCallbackApi.onPoiTap" + messageChannelSuffix;
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(
              binaryMessenger, channelName, getCodec());
      channel.send(
          new ArrayList<>(Collections.singletonList(poiArg)),
          channelReply -> {
            if (channelReply instanceof List) {
              List<Object> listReply = (List<Object>) channelReply;
              if (listReply.size() > 1) {
  ...
  public interface MapsInspectorApi {
    ...
    static void setUp(@NonNull BinaryMessenger binaryMessenger, @NonNull String messageChannelSuffix, @Nullable MapsInspectorApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.google_maps_flutter_android.MapsInspectorApi.getGroundOverlayInfo" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.google_maps_flutter_android.MapsInspectorApi.getCameraPosition" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
