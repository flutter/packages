...
class MapsCallbackApi(
  ...
  suspend fun onCameraMoveStarted() {
    val separatedMessageChannelSuffix =
        if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
  ...
  suspend fun onCameraMove(cameraPositionArg: PlatformCameraPosition) {
    val separatedMessageChannelSuffix =
        if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    return suspendCancellableCoroutine { continuation ->
      val channelName =
  ...
  suspend fun onTap(positionArg: PlatformLatLng) {
    val separatedMessageChannelSuffix =
        if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    return suspendCancellableCoroutine { continuation ->
      val channelName =
  ...
  suspend fun onLongPress(positionArg: PlatformLatLng) {
    val separatedMessageChannelSuffix =
        if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    return suspendCancellableCoroutine { continuation ->
      val channelName =
  ...
  suspend fun onMarkerTap(markerIdArg: String) {
    val separatedMessageChannelSuffix =
        if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    return suspendCancellableCoroutine { continuation ->
      val channelName =
  ...
  suspend fun onMarkerDragStart(markerIdArg: String, positionArg: PlatformLatLng) {
    val separatedMessageChannelSuffix =
        if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    return suspendCancellableCoroutine { continuation ->
      val channelName =
  ...
  suspend fun onMarkerDrag(markerIdArg: String, positionArg: PlatformLatLng) {
    val separatedMessageChannelSuffix =
        if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    return suspendCancellableCoroutine { continuation ->
      val channelName =
  ...
  suspend fun onMarkerDragEnd(markerIdArg: String, positionArg: PlatformLatLng) {
    val separatedMessageChannelSuffix =
        if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    return suspendCancellableCoroutine { continuation ->
      val channelName =
  ...
  suspend fun onInfoWindowTap(markerIdArg: String) {
    val separatedMessageChannelSuffix =
        if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    return suspendCancellableCoroutine { continuation ->
      val channelName =
  ...
  suspend fun onCircleTap(circleIdArg: String) {
    val separatedMessageChannelSuffix =
        if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    return suspendCancellableCoroutine { continuation ->
      val channelName =
  ...
  suspend fun onClusterTap(clusterArg: PlatformCluster) {
    val separatedMessageChannelSuffix =
        if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    return suspendCancellableCoroutine { continuation ->
      val channelName =
  ...
  suspend fun onPolygonTap(polygonIdArg: String) {
    val separatedMessageChannelSuffix =
        if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    return suspendCancellableCoroutine { continuation ->
      val channelName =
  ...
  suspend fun onPolylineTap(polylineIdArg: String) {
    val separatedMessageChannelSuffix =
        if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    return suspendCancellableCoroutine { continuation ->
      val channelName =
  ...
  suspend fun onGroundOverlayTap(groundOverlayIdArg: String) {
    val separatedMessageChannelSuffix =
        if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    return suspendCancellableCoroutine { continuation ->
      val channelName =
  ...
  suspend fun getTileOverlayTile(
...
interface MapsInitializerApi {
   ...
   */
  suspend fun initializeWithPreferredRenderer(type: PlatformRendererType?): PlatformRendererType
  /**
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> =
                  try {
                    listOf(api.initializeWithPreferredRenderer(typeArg))
                  } catch (exception: Throwable) {
                    MessagesPigeonUtils.wrapError(exception)
                  }
              reply.reply(wrapped)
