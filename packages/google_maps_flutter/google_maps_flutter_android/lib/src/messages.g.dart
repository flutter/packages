...
abstract class MapsCallbackApi {
  ...
  static void setUp(MapsCallbackApi? api, {BinaryMessenger? binaryMessenger, String messageChannelSuffix = '',}) {
    ...
    {
      final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.google_maps_flutter_android.MapsCallbackApi.onActiveLevelChanged$messageChannelSuffix', pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        pigeonVar_channel.setMessageHandler(null);
      } else {
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.google_maps_flutter_android.MapsCallbackApi.onActiveLevelChanged was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final String? arg_activeLevelShortName = (args[0] as String?);
          assert(arg_activeLevelShortName != null,
              'Argument for dev.flutter.pigeon.google_maps_flutter_android.MapsCallbackApi.onActiveLevelChanged was null, expected non-null String.');
          try {
...
class MapsInspectorApi {
  ...
  Future<PlatformGroundOverlay?> getGroundOverlayInfo(String groundOverlayId) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.google_maps_flutter_android.MapsInspectorApi.getGroundOverlayInfo$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<PlatformCameraPosition> getCameraPosition() async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.google_maps_flutter_android.MapsInspectorApi.getCameraPosition$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
