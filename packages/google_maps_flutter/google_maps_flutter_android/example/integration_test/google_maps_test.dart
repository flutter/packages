...
void main() {
  ...
  setUpAll(() async {
    final instance = GoogleMapsFlutterPlatform.instance as GoogleMapsFlutterAndroid;
  ...
  testWidgets('testGetVisibleRegion', (WidgetTester tester) async {
    ...
    final LatLngBounds firstVisibleRegion =
        await waitForValueMatchingPredicate<LatLngBounds>(
          ...
          (LatLngBounds bounds) =>
              bounds != zeroLatLngBounds && bounds.northeast != bounds.southwest,
        ) ??
        zeroLatLngBounds;
  ...
  testWidgets(
    'testMyLocationButton initial value false',
    (WidgetTester tester) async {
      final Key key = GlobalKey();
      final mapIdCompleter = Completer<int>();
  ...
  testWidgets(
    'testMyLocationButton initial value true',
    (WidgetTester tester) async {
      final Key key = GlobalKey();
      final mapIdCompleter = Completer<int>();
  ...
  testWidgets('getStyleError reports last error', (WidgetTester tester) async {
    ...
    for (var i = 0; i < 1000 && error == null; i++) {
