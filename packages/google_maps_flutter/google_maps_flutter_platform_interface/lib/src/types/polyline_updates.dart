...
class PolylineUpdates extends MapsObjectUpdates<Polyline> {
  ...
  PolylineUpdates.from(super.previous, super.current) : super.from(objectName: 'polyline');
  ...
  Set<PolylineId> get polylineIdsToRemove => objectIdsToRemove.cast<PolylineId>();
