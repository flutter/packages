...
class MethodChannelGoogleMapsFlutter extends GoogleMapsFlutterPlatform {
  ...
  Future<dynamic> _handleMethodCall(MethodCall call, int mapId) async {
    switch (call.method) {
      ...
      case 'cluster#onTap':
        final Map<String, Object?> arguments = _getArgumentDictionary(call);
        final ClusterManagerId clusterManagerId = ClusterManagerId(arguments['clusterManagerId']! as String);
        final LatLng position = LatLng.fromJson(arguments['position'])!;

        final Map<String, List<dynamic>> latLngData =
            (arguments['bounds']! as Map<dynamic, dynamic>).map((dynamic key, dynamic object) => MapEntry<String, List<dynamic>>(key as String, object as List<dynamic>));
        ...
        final List<MarkerId> markerIds = (arguments['markerIds']! as List<dynamic>).map((dynamic markerId) => MarkerId(markerId as String)).toList();
  ...
  Future<LatLngBounds> getVisibleRegion({
    ...
    final Map<String, dynamic> latLngBounds = (await channel(mapId).invokeMapMethod<String, dynamic>('map#getVisibleRegion'))!;
  ...
  Future<ScreenCoordinate> getScreenCoordinate(
    ...
    final Map<String, int> point = (await channel(mapId).invokeMapMethod<String, int>('map#getScreenCoordinate', latLng.toJson()))!;
  ...
  Future<LatLng> getLatLng(
    ...
    final List<dynamic> latLng = (await channel(mapId).invokeMethod<List<dynamic>>('map#getLatLng', screenCoordinate.toJson()))!;
  ...
  Future<bool> isMarkerInfoWindowShown(
    ...
    return (await channel(mapId).invokeMethod<bool>('markers#isInfoWindowShown', <String, String>{'markerId': markerId.value}))!;
  }
