...
@interface FGMPlatformDoublePair ()
+ (FGMPlatformDoublePair *)fromList:(NSArray<id> *)list;
+ (nullable FGMPlatformDoublePair *)nullableFromList:(NSArray<id> *)list;
- (NSArray<id> *)toList;
@end
...
@implementation FGMPlatformDoublePair
+ (instancetype)makeWithX:(double)x y:(double)y {
  FGMPlatformDoublePair *pigeonResult = [[FGMPlatformDoublePair alloc] init];
  pigeonResult.x = x;
  pigeonResult.y = y;
  return pigeonResult;
}
...
+ (nullable FGMPlatformDoublePair *)nullableFromList:(NSArray<id> *)list {
  return (list) ? [FGMPlatformDoublePair fromList:list] : nil;
}
- (NSArray<id> *)toList {
  return @[
    @(self.x),
...
+ (FGMPlatformGroundOverlay *)fromList:(NSArray<id> *)list {
  ...
  pigeonResult.zIndex = [GetNullableObjectAtIndex(list, 7) doubleValue];
...
- (nullable id)readValueOfType:(UInt8)type {
  switch (type) {
    ...
    case 158:
      return [FGMPlatformDoublePair fromList:[self readValue]];
    case 159:
...
- (void)writeValue:(id)value {
  if ([value isKindOfClass:[FGMPlatformMapTypeBox class]]) {
    ...
    [self writeByte:157];
    [self writeValue:[value toList]];
  } else if ([value isKindOfClass:[FGMPlatformDoublePair class]]) {
    [self writeByte:158];
    [self writeValue:[value toList]];
