...
@property(nonatomic, strong, nullable) NSNumber * borderColor;
@property(nonatomic, strong, nullable) NSNumber * glyphColor;
@property(nonatomic, strong, nullable) NSNumber * glyphTextColor;
