...
class _PigeonCodec extends StandardMessageCodec {
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 143: 
        return PlatformCameraUpdateAnimationConfiguration.decode(readValue(buffer)!);
      case 144: 
...
class MapsApi {
  ...
  Future<void> animateCamera(PlatformCameraUpdate cameraUpdate, {PlatformCameraUpdateAnimationConfiguration? configuration}) async {
    ...
    final List<Object?>? pigeonVar_replyList =
        await pigeonVar_channel.send(<Object?>[cameraUpdate, configuration]) as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
      throw PlatformException(
