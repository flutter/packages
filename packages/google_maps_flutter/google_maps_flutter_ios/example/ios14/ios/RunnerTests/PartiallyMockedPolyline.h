 ...
 */
@interface PartiallyMockedPolyline : GMSPolyline
...
@property(nonatomic, assign, readonly) BOOL didSetGeodesic;
@property(nonatomic, assign, readonly) BOOL didSetSpans;
