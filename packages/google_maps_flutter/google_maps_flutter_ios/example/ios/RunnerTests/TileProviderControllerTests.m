...
@interface TileProviderControllerTests : XCTestCase
@end

@implementation TileProviderControllerTests
...
- (void)testCallChannelOnPlatformThread {
  ...
  FGMTileProviderController *controller =
      [[FGMTileProviderController alloc] initWithTileOverlayIdentifier:@"foo"
