...
@interface PolylineControllerTests : XCTestCase
@end

@implementation PolylineControllerTests
...
- (FGMPolylineController *)polylineControllerWithMockedMap {
  ...
  FGMPolylineController *polylineControllerWithMockedMap =
      [[FGMPolylineController alloc] initWithPath:path
...
- (void)testPatternsSetSpans {
  FGMPolylineController *polylineController = [self polylineControllerWithMockedMap];
                                        ...
                                        jointType:FGMPlatformJointTypeRound
                                         patterns:@[]
                                          ...
                                          visible:YES
                                            width:1
                                           zIndex:0]
               withMapView:[PolylineControllerTests mapView]];
