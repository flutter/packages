...
@interface PolygonControllerTests : XCTestCase
@end

@implementation PolygonControllerTests

- (void)testUpdatePolygonSetsVisibilityLast {
  PropertyOrderValidatingPolygon *polygon = [[PropertyOrderValidatingPolygon alloc] init];
  [FGMPolygonController updatePolygon:polygon
                                          ...
                                          makeWithConsumeTapEvents:NO
                                                       ...
                                                       strokeWidth:0
                                                           visible:YES
                                                            ...
                                                            points:@[]
                                                         polygonId:@"polygon"]
                          withMapView:[PolygonControllerTests mapView]];
